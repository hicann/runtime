...
checkopts() {
  ...
  # Process the options
  parsed_args=$(getopt -a -o j:hvf: -l help,pkg,verbose,build_host_only,ascend_install_path:,build-type:,cann_3rd_lib_path:,ascend_3rd_lib_path:,asan,sign-script:,enable-sign,version: -- "$@") || {
    usage
    exit 1
  }
