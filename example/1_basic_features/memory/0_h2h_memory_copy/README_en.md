...
## Description
This sample demonstrates Host-side memory copy functionality.
...
- Data Transfer
    - Call `aclrtMemcpy` to implement Host-to-Host data transfer using memory copy.
...
[INFO]  Allocate memory on the host memory 0x... successfully
[INFO]  Write the data 123 to the virtual address 0x...
