...
#include <thread>
#include "acl/acl.h"
#include "kernel_func/kernel_add.h"
#include "utils.h"
...
int DeviceInfoQuery()
{
    ...
    INFO_LOG(
        "Get device utilizationRate success. cubeUtilization %d, vectorUtilization %d, aicpuUtilization %d,"
        "memoryUtilization %d.",
    ...
    INFO_LOG(
        "Get stream priorityRange success. leastPriority %d, greatestPriority %d.", leastPriority, greatestPriority);
