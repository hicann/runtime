...
/*
 * This sample demonstrates synchronous host-to-device memory copy from hostPtrA to devPtrB.
 */
...
int32_t main()
{
    ...
    *hostPtrA = writeValue;
    ...
    // Copy memory from address hostPtrA to address devPtrB synchronously
    CHECK_ERROR(aclrtMemcpy(devPtrB, size, hostPtrA, size, ACL_MEMCPY_HOST_TO_DEVICE));
