...
/*
 * This sample demonstrates asynchronous device-to-host memory copy from devPtrB to hostPtrA.
 */
...
int32_t main()
{
    ...
    // Copy memory from address devPtrB to address hostPtrA asynchronously
    CHECK_ERROR(aclrtMemcpyAsync(hostPtrA, size, devPtrB, size, ACL_MEMCPY_DEVICE_TO_HOST, stream));
