...
/*
 * This sample demonstrates synchronous device-to-device memory copy from devPtrA to devPtrB.
 */
...
int32_t main()
{
    ...
    CHECK_ERROR(aclrtMemcpy(devPtrB, size, devPtrA, size, ACL_MEMCPY_DEVICE_TO_DEVICE));
