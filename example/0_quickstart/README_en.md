...
- [5_runtime_lifecycle_callbacks](./5_runtime_lifecycle_callbacks/README_en.md): Demonstrates how application plugins participate in ACL initialization and finalization, and verifies lifecycle semantics through callback registration, unregistration, and reference counting.
