...
```text
[INFO]  Generate normal distribution random numbers, data type: float
Random result[0] = ...
...
[INFO]  Generate truncated normal distribution random numbers, data type: BF16
Random result[0] = ...
...
[INFO]  Generate uniform distribution random numbers, data type: FP16
Random result[0] = ...
...
[INFO]  Generate uniform distribution random numbers, data type: INT32
Random result[0] = ...
...
[INFO]  Generate dropout bitmask, output data type: UINT8
Random result[0] = ...
