...
# Resolve the CANN path, SOC version, and AscendC CMake directory.
...
KERNEL_BINARY="${OUTPUT_DIR}/fatbin/binary_introspection_kernel/binary_introspection_kernel.o"
...
"${HOST_BINARY}" "${KERNEL_BINARY}" | tee output_msg.txt
