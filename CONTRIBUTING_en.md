...
Additionally, before coding, writing tests, and preparing design proposals, first read the development guides under `docs/zh/guidelines/` and follow the relevant standards:
