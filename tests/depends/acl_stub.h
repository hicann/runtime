...
public:
    ...
    virtual rtError_t rtStreamWaitEventWithFlag(rtStream_t stream, rtEvent_t event, uint32_t timeout, uint32_t flag);
    ...
    virtual rtError_t rtEventRecordWithFlag(rtEvent_t event, rtStream_t stream, uint32_t flag);
    ...
    virtual rtError_t rtMemcpyAsync(
    ...
    virtual rtError_t rtMemcpyAsyncEx(
        void* dst, uint64_t destMax, const void* src, uint64_t count, rtMemcpyKind_t kind, rtStream_t stream,
    ...
    virtual rtError_t rtCpuKernelLaunchWithFlag(
    ...
    virtual rtError_t rtGetMemUsageInfo(
    ...
    virtual rtError_t rtRegDeviceStateCallbackEx(
    ...
    virtual rtError_t rtMemQueueQuery(
    ...
    virtual rtError_t rtMemcpy2d(
        void* dst, uint64_t dpitch, const void* src, uint64_t spitch, uint64_t width, uint64_t height,
        rtMemcpyKind_t kind);
    virtual rtError_t rtMemcpy2dAsync(
        void* dst, uint64_t dpitch, const void* src, uint64_t spitch, uint64_t width, uint64_t height,
    ...
    virtual rtError_t rtGetFaultEvent(
    ...
    virtual rtError_t rtDeviceGetHostAtomicCapabilities(
        uint32_t* caps, const rtAtomicOperation* ops, const uint32_t count, int32_t deviceId);
    virtual rtError_t rtDeviceGetP2PAtomicCapabilities(
    ...
    virtual rtError_t rtMemPoolMallocAsync(
    ...
    virtual rtError_t rtMemMapNoAccess(void* virPtr, size_t size, size_t offset, rtDrvMemHandle handle, uint64_t flags);
    ...
    virtual rtError_t rtsFuncGetByName(const rtBinHandle binHandle, const char_t* kernelName, rtFuncHandle* funcHandle);
    virtual rtError_t rtBinaryGetGlobal(const rtBinHandle binHandle, const char_t* name, void** dptr, size_t* size);
    virtual rtError_t rtBinaryEnumerateFunctions(
    ...
    virtual rtError_t rtCreateLaunchArgs(
    ...
    virtual rtError_t rtLaunchKernelByFuncHandleV3(
    ...
    virtual rtError_t rtMemExportToShareableHandle(
        rtDrvMemHandle handle, rtDrvMemHandleType handleType, uint64_t flag, uint64_t* shareableHandle);
    virtual rtError_t rtsMemExportToShareableHandle(
        rtDrvMemHandle handle, rtDrvMemHandleType handleType, uint64_t flag, uint64_t* shareableHandle);
    ...
    virtual rtError_t rtMemImportFromShareableHandle(
        uint64_t shareableHandle, int32_t deviceId, rtDrvMemHandle* handle);
    virtual rtError_t rtsMemImportFromShareableHandle(
        uint64_t shareableHandle, int32_t deviceId, rtDrvMemHandle* handle);
    virtual rtError_t rtMemImportFromShareableHandleV2(
    ...
    virtual rtError_t rtDeviceL2CacheFlush(void* rsv);
    ...
    virtual rtError_t rtStreamGetCaptureInfo(
        rtStream_t stm, rtStreamCaptureStatus* const status, rtModel_t* captureMdl);
    ...
    virtual rtError_t rtLaunchSIMTKernelWithArgsArray(
        ...
        void** args);
    virtual rtError_t rtLaunchSIMTKernelWithHostArgs(
        void* func, rtDim3 gridDim, rtDim3 blockDim, size_t dynUbufSize, rtStream_t stream, rtKernelLaunchCfg_t* cfg,
    ...
    virtual rtError_t rtModelKernelTaskGetAttribute(
    ...
    virtual rtError_t rtModelCondHandleCreate(
    ...
    virtual rtError_t rtsMemcpyAsyncWithDesc(
        rtMemcpyDesc_t desc, rtMemcpyKind kind, rtMemcpyConfig_t* config, rtStream_t stream);
    virtual rtError_t rtMemcpyAsyncWithOffset(
    ...
    virtual rtError_t rtsSetMemcpyDesc(
    ...
    virtual rtError_t rtsKernelArgsInitByUserMem(
    ...
    virtual rtError_t rtsKernelArgsParaUpdate(
    ...
    virtual rtError_t rtsLaunchReduceAsyncTask(
        const rtReduceInfo_t* reduceInfo, const rtStream_t stm, const void* reserve);
    ...
    virtual rtError_t rtsCheckMemType(
    ...
    virtual rtError_t rtsLaunchKernelWithDevArgs(
    ...
    virtual rtError_t rtsLaunchKernelWithHostArgs(
    ...
    virtual rtError_t rtsNpuGetFloatOverFlowStatus(
    ...
    virtual rtError_t rtsLaunchRandomNumTask(
        const rtRandomNumTaskInfo_t* taskInfo, const rtStream_t stream, void* reserve);
    ...
    virtual rtError_t rtsSetDeviceTaskAbortCallback(
        const char_t* regName, rtsDeviceTaskAbortCallback callback, void* args);
    ...
    virtual rtError_t rtsLaunchUpdateTask(
    ...
    virtual rtError_t rtsLaunchCmoAddrTask(
    ...
    virtual rtError_t rtsCntNotifyWaitWithTimeout(
        rtCntNotify_t cntNotify, rtStream_t stream, rtCntNotifyWaitInfo_t* info);
    ...
    virtual rtError_t rtBinarySetExceptionCallback(
        rtBinHandle binHandle, rtOpExceptionCallback callback, void* userData);
    ...
    virtual int32_t TdtHostPushData(
...
public:
    ...
    MOCK_METHOD2(
        GetRuntimePlatformInfosByDevice, uint32_t(const uint32_t& device_id, fe::PlatFormInfos& platform_infos));
    ...
    MOCK_METHOD2(
        UpdateRuntimePlatformInfosByDevice, uint32_t(const uint32_t& device_id, fe::PlatFormInfos& platform_infos));
    // tdt function stub
    ...
    MOCK_METHOD3(
        TdtHostPushData,
        int32_t(const std::string& channelName, const std::vector<tdt::DataItem>& item, uint32_t deviceId));
    ...
    MOCK_METHOD4(
        rtMemManagedAdvise,
        rtError_t(const void* const ptr, uint64_t size, uint16_t advise, rtMemManagedLocation location));
    MOCK_METHOD5(
        rtMemManagedGetAttr,
        rtError_t(rtMemManagedRangeAttribute attribute, const void* ptr, size_t size, void* data, size_t dataSize));
    MOCK_METHOD6(
        rtMemManagedGetAttrs, rtError_t(
                                  rtMemManagedRangeAttribute* attributes, size_t numAttributes, const void* ptr,
    ...
    MOCK_METHOD4(
        rtStreamWaitEventWithFlag, rtError_t(rtStream_t stream, rtEvent_t event, uint32_t timeout, uint32_t flag));
    ...
    MOCK_METHOD3(rtEventRecordWithFlag, rtError_t(rtEvent_t event, rtStream_t stream, uint32_t flag));
    ...
    MOCK_METHOD5(
        rtMemcpy, rtError_t(void* dst, uint64_t destMax, const void* src, uint64_t count, rtMemcpyKind_t kind));
    MOCK_METHOD6(
        rtMemcpyAsync,
        rtError_t(
            void* dst, uint64_t destMax, const void* src, uint64_t count, rtMemcpyKind_t kind, rtStream_t stream));
    MOCK_METHOD7(
        rtMemcpyAsyncEx, rtError_t(
                             void* dst, uint64_t destMax, const void* src, uint64_t count, rtMemcpyKind_t kind,
    ...
    MOCK_METHOD5(
        rtMemsetAsync, rtError_t(void* ptr, uint64_t destMax, uint32_t value, uint64_t count, rtStream_t stream));
    MOCK_METHOD7(
        rtCpuKernelLaunchWithFlag, rtError_t(
                                       const void* soName, const void* kernelName, uint32_t numBlocks,
    ...
    MOCK_METHOD4(
        rtGetMemUsageInfo,
        rtError_t(uint32_t deviceId, rtMemUsageInfo_t* memUsageInfo, size_t inputNum, size_t* outputNum));
    ...
    MOCK_METHOD5(
        rtFunctionRegister,
        rtError_t(void* binHandle, const void* stubFunc, const char* stubName, const void* devFunc, uint32_t funcMode));
    MOCK_METHOD6(
        rtKernelLaunch, rtError_t(
                            const void* stubFunc, uint32_t numBlocks, void* args, uint32_t argsSize, rtSmDesc_t* smDesc,
                            rtStream_t stream));
    ...
    MOCK_METHOD3(
        rtRegDeviceStateCallbackEx,
        rtError_t(const char* regName, rtDeviceStateCallback callback, const rtDevCallBackDir_t notifyPos));
    MOCK_METHOD2(rtDeviceGetStreamPriorityRange, rtError_t(int32_t* leastPriority, int32_t* greatestPriority));
    MOCK_METHOD4(
        rtGetDeviceCapability, rtError_t(int32_t device, int32_t moduleType, int32_t featureType, int32_t* value));
    ...
    MOCK_METHOD4(
        rtMemQueueEnQueueBuff, rtError_t(int32_t devId, uint32_t qid, rtMemQueueBuff_t* inBuf, int32_t timeout));
    MOCK_METHOD4(
        rtMemQueueDeQueueBuff, rtError_t(int32_t devId, uint32_t qid, rtMemQueueBuff_t* outBuf, int32_t timeout));
    MOCK_METHOD6(
        rtMemQueueQuery,
        rtError_t(
            int32_t devId, rtMemQueueQueryCmd_t cmd, void* inBuff, uint32_t inLen, void* outBuff, uint32_t* outLen));
    ...
    MOCK_METHOD3(
        rtEschedSubmitEventSync, rtError_t(int32_t devId, rtEschedEventSummary_t* event, rtEschedEventReply_t* ack));
    ...
    MOCK_METHOD7(
        rtMemcpy2d, rtError_t(
                        void* dst, uint64_t dpitch, const void* src, uint64_t spitch, uint64_t width, uint64_t height,
                        rtMemcpyKind_t kind));
    MOCK_METHOD8(
        rtMemcpy2dAsync, rtError_t(
                             void* dst, uint64_t dpitch, const void* src, uint64_t spitch, uint64_t width,
    ...
    MOCK_METHOD4(
        ...
        rtError_t(uint32_t* caps, const rtAtomicOperation* ops, const uint32_t count, int32_t deviceId));
    MOCK_METHOD5(
        rtDeviceGetP2PAtomicCapabilities, rtError_t(
                                              uint32_t* caps, const rtAtomicOperation* ops, const uint32_t count,
                                              int32_t srcDeviceId, int32_t dstDeviceId));
    ...
    MOCK_METHOD4(
        rtMallocPhysical, rtError_t(rtDrvMemHandle* handle, size_t size, rtDrvMemProp_t* prop, uint64_t flags));
    ...
    MOCK_METHOD5(
        rtMemMapNoAccess, rtError_t(void* virPtr, size_t size, size_t offset, rtDrvMemHandle handle, uint64_t flags));
    MOCK_METHOD1(rtUnmapMem, rtError_t(void* devPtr));

    MOCK_METHOD5(
        rtMemManagedPrefetchAsync,
        rtError_t(const void* ptr, size_t size, rtMemManagedLocation location, uint32_t flags, rtStream_t stream));
    MOCK_METHOD8(
        rtMemManagedPrefetchBatchAsync,
        rtError_t(
            const void** ptrs, size_t* sizes, size_t count, rtMemManagedLocation* prefetchLocs, size_t* prefetchLocIdxs,
            size_t numPrefetchLocs, uint64_t flags, rtStream_t stream));
    MOCK_METHOD4(rtMemMapSelectedLink, rtError_t(void* virPtrDst, size_t size, void* virPtrSrc, uint32_t linkIdx));
    MOCK_METHOD1(rtDeviceL2CacheFlush, rtError_t(void* rsv));
    MOCK_METHOD2(rtMemMapSetLink, rtError_t(rtDrvMemHandle handle, rtMemLinkType adviceLink));

    MOCK_METHOD3(
        rtBinaryLoadWithoutTilingKey, rtError_t(const void* data, const uint64_t length, rtBinHandle* binHandle));
    MOCK_METHOD1(rtBinaryUnLoad, rtError_t(rtBinHandle binHandle));
    MOCK_METHOD3(
        rtsFuncGetByName, rtError_t(const rtBinHandle binHandle, const char_t* kernelName, rtFuncHandle* funcHandle));
    MOCK_METHOD2(rtGetFuncBySymbol, rtError_t(const void* symbol, rtFuncHandle* funcHandle));
    MOCK_METHOD4(
        rtBinaryGetGlobal, rtError_t(const rtBinHandle binHandle, const char_t* name, void** dptr, size_t* size));
    MOCK_METHOD3(
        rtBinaryEnumerateFunctions,
        rtError_t(const rtBinHandle binHandle, rtFuncHandle* funcHandles, uint32_t numFunctions));
    MOCK_METHOD5(
        rtCreateLaunchArgs, rtError_t(
                                size_t argsSize, size_t hostInfoTotalSize, size_t hostInfoNum, void* argsData,
                                rtLaunchArgsHandle* argsHandle));
    MOCK_METHOD1(rtDestroyLaunchArgs, rtError_t(rtLaunchArgsHandle argsHandle));
    MOCK_METHOD5(
        rtLaunchKernelByFuncHandleV3, rtError_t(
                                          rtFuncHandle funcHandle, uint32_t numBlocks, const rtArgsEx_t* const argsInfo,
                                          rtStream_t stm, const rtTaskCfgInfo_t* const cfgInfo));
    MOCK_METHOD4(
        rtMemExportToShareableHandle,
        rtError_t(rtDrvMemHandle handle, rtDrvMemHandleType handleType, uint64_t flag, uint64_t* shareableHandle));
    MOCK_METHOD4(
        rtsMemExportToShareableHandle,
        rtError_t(rtDrvMemHandle handle, rtDrvMemHandleType handleType, uint64_t flag, uint64_t* shareableHandle));
    MOCK_METHOD4(
        rtMemExportToShareableHandleV2,
        rtError_t(rtDrvMemHandle handle, rtMemSharedHandleType handleType, uint64_t flags, void* shareableHandle));
    MOCK_METHOD3(
        rtMemImportFromShareableHandle, rtError_t(uint64_t shareableHandle, int32_t deviceId, rtDrvMemHandle* handle));
    MOCK_METHOD3(
        rtsMemImportFromShareableHandle, rtError_t(uint64_t shareableHandle, int32_t deviceId, rtDrvMemHandle* handle));
    MOCK_METHOD5(
        rtMemImportFromShareableHandleV2, rtError_t(
                                              const void* shareableHandle, rtMemSharedHandleType handleType,
    ...
    MOCK_METHOD4(
        rtMemSetPidToShareableHandleV2,
        rtError_t(const void* shareableHandle, rtMemSharedHandleType handleType, int pid[], uint32_t pidNum));
    MOCK_METHOD3(
        rtMemGetAllocationGranularity,
        rtError_t(rtDrvMemProp_t* prop, rtDrvMemGranularityOptions option, size_t* granularity));
    ...
    MOCK_METHOD3(
        rtStreamGetCaptureInfo, rtError_t(rtStream_t stm, rtStreamCaptureStatus* const status, rtModel_t* captureMdl));
    ...
    MOCK_METHOD7(
        rtLaunchSIMTKernelWithArgsArray, rtError_t(
                                             void* func, rtDim3 gridDim, rtDim3 blockDim, size_t dynUbufSize,
                                             rtStream_t stream, rtKernelLaunchCfg_t* cfg, void** args));
    MOCK_METHOD10(
        rtLaunchSIMTKernelWithHostArgs,
        rtError_t(
            void* func, rtDim3 gridDim, rtDim3 blockDim, size_t dynUbufSize, rtStream_t stream,
    ...
    MOCK_METHOD3(
        rtModelKernelTaskGetAttribute,
        rtError_t(rtTask_t task, rtLaunchKernelAttrId attrId, rtLaunchKernelAttrVal_t* attrValue));
    ...
    MOCK_METHOD4(
        ...
        rtError_t(rtModel_t mdl, uint32_t defaultLaunchValue, rtCondHandleFlag_t flag, rtCondHandle_t* handle));
    ...
    MOCK_METHOD4(
        ...
        rtError_t(rtMemcpyDesc_t desc, rtMemcpyKind kind, rtMemcpyConfig_t* config, rtStream_t stream));
    MOCK_METHOD8(
        rtMemcpyAsyncWithOffset, rtError_t(
                                     (void** dst, uint64_t dstMax, uint64_t dstDataOffset, const void** src,
    ...
    MOCK_METHOD6(
        rtsSetMemcpyDesc, rtError_t(
                              rtMemcpyDesc_t desc, rtMemcpyKind kind, void* srcAddr, void* dstAddr, size_t count,
                              rtMemcpyConfig_t* config));
    MOCK_METHOD3(
        rtsBinaryLoadFromFile,
        rtError_t(const char* const binPath, const rtLoadBinaryConfig_t* const optionalCfg, rtBinHandle* handle));
    ...
    MOCK_METHOD4(
        rtsKernelArgsAppend, rtError_t(rtArgsHandle handle, void* para, size_t paraSize, rtParaHandle* paraHandle));
    MOCK_METHOD2(rtsKernelArgsAppendPlaceHolder, rtError_t(rtArgsHandle handle, rtParaHandle* paraHandle));
    MOCK_METHOD4(
        rtsKernelArgsParaUpdate,
        rtError_t(rtArgsHandle argsHandle, rtParaHandle paraHandle, void* para, size_t paraSize));
    MOCK_METHOD4(
        rtsKernelArgsInitByUserMem,
        rtError_t(rtFuncHandle funcHandle, rtArgsHandle argsHandle, void* userHostMem, size_t actualArgsSize));
    MOCK_METHOD3(
        rtsKernelArgsGetMemSize, rtError_t(rtFuncHandle funcHandle, size_t userArgsSize, size_t* actualArgsSize));
    ...
    MOCK_METHOD4(
        rtsValueWrite, rtError_t(const void* const devAddr, const uint64_t value, const uint32_t flag, rtStream_t stm));
    MOCK_METHOD4(
    ...
    MOCK_METHOD3(
        rtsStreamGetAttribute, rtError_t(rtStream_t stm, rtStreamAttr stmAttrId, rtStreamAttrValue_t* attrValue));
    ...
    MOCK_METHOD3(
        rtsLaunchReduceAsyncTask,
        rtError_t(const rtReduceInfo_t* reduceInfo, const rtStream_t stm, const void* reserve));

    MOCK_METHOD3(
        rtsGetDeviceResLimit, rtError_t(const int32_t deviceId, const rtDevResLimitType_t type, uint32_t* value));
    MOCK_METHOD3(
        rtsSetDeviceResLimit, rtError_t(const int32_t deviceId, const rtDevResLimitType_t type, uint32_t value));
    ...
    MOCK_METHOD4(
        rtsBinaryLoadFromData, rtError_t(
                                   const void* const data, const uint64_t length,
                                   const rtLoadBinaryConfig_t* const optionalCfg, rtBinHandle* handle));
    MOCK_METHOD4(
        rtsRegisterCpuFunc, rtError_t(
                                rtBinHandle binHandle, const char_t* const funcName, const char_t* const kernelName,
                                rtFuncHandle* funcHandle));
    MOCK_METHOD5(
        rtsCmoAsyncWithBarrier,
        rtError_t(void* srcAddrPtr, size_t srcLen, rtCmoOpCode cmoType, uint32_t logicId, rtStream_t stm));
    MOCK_METHOD3(rtsLaunchBarrierTask, rtError_t(rtBarrierTaskInfo_t* taskInfo, rtStream_t stm, uint32_t flag));
    MOCK_METHOD4(
        rtsGetPairDevicesInfo, rtError_t(uint32_t devId, uint32_t otherDevId, int32_t infoType, uint64_t* val));

    MOCK_METHOD8(
        rtsMemcpyBatch, rtError_t(
                            void** dsts, void** srcs, size_t* sizes, size_t count, rtMemcpyBatchAttr* attrs,
    ...
    MOCK_METHOD5(
        rtsIpcMemGetExportKey, rtError_t(const void* ptr, size_t size, char_t* key, uint32_t len, uint64_t flags));
    ...
    MOCK_METHOD3(
        rtNotifySetImportPidInterServer, rtError_t(rtNotify_t notify, const rtServerPid* serverPids, size_t num));
    MOCK_METHOD5(
        rtsCheckMemType,
        rtError_t(void** addrList, uint32_t size, uint32_t memType, uint32_t* checkResult, uint32_t reserve));
    ...
    MOCK_METHOD7(
        rtsLaunchKernelWithDevArgs, rtError_t(
                                        rtFuncHandle funcHandle, uint32_t numBlocks, rtStream_t stm,
    ...
    MOCK_METHOD8(
        ...
        rtError_t(
            ...
            uint32_t argsSize, rtPlaceHolderInfo_t* placeHolderArray, uint32_t placeHolderNum));
    MOCK_METHOD3(
        rtsGetFloatOverflowStatus, rtError_t(void* const outputAddr, const uint64_t outputSize, rtStream_t stm));
    MOCK_METHOD1(rtsResetFloatOverflowStatus, rtError_t(rtStream_t stm));
    MOCK_METHOD4(
        rtsNpuGetFloatOverFlowStatus,
        rtError_t(void* const outputAddr, const uint64_t outputSize, uint32_t checkMode, rtStream_t stm));
    ...
    MOCK_METHOD3(
        rtsLaunchRandomNumTask,
        rtError_t(const rtRandomNumTaskInfo_t* taskInfo, const rtStream_t stream, void* reserve));
    MOCK_METHOD3(
        rtsRegStreamStateCallback, rtError_t(const char_t* regName, rtsStreamStateCallback callback, void* args));
    MOCK_METHOD3(
        rtsRegDeviceStateCallback, rtError_t(const char_t* regName, rtsDeviceStateCallback callback, void* args));
    MOCK_METHOD3(
        rtsSetDeviceTaskAbortCallback,
        rtError_t(const char_t* regName, rtsDeviceTaskAbortCallback callback, void* args));
    ...
    MOCK_METHOD4(
        rtsLaunchUpdateTask,
        rtError_t(rtStream_t taskStream, uint32_t taskId, rtStream_t execStream, rtTaskUpdateCfg_t* info));
    ...
    MOCK_METHOD4(
        rtsLaunchCmoAddrTask,
        rtError_t(rtCmoDesc_t cmoDesc, rtStream_t stream, rtCmoOpCode cmoType, const void* reserve));
    ...
    MOCK_METHOD3(
        rtsCntNotifyRecord, rtError_t(rtCntNotify_t cntNotify, rtStream_t stream, rtCntNotifyRecordInfo_t* info));
    MOCK_METHOD3(
        rtsCntNotifyWaitWithTimeout,
        rtError_t(rtCntNotify_t cntNotify, rtStream_t stream, rtCntNotifyWaitInfo_t* info));
    ...
    MOCK_METHOD3(
        rtBinarySetExceptionCallback, rtError_t(rtBinHandle binHandle, rtOpExceptionCallback callback, void* userData));
