...
class COMMON_CONFIG_MANAGER_OPEN_TEST: public testing::Test {
protected:
    virtual void SetUp() {
    }
...
TEST_F(COMMON_CONFIG_MANAGER_OPEN_TEST, IsDriverSupportLlc)
{
...
TEST_F(COMMON_CONFIG_MANAGER_OPEN_TEST, GetVersionSpecificMetrics)
{
    GlobalMockObject::verify();
    auto configManger = Analysis::Dvvp::Common::Config::ConfigManager::instance();
...
TEST_F(COMMON_CONFIG_MANAGER_OPEN_TEST, GetChipIdTest)
{
    GlobalMockObject::verify();
    auto configManger = Analysis::Dvvp::Common::Config::ConfigManager::instance();
