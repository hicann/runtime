...
class COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST: public testing::Test {
protected:
    virtual void SetUp() {
    }
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckProfilingParams) {
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckProfilingIntervalIsValid) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckSystemTraceSwitchProfiling) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckControlSwitchProfiling) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
    params->taskTsfw = "asd";
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckTsSwitchProfiling) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckPmuSwitchProfiling) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckAivEventCoresIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckTsCpuEventIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckDdrEventsIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckHbmEventsIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
    std::vector<std::string> events = {"read","write","read","write","read","write","read","write","read","write"};
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckAivEventsIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
    const std::vector<std::string> aiv;
    EXPECT_EQ(true, entry->CheckAivEventsIsValid(aiv));
}

TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckAppNameIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckProfilingParams1) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, Init) {
    GlobalMockObject::verify();
    EXPECT_EQ(0, analysis::dvvp::common::validation::ParamValidation::instance()->Init());
}

TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, UnInit) {
    GlobalMockObject::verify();
    EXPECT_EQ(0, analysis::dvvp::common::validation::ParamValidation::instance()->Uninit());
}

TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckLlcEventsIsValid) {
    GlobalMockObject::verify();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckEventsSize)
{
    GlobalMockObject::verify();
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckL2CacheEventsValid) {
    using namespace analysis::dvvp::common::validation;
    GlobalMockObject::verify();
    ...
    std::vector<std::string> events = {"0x01", "0x02", "0x03", "0x3f"};
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
    EXPECT_EQ(false, entry->CheckSocPmuEventsValid(ProfSocPmuType::PMU_TYPE_NOC, events));
    Platform::instance()->Uninit();
}

TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, IsValidSleepPeriod) {
    GlobalMockObject::verify();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckHostSysOptionsIsValid) {
    GlobalMockObject::verify();

    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
    std::string hostSysOptions;
    EXPECT_EQ(false, entry->CheckHostSysOptionsIsValid(hostSysOptions));
    hostSysOptions = "COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST/CheckHostSysOptionsIsValid";
    EXPECT_EQ(false, entry->CheckHostSysOptionsIsValid(hostSysOptions));
    hostSysOptions = "cpu";
    EXPECT_EQ(true, entry->CheckHostSysOptionsIsValid(hostSysOptions));
}

TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckHostSysPidIsValid) {
    GlobalMockObject::verify();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckHostSysUsageOptionsIsValid) {
    GlobalMockObject::verify();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, ProfStarsAcsqParamIsValid) {
    GlobalMockObject::verify();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckStorageLimit) {
    using namespace analysis::dvvp::common::validation;
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckInstrProfilingFreqValid) {
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
        .will(returnValue(PlatformType::CHIP_V4_1_0));
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckAiCoreEventCoresIsValid) {
    using namespace analysis::dvvp::common::validation;
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_TEST, CheckFreqIsValid) {
    MOCKER_CPP(&Platform::CheckIfSupport, bool (Platform::*)(const std::string) const)
        .stubs()
