...
///////////////////////////////////////////////////////////////////
class DRIVER_AI_DRV_API_OPEN_TEST: public testing::Test {
protected:
    virtual void SetUp() {
    }
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetDeviceStatusTest) {
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetDevNum) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetDevIds) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvPeripheralStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvTscpuStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvAicoreStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvAicoreTaskBasedStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvAicpuStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvFftsProfileStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvAccProfileStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvTsFwStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvStarsSocLogStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvStop) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvChannelRead) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvChannelPoll) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvProfFlush) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvHwtsLogStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvFmkDataStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvL2CacheTaskStart) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetDevIdsStr) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetPlatformInfo) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvCheckIfHelperHost) {
    GlobalMockObject::verify();
    MOCKER(drvGetDevNum)
        .stubs()
        .will(returnValue(DRV_ERROR_NONE))
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetAivNum)
{
    GlobalMockObject::verify();
    uint32_t deviceId = 0;
    int64_t aivNum = 0;
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetEnvType) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetCtrlCpuId) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetCtrlCpuCoreNum) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetCtrlCpuEndianLittle) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetAiCpuCoreNum) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetAiCpuCoreId) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetAiCpuOccupyBitmap) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetTsCpuCoreNum) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetAiCoreId) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetAiCoreNum) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetDeviceTime) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetHostFreq) {
    GlobalMockObject::verify();
...
TEST_F(DRIVER_AI_DRV_API_OPEN_TEST, DrvGetDeviceFreq) {
    GlobalMockObject::verify();
    int64_t outFreq = 1000;
    std::string freq;
    MOCKER(halGetDeviceInfo)
