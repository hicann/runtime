...
class RUNNING_MODE_OPEN_UTEST : public testing::Test {
protected:
    virtual void SetUp() {}
...
TEST_F(RUNNING_MODE_OPEN_UTEST, ConvertParamsSetToString)
{
    std::set<int> srcSet;
...
TEST_F(RUNNING_MODE_OPEN_UTEST, CheckForbiddenParams)
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, CheckNeccessaryParams)
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, OutputUselessParams)
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, GetOutputDirInfoFromParams)
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, GetOutputDirInfoFromRecord)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, RemoveRecordFile)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, HandleProfilingParams)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, StopRunningTasks)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, StartParseTask)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, StartQueryTask)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, StartExportTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, StopNoWait) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, WaitRunningProcess){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, GetRunningTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, CheckAnalysisEnv){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, AppModeModeParamsCheck){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, AppModeRunModeTasks){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, AppModeSetDefaultParams){
    GlobalMockObject::verify();
...
TEST_F(RUNNING_MODE_OPEN_UTEST, AppModeStartAppTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, AppModeStartAppTaskForDynProf){
    GlobalMockObject::verify();
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeCheckIfDeviceOnline){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeStopRunningTasks){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeCheckHostSysParams){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, DataWillBeCollected){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeModeParamsCheck){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeRunModeTasks){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeCreateJobDir){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeRecordOutPut){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeCheckHostAndDeviceOrder){
    GlobalMockObject::verify();
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeStartHostTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeStartDeviceTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params2;
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemModeStopTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, SystemWaitSysTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, IsDeviceJob){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, CreateUploader)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, GenerateHostParam)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, GenerateDeviceParam) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, GenerateDeviceParam2) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, CreateSampleJsonFile) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, CreateDoneFile) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, WriteCtrlDataToFile) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, StartSysTask) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, ParseModeModeParamsCheck) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, ParseModeUpdateOutputDirInfo) 
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, ParseModeRunModeTasks) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::ParseMode rMode("parse", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, QueryModeUpdateOutputDirInfo) 
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    params->result_dir = "hello";
...
TEST_F(RUNNING_MODE_OPEN_UTEST, QueryModeModeParamsCheck) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, QueryModeRunModeTasks) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::QueryMode rMode("query", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, ExportModeUpdateOutputDirInfo) 
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    params->result_dir = "hello";
...
TEST_F(RUNNING_MODE_OPEN_UTEST, ExportModeModeParamsCheck) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST,ExportModeRunModeTasks) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::ExportMode rMode("export", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, StartAnalyzeTask)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_UTEST, AnalyzeModeModeParamsCheck) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
