...
class ADPROF_OPEN_UTEST : public testing::Test {
protected:
    virtual void SetUp()
    {}
...
TEST_F(ADPROF_OPEN_UTEST, AdprofInit)
{
...
TEST_F(ADPROF_OPEN_UTEST, AdprofCollectorProxy) 
{
...
TEST_F(ADPROF_OPEN_UTEST, AdprofBinFunc)
{
...
TEST_F(ADPROF_OPEN_UTEST, StartAdprof) 
{
    std::map<std::string, std::string> kvPairs = {
...
TEST_F(ADPROF_OPEN_UTEST, AdprofBin)
{
...
TEST_F(ADPROF_OPEN_UTEST, AdprofBinGetHostPidFailed) 
{
...
TEST_F(ADPROF_OPEN_UTEST, AdprofBinUTestCheckHostPidFailed)
{
...
TEST_F(ADPROF_OPEN_UTEST, AdprofBinUTestGetDevicePidFailed)
{
...
TEST_F(ADPROF_OPEN_UTEST, AdprofBinDlopenFailed)
{
    uint32_t getHostPid = 12345;
...
TEST_F(ADPROF_OPEN_UTEST, AdprofBinDlsymFailed)
{
    uint32_t getHostPid = 12345;
    char* argv[] = {"adprof", "host_pid:12345", "dev_id:0", "", ""};
    void *handle = (void*)1;
...
TEST_F(ADPROF_OPEN_UTEST, AdprofBinDlsymGetIsExitFailed)
{
    uint32_t getHostPid = 12345;
    char* argv[] = {"adprof", "host_pid:12345", "dev_id:0", "", ""};
    void *handle = (void*)1;
...
TEST_F(ADPROF_OPEN_UTEST, AdprofBinSuccess)
{
    uint32_t getHostPid = 12345;
    char* argv[] = {"adprof", "host_pid:12345", "dev_id:0", "", ""};
    void *handle = (void*)1;
...
TEST_F(ADPROF_OPEN_UTEST, AdprofModifyParam)
{
...
TEST_F(ADPROF_OPEN_UTEST, AdprofSpilitChunk)
{
...
TEST_F(ADPROF_OPEN_UTEST, FuncBind)
{
    analysis::dvvp::ProfileFileChunk dataChunk1;
    dataChunk1.isLastChunk = false;
    dataChunk1.chunkModule = 0;
