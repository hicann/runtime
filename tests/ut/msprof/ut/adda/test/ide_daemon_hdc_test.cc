...
class IDE_DAEMON_HDC_UTEST: public testing::Test {
protected:
    virtual void SetUp() {
    }
...
TEST_F(IDE_DAEMON_HDC_UTEST, HdcDaemonInit_get_dev_num_error)
{
...
TEST_F(IDE_DAEMON_HDC_UTEST, HdcDaemonInit)
{
    uint32_t count = 1;
...
TEST_F(IDE_DAEMON_HDC_UTEST, HdcDaemonInitDevNumErr)
{
    MOCKER(GetDevCount)
        .stubs()
...
TEST_F(IDE_DAEMON_HDC_UTEST, GetDevCount)
{
    uint32_t devCount = 0;
...
TEST_F(IDE_DAEMON_HDC_UTEST, IdeHdcCheckRunEnv)
{
...
TEST_F(IDE_DAEMON_HDC_UTEST, IdeDestroyGlobalCtrlInfo)
{
    DevInfoT devInfo = {0};
    uint32_t phyDevId = 1;
...
TEST_F(IDE_DAEMON_HDC_UTEST, HdcCreateHdcServerProc)
{
    DevInfoT devInfo = {0};
    uint32_t phyDevId = 1;
    uint32_t devCount = 0;
...
TEST_F(IDE_DAEMON_HDC_UTEST, IdeDestroyGlobalCtrlInfoDev)
{
