...
#include <vector>
#include <string>
#include "ide_common_util_test.h"
...
class IDE_DAEMON_COMMON_UTIL_TEST: public testing::Test {
protected:
    virtual void SetUp() {
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeGetCompontName)
{
    EXPECT_STREQ("default", IdeGetCompontName(NR_IDE_COMPONENTS));
}

TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeXmalloc)
{
    void *ptr = IdeXmalloc(0);
    EXPECT_TRUE(ptr == NULL);
}

TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeXmalloc_failed)
{
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeXmalloc_memset_s_failed)
{
    MOCKER(memset_s)
        .stubs()
        .will(returnValue(-1));
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeXfree)
{
    void *ptr = (void *)0x0;
    IdeXfree(ptr);
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeReqFree)
{
    struct tlv_req req;
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, DaemonInit_init_failed)
{
    mmSockHandle sock;
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, DaemonInit_chdir_failed)
{
    mmSockHandle sock;
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, DaemonInit_success)
{
    mmSockHandle sock;
    int port = 22118;
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeRegisterModule)
{
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeComponentsInit)
{
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeGetComponentType)
{
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeGetCompontNameByReq)
{
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeXrmalloc)
{
...
TEST_F(IDE_DAEMON_COMMON_UTIL_TEST, IdeRegisterSig)
{
    MOCKER(memset_s)
        .stubs()
        .will(returnValue(-1))
