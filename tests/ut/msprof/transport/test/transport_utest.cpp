...
TEST_F(TRANSPORT_TRANSPORT_ITRANSPORT_TEST, ParseStr2IdFileChunkBasic)
{
    ...
    trans->perfCount_ = perfCount;
    trans->Init();
    std::shared_ptr<analysis::dvvp::ProfileFileChunk> fileChunkReq =
        std::make_shared<analysis::dvvp::ProfileFileChunk>();
...
TEST_F(TRANSPORT_TRANSPORT_ITRANSPORT_TEST, ParseStr2IdFileChunkResidual)
{
    ...
    const std::string content2 =
        PackStr2IdStructs({MakeStr2IdStruct("xxxxxxx"), MakeStr2IdStruct(std::string(STR2ID_MARK) + hashStr)});
...
TEST_F(TRANSPORT_TRANSPORT_ITRANSPORT_TEST, ParseStr2IdFileChunkLongData)
{
    ...
    std::string case1Struct1 =
        std::string(STR2ID_MARK) + "Notify_Record,HcomReduce_6629421139219749105_1,hccl_world_group,Memcpy";
    case1Struct1 +=
        ",Notify_Wait,Reduce_Inline,Ub_Inline_Write,AlgType::MESH,HcomAllGather_6629421139219749105_2,Ub_Write_Or_Read";
    std::string case1Struct2 =
        "HcomAllReduce_6629421139219749105_3,Write_With_Notify,HcomAllReduce_6629421139219749105_4";
    ...
    case1Struct3 +=
        ",HcomReduce_6629421139219749105_10,HcomReduce_6629421139219749105_11,HcomAllReduce_6629421139219749105_0";
    const std::string content4 = PackStr2IdStructs(
        {MakeStr2IdStruct(case1Struct1), MakeStr2IdStruct(case1Struct2), MakeStr2IdStruct(case1Struct3)});
...
TEST_F(TRANSPORT_TRANSPORT_ITRANSPORT_TEST, ParseStr2IdChunkSkipsNonAsciiPayload)
{
    ...
    auto chunk = std::make_shared<analysis::dvvp::ProfileFileChunk>();
    chunk->fileName = "aicpu.data";
    chunk->chunk = PackStr2IdStructs(
        {MakeStr2IdStruct(std::string(STR2ID_MARK) + "op_a,op_b"), MakeStr2IdStruct(binary),
