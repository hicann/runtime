...
static const char MINIV3_RM_RF[] = "rm -rf ./acljsonMiniV3stest_workspace";
...
class AclJsonMiniV3RcStest: public testing::Test {
protected:
    virtual void SetUp()
    {
        DlStub();
...
TEST_F(AclJsonMiniV3RcStest, AclJsonDefault)
{
    // miniv3_rc: TaskTime
    nlohmann::json data;
