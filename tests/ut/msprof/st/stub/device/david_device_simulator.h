...
#ifndef CANN_DVVP_TEST_DAVID_DEVICE_SIMULATOR_H
#define CANN_DVVP_TEST_DAVID_DEVICE_SIMULATOR_H
#include <algorithm>
#include <cstdint>
#include <cstdio>
#include <string>
...
namespace Dvvp {
namespace Test {
class DavidDeviceSimulator : public DeviceSimulator {
public:
    DavidDeviceSimulator() {}
    explicit DavidDeviceSimulator(uint32_t platformType) : platformType_(platformType) {}
    virtual ~DavidDeviceSimulator() {}
