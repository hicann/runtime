...
int32_t MiniDeviceSimulator::ProfDrvGetChannels(ChannelList &channels)
{
    int32_t channles_ids[] = {4,6,7,10,43,44,130,131,142};
...
int32_t MiniDeviceSimulator::GetDeviceInfo(int32_t moduleType, int32_t infoType, int64_t *value)
{
    if (moduleType == MODULE_TYPE_SYSTEM &&
        infoType == INFO_TYPE_VERSION) {
        *value = (int64_t)StPlatformType::MINI_TYPE << 8;
    }
