...
#ifndef CANN_DVVP_TEST_MODENA_DEVICE_SIMULATOR_H
#define CANN_DVVP_TEST_MODENA_DEVICE_SIMULATOR_H
...
namespace Dvvp {
namespace Test {
class ModenaDeviceSimulator : public DavidV121DeviceSimulator {
public:
