...
namespace Dvvp {
namespace Test {
int32_t DavidV121DeviceSimulator::ProfDrvGetChannels(ChannelList &channels)
{
...
int32_t DavidV121DeviceSimulator::GetDeviceInfo(int32_t moduleType, int32_t infoType, int64_t *value)
{
