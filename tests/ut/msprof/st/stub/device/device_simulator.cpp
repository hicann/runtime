...
int32_t DeviceSimulator::GetDeviceInfo(int32_t moduleType, int32_t infoType, int64_t* value) { return -1; }

int32_t DeviceSimulator::ProfDrvGetChannels(ChannelList& channels) { return 0; }
...
int32_t DeviceSimulator::ProfDrvStart(uint32_t channelId, const ProfStartPara& para)
{
    ...
    switch (channelId) {
        ...
        case CHANNEL_CUS_AICPU: {
            ...
            profSampleOps_[channelId].start_func(
...
int32_t DeviceSimulator::CreateTlvData(prof_sample_para* para)
{
    ...
    std::vector<std::string> fileNames = {
        "SystemCpuUsage.data", "Memory.data", "ai_ctrl_cpu.data", "1-CpuUsage.data", "1-Memory.data"};
...
int32_t DeviceSimulator::HalEschedQueryInfo(
...
int32_t DeviceSimulator::HalEschedWaitEvent(
    uint32_t grpId, uint32_t threadId, int32_t timeout, struct event_info* event)
{
...
int32_t DeviceSimulator::HalProfSampleDataReport(
