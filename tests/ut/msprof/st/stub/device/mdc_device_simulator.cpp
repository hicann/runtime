...
namespace Dvvp {
namespace Test {
int32_t MdcDeviceSimulator::ProfDrvGetChannels(ChannelList &channels)
{
    std::string channelStr = "7,8,10,43,44,45,46,47,48,49,85,135,136,137,138,139";
    std::string pattern = ",";
...
int32_t MdcDeviceSimulator::GetDeviceInfo(int32_t moduleType, int32_t infoType, int64_t *value)
{
