...
uint32_t TsdGetProcListStatusStubError(const uint32_t logicDeviceId, ProcStatusParam* pidInfo, const uint32_t arrayLen)
{
    return 1;
}
...
void* mmDlsymTsdError(void* handle, const char* funcName)
{
    std::map<std::string, void*> errorFunc = {
        ...
        {"TsdGetProcListStatus", (void*)TsdGetProcListStatusStubError},
...
void* mmDlopen(const char* fileName, int mode) { return (void*)0x12345678; }