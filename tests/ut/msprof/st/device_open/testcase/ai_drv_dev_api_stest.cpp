...
class DRV_DEV_API_OPEN_STEST : public testing::Test {
protected:
    virtual void SetUp() {
    }
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetPlatformInfo)
{
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvCheckIfHelperHost)
{
    GlobalMockObject::verify();
    MOCKER(drvGetDevNum)
        .stubs()
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetAivNum)
{
    GlobalMockObject::verify();
    uint32_t deviceId = 0;
    int64_t aivNum = 0;
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetEnvType) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetCtrlCpuId) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetCtrlCpuCoreNum) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetCtrlCpuEndianLittle) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetAiCpuCoreNum) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetAiCpuCoreId) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetAiCpuOccupyBitmap) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetTsCpuCoreNum) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetAiCoreId) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetAiCoreNum) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvGetDeviceTime) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvChannelRead) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvChannelPoll) {
    GlobalMockObject::verify();
...
TEST_F(DRV_DEV_API_OPEN_STEST, DrvProfFlush) {
    GlobalMockObject::verify();
