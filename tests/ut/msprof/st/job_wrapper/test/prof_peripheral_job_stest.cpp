...
class JOB_WRAPPER_PROF_HSCB_JOB_STEST : public testing::Test {
protected:
    virtual void SetUp()
    {
        collectionJobCfg_ = std::make_shared<Analysis::Dvvp::JobWrapper::CollectionJobCfg>();
...
TEST_F(JOB_WRAPPER_PROF_HSCB_JOB_STEST, AicpuHscbInit)
{
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
...
TEST_F(JOB_WRAPPER_PROF_HSCB_JOB_STEST, AicpuHscbSendData)
{
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
...
TEST_F(JOB_WRAPPER_PROF_HSCB_JOB_STEST, AicpuHscbProcess)
{
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
...
TEST_F(JOB_WRAPPER_PROF_HSCB_JOB_STEST, AicpuHscbUninit)
{
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
