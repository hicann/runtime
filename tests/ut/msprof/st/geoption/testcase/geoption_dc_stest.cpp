...
static const char DC_RM_RF[] = "rm -rf ./geoptionDcstest_workspace";
static const char DC_MKDIR[] = "mkdir ./geoptionDcstest_workspace";
static const char DC_OUTPUT_DIR[] = "./geoptionDcstest_workspace/output";

class GeOptionDcStest: public testing::Test {
protected:
    virtual void SetUp()
    {
        DlStub();
...
TEST_F(GeOptionDcStest, GeOptionDefault)
{
    // dc: TaskTime
    nlohmann::json data;
    data["output"] = DC_OUTPUT_DIR;
...
TEST_F(GeOptionDcStest, GeOptionHardwareMem)
{
    // dc: HardwareMem
    nlohmann::json data;
    data["output"] = DC_OUTPUT_DIR;
    data["sys_hardware_mem_freq"] = 50;
    std::vector<std::string> dataList = {"ddr.data", "npu_mem.data"};
