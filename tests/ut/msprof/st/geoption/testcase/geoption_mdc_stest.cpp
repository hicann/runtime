...
static const char MDC_RM_RF[] = "rm -rf ./geoptionMdcstest_workspace";
static const char MDC_MKDIR[] = "mkdir ./geoptionMdcstest_workspace";
static const char MDC_OUTPUT_DIR[] = "./geoptionMdcstest_workspace/output";

class GeOptionMdcStest: public testing::Test {
protected:
    virtual void SetUp()
    {
        DlStub();
...
TEST_F(GeOptionMdcStest, GeOptionDefault)
{
    // mdc: TaskTime
    nlohmann::json data;
    data["output"] = MDC_OUTPUT_DIR;
