...
static const char CLOUD_RM_RF[] = "rm -rf ./geoptionCloudstest_workspace";
static const char CLOUD_MKDIR[] = "mkdir ./geoptionCloudstest_workspace";
static const char CLOUD_OUTPUT_DIR[] = "./geoptionCloudstest_workspace/output";

class GeOptionCloudStest: public testing::Test {
protected:
    virtual void SetUp()
    {
        DlStub();
...
TEST_F(GeOptionCloudStest, GeOptionDefault)
{
    // cloud: TaskTime
    nlohmann::json data;
...
TEST_F(GeOptionCloudStest, GeOptionHardwareMem)
{
    // cloud: HardwareMem
    nlohmann::json data;
    data["output"] = CLOUD_OUTPUT_DIR;
...
TEST_F(GeOptionCloudStest, GeOptionTaskMemory)
{
    // cloud: TaskMemory
    nlohmann::json data;
    data["output"] = CLOUD_OUTPUT_DIR;
