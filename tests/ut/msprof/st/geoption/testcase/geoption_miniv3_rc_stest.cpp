...
static const char MINIV3_RM_RF[] = "rm -rf ./geoptionMiniV3stest_workspace";
static const char MINIV3_MKDIR[] = "mkdir ./geoptionMiniV3stest_workspace";
static const char MINIV3_OUTPUT_DIR[] = "./geoptionMiniV3stest_workspace/output";

using namespace analysis::dvvp::common::error;
using namespace Cann::Dvvp::Test;

class GeOptionMiniV3RcStest: public testing::Test {
protected:
    virtual void SetUp()
    {
        DlStub();
...
TEST_F(GeOptionMiniV3RcStest, GeOptionDefault)
{
    // miniv3_ep: TaskTime
    nlohmann::json data;
    data["output"] = MINIV3_OUTPUT_DIR;
