...
static const char DAVID_V121_RM_RF[] = "rm -rf ./geoptionDavidV121stest_workspace";
...
TEST_F(GeOptionDavidV121Stest, GeOptionDefault)
{
    // david: TaskTime
    nlohmann::json data;
...
TEST_F(GeOptionDavidV121Stest, GeOptionSysCpuFreq)
{
    nlohmann::json data;
    data["output"] = DAVID_V121_OUTPUT_DIR;
...
TEST_F(GeOptionDavidV121Stest, GeOptionScale)
{
    // david: scale
    nlohmann::json data;
    data["output"] = DAVID_V121_OUTPUT_DIR;
...
TEST_F(GeOptionDavidV121Stest, GeOptionScaleCritical)
{
