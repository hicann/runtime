...
static const char MDCMINIV3_RM_RF[] = "rm -rf ./geoptionMdcMiniV3stest_workspace";
...
TEST_F(GeOptionMdcMiniV3Stest, GeOptionDefault)
{
...
TEST_F(GeOptionMdcMiniV3Stest, GeOptionAicpuProfiling)
{
    // mdc_mini_v3: aicpu
    nlohmann::json data;
    data["output"] = MDCMINIV3_OUTPUT_DIR;
...
TEST_F(GeOptionMdcMiniV3Stest, GeOptionTaskBlockProfiling)
{
    // mdc_mini_v3: InstrProfiling
    nlohmann::json data;
    data["output"] = MDCMINIV3_OUTPUT_DIR;
    data["aic_mode"] = "task_based";
    data["task_block"] = "on";
    EXPECT_EQ(PROFILING_FAILED, MsprofMgr().GeOptionStart(1, data));
}