...
class RUNNING_MODE_OPEN_STEST : public testing::Test {
protected:
    virtual void SetUp() {}
...
TEST_F(RUNNING_MODE_OPEN_STEST, ConvertParamsSetToString)
{
    std::set<int> srcSet;
    ...
    srcSet = {0, 1};
    EXPECT_EQ("--help --output", rMode.ConvertParamsSetToString(srcSet));
}

TEST_F(RUNNING_MODE_OPEN_STEST, CheckForbiddenParams)
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, CheckNeccessaryParams)
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, OutputUselessParams)
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, GetOutputDirInfoFromParams)
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, GetOutputDirInfoFromRecord)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, RemoveRecordFile)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, HandleProfilingParams)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, StopRunningTasks)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, StartParseTask)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, StartQueryTask)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, StartExportTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, WaitRunningProcess){
    GlobalMockObject::verify();
    g_phase = 0;
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, GetRunningTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, CheckAnalysisEnv){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, AppModeModeParamsCheck){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_STEST, SetAppEnv) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
        new analysis::dvvp::message::ProfileParams());
...
TEST_F(RUNNING_MODE_OPEN_STEST, AppModeRunModeTasks){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", nullptr);
    ...
    EXPECT_EQ(PROFILING_SUCCESS, rMode.RunModeTasks());
    EXPECT_EQ(PROFILING_SUCCESS, rMode.RunModeTasks());
    rMode.jobResultDirList_.clear();
    EXPECT_EQ(PROFILING_FAILED, rMode.RunModeTasks());
}

TEST_F(RUNNING_MODE_OPEN_STEST, AppModeSetDefaultParams){
    GlobalMockObject::verify();
...
TEST_F(RUNNING_MODE_OPEN_STEST, AppModeStartAppTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, AppModeStartAppTaskError) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::AppMode rMode("app", params);
    ...
    params->app_dir = "/bin";
    params->app = "echo";
    params->cmdPath = "/bin/echo";
    MOCKER(OsalRealPath).stubs().will(returnValue(-1));
    EXPECT_EQ(PROFILING_FAILED, rMode.StartAppTask(true));
}

TEST_F(RUNNING_MODE_OPEN_STEST, AppModeStartAppTaskForDynProf){
    GlobalMockObject::verify();
    ...
    MOCKER(&analysis::dvvp::app::Application::LaunchApp)
        ...
        .will(returnValue(PROFILING_FAILED))
        .then(returnValue(PROFILING_SUCCESS));
    MOCKER_CPP(&DynProfCliMgr::StartDynProfCli)
        .stubs()
        .will(returnValue(PROFILING_FAILED))
        .then(returnValue(PROFILING_SUCCESS));
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeCheckIfDeviceOnline){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeStopRunningTasks){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeCheckHostSysParams){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, DataWillBeCollected){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeModeParamsCheck){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeRunModeTasks){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", nullptr);
    EXPECT_EQ(PROFILING_FAILED, rMode.RunModeTasks());
    rMode.params_ = params;
    rMode.params_->ai_core_profiling = "on";
    rMode.jobResultDirList_.insert("PROF");
    MOCKER_CPP(&SystemMode::StartSysTask)
        .stubs()
        .will(returnValue(PROFILING_FAILED))
        .then(returnValue(PROFILING_NOTSUPPORT))
        .then(returnValue(PROFILING_SUCCESS));
    ...
    EXPECT_EQ(PROFILING_FAILED, rMode.RunModeTasks());
    EXPECT_EQ(PROFILING_NOTSUPPORT, rMode.RunModeTasks());
    EXPECT_EQ(PROFILING_SUCCESS, rMode.RunModeTasks());
    EXPECT_EQ(PROFILING_SUCCESS, rMode.RunModeTasks());
    EXPECT_EQ(PROFILING_SUCCESS, rMode.RunModeTasks());
    EXPECT_EQ(PROFILING_SUCCESS, rMode.RunModeTasks());
    EXPECT_EQ("on", rMode.params_->aiv_profiling);
    EXPECT_EQ("sample-based", rMode.params_->aiv_profiling_mode);
}

TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeCreateJobDir){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeRecordOutPut){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeCheckHostAndDeviceOrder){
    GlobalMockObject::verify();
    ...
    MOCKER_CPP_VIRTUAL((analysis::dvvp::common::thread::Thread*)deviceTask.get(), &ProfRpcTask::Start)
        .stubs()
        .will(returnValue(PROFILING_SUCCESS));
    MOCKER_CPP_VIRTUAL((analysis::dvvp::common::thread::Thread*)HostTask.get(), &ProfSocTask::Start)
        .stubs()
        .will(returnValue(PROFILING_SUCCESS));

    paramsDevice->job_id = "1";
    EXPECT_EQ(PROFILING_SUCCESS, rMode.StartHostTask(result_dir, 64));
    EXPECT_EQ(PROFILING_SUCCESS, rMode.StartDeviceTask(result_dir, "1"));
    EXPECT_EQ(2, rMode.taskMap_.size());
    EXPECT_EQ(2, rMode.taskList_.size());
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeStartHostTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeStartDeviceTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params2;
...
TEST_F(RUNNING_MODE_OPEN_STEST, SystemModeStopTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
    auto info = std::make_shared<Analysis::Dvvp::Msprof::ProfSocTask>(1, params);
    rMode.taskMap_.insert(std::make_pair("1", info));
    rMode.taskList_.push_back(info);
    MOCKER_CPP_VIRTUAL((MsprofTask*)info.get(), &ProfSocTask::Stop).stubs().will(returnValue(0));
    MOCKER_CPP_VIRTUAL((MsprofTask*)info.get(), &ProfSocTask::Wait).stubs().will(returnValue(0));
    rMode.StopTask();
    EXPECT_EQ(0, rMode.taskMap_.size());
    EXPECT_EQ(0, rMode.taskList_.size());
}

TEST_F(RUNNING_MODE_OPEN_STEST, SystemWaitSysTask){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, IsDeviceJob){
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_STEST, CreateUploader)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, GenerateHostParam)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    ...
    EXPECT_EQ(pp1->instrProfiling, "on");
    EXPECT_EQ(pp1->instrProfilingFreq, 1234);
}

TEST_F(RUNNING_MODE_OPEN_STEST, GenerateDeviceParam) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, GenerateDeviceParam2) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, CreateSampleJsonFile) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, CreateDoneFile) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, WriteCtrlDataToFile) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, StartSysTask) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::SystemMode rMode("system", params);
...
TEST_F(RUNNING_MODE_OPEN_STEST, ParseModeModeParamsCheck) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, ParseModeUpdateOutputDirInfo) 
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, ParseModeRunModeTasks) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::ParseMode rMode("parse", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_STEST, QueryModeUpdateOutputDirInfo) 
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    params->result_dir = "hello";
...
TEST_F(RUNNING_MODE_OPEN_STEST, QueryModeModeParamsCheck) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, QueryModeRunModeTasks) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::QueryMode rMode("query", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_STEST, ExportModeUpdateOutputDirInfo) 
{
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    params->result_dir = "hello";
...
TEST_F(RUNNING_MODE_OPEN_STEST, ExportModeModeParamsCheck) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST,ExportModeRunModeTasks) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
    Collector::Dvvp::Msprofbin::ExportMode rMode("export", nullptr);
...
TEST_F(RUNNING_MODE_OPEN_STEST, StartAnalyzeTask)
{
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
...
TEST_F(RUNNING_MODE_OPEN_STEST, AnalyzeModeModeParamsCheck) {
    GlobalMockObject::verify();
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(
    new analysis::dvvp::message::ProfileParams);
