...
class INPUT_PARSER_OPEN_STEST : public testing::Test {
protected:
    virtual void SetUp() {}
...
TEST_F(INPUT_PARSER_OPEN_STEST, MsprofHostCheckValid) {
    GlobalMockObject::verify();
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckHostSysCmdOutIsExist) {
    GlobalMockObject::verify();
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckOutputValid) {
    GlobalMockObject::verify();
    InputParser parser = InputParser();
    struct MsprofCmdInfo cmdInfo = { {nullptr} };
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckStorageLimitValid) {
    GlobalMockObject::verify();
    InputParser parser = InputParser();
    struct MsprofCmdInfo cmdInfo = { {nullptr} };
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckStorageLimit) {
...
TEST_F(INPUT_PARSER_OPEN_STEST, GetAppParam) {
    GlobalMockObject::verify();
    InputParser parser = InputParser();
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckAppValid) {
    GlobalMockObject::verify();
    InputParser parser = InputParser();
    struct MsprofCmdInfo cmdInfo = { {nullptr} };
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckEnvironmentValid) {
    GlobalMockObject::verify();
    InputParser parser = InputParser();
    struct MsprofCmdInfo cmdInfo = { {nullptr} };
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckPythonPathValid) {
    GlobalMockObject::verify();
    InputParser parser = InputParser();
    struct MsprofCmdInfo cmdInfo = { {nullptr} };
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckDynProfValid)
{
    struct MsprofCmdInfo cmdInfo = { {nullptr} };
...
TEST_F(INPUT_PARSER_OPEN_STEST, ParamsCheck) {
    GlobalMockObject::verify();
    InputParser parser = InputParser();
...
TEST_F(INPUT_PARSER_OPEN_STEST, ASCEND_WORK_PATH)
{
...
TEST_F(INPUT_PARSER_OPEN_STEST, DefaultOutput)
{
    char *argv[] = {"msprof", "--aicpu=on", "python3", "test.py", nullptr};
    optind = 1;
    InputParser parser = InputParser();
...
TEST_F(INPUT_PARSER_OPEN_STEST, SetHostSysParam) {
    GlobalMockObject::verify();
    InputParser parser = InputParser();
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckBaseOrder) {
...
TEST_F(INPUT_PARSER_OPEN_STEST, CheckBaseInfo) {
    GlobalMockObject::verify();
...
TEST_F(INPUT_PARSER_OPEN_STEST, PreCheckPlatform) {
    InputParser parser = InputParser();
    struct MsprofCmdInfo cmdInfo = { {nullptr} };
...
TEST_F(INPUT_PARSER_OPEN_STEST, MsprofFreqCheckValid) {
    InputParser parser = InputParser();
    struct MsprofCmdInfo cmdInfo = { {nullptr} };
...
TEST_F(INPUT_PARSER_OPEN_STEST, GetAppPath) {
    GlobalMockObject::verify();
...
TEST_F(INPUT_PARSER_OPEN_STEST, GetCmdString) {
    GlobalMockObject::verify();
...
TEST_F(INPUT_PARSER_OPEN_STEST, MsprofCmdCheckValid) {
    InputParser parser = InputParser();
    struct MsprofCmdInfo cmdInfo = { {nullptr} };
    cmdInfo.args[ARGS_DYNAMIC_PROF] = "on";
