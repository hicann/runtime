...
class AclApiCloudStest : public testing::Test {
protected:
...
TEST_F(AclApiCloudStest, AclApiDefault)
{
    ...
    std::vector<std::string> deviceDataList = {"aicore.data", "ts_track.data", "l2_cache.data"};
...
TEST_F(AclApiCloudStest, AclApiSetConfig)
{
    uint32_t deviceIdList[1] = {devId};
    aclprofAicoreMetrics aicoreMetrics = ACL_AICORE_ARITHMETIC_UTILIZATION;
    aclprofAicoreEvents *aicoreEvents = nullptr;
...
TEST_F(AclApiCloudStest, AclApiSetConfigHostSysUsage)
{
    uint32_t deviceIdList[1] = {devId};
    aclprofAicoreMetrics aicoreMetrics = ACL_AICORE_ARITHMETIC_UTILIZATION;
    aclprofAicoreEvents *aicoreEvents = nullptr;
...
TEST_F(AclApiCloudStest, AclApiSetConfigError)
{
