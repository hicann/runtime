...
class COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST: public testing::Test {
protected:
    virtual void SetUp() {
    }
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckProfilingParams) {
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckProfilingIntervalIsValid) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckSystemTraceSwitchProfiling) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckControlSwitchProfiling) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
    params->taskTsfw = "asd";
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckTsSwitchProfiling) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckPmuSwitchProfiling) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckAivEventCoresIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckTsCpuEventIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckDdrEventsIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckHbmEventsIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
    std::vector<std::string> events = {"read","write","read","write","read","write","read","write","read","write"};
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckAivEventsIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
    const std::vector<std::string> aiv;
    EXPECT_EQ(true, entry->CheckAivEventsIsValid(aiv));
}

TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckAppNameIsValid) {
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckProfilingParams1) {
    std::shared_ptr<analysis::dvvp::message::ProfileParams> params(new analysis::dvvp::message::ProfileParams());
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, Init) {
    GlobalMockObject::verify();
    EXPECT_EQ(0, analysis::dvvp::common::validation::ParamValidation::instance()->Init());
}

TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, UnInit) {
    GlobalMockObject::verify();
    EXPECT_EQ(0, analysis::dvvp::common::validation::ParamValidation::instance()->Uninit());
}

TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckLlcEventsIsValid) {
    GlobalMockObject::verify();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckEventsSize)
{
    GlobalMockObject::verify();
    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckSocPmuEventsValid) {
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, IsValidSleepPeriod) {
    GlobalMockObject::verify();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckHostSysOptionsIsValid) {
    GlobalMockObject::verify();

    auto entry = analysis::dvvp::common::validation::ParamValidation::instance();
    std::string hostSysOptions;
    EXPECT_EQ(false, entry->CheckHostSysOptionsIsValid(hostSysOptions));
    hostSysOptions = "COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST/CheckHostSysOptionsIsValid";
    EXPECT_EQ(false, entry->CheckHostSysOptionsIsValid(hostSysOptions));
    hostSysOptions = "cpu";
    EXPECT_EQ(true, entry->CheckHostSysOptionsIsValid(hostSysOptions));
}

TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckHostSysPidIsValid) {
    GlobalMockObject::verify();
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckStorageLimit) {
    using namespace analysis::dvvp::common::validation;
...
TEST_F(COMMON_VALIDATION_PARAM_VALIDATION_OPEN_STEST, CheckInstrProfilingFreqValid) {
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
        .will(returnValue(PlatformType::CHIP_V4_1_0));
