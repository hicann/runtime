...
TEST_F(DEVPROF_API_UTEST, Stop_func_nullptr) { EXPECT_EQ(PROFILING_FAILED, DevprofApi::Instance()->Stop()); }

TEST_F(DEVPROF_API_UTEST, GetIsExit_func_nullptr) { EXPECT_EQ(PROFILING_FAILED, DevprofApi::Instance()->GetIsExit()); }
...
TEST_F(DEVPROF_API_UTEST, AdprofCheckFeatureIsOn_c_api) { EXPECT_EQ(PROFILING_FAILED, AdprofCheckFeatureIsOn(0)); }

TEST_F(DEVPROF_API_UTEST, AdprofGetHashId_c_api) { EXPECT_EQ(PROFILING_FAILED, AdprofGetHashId("hash", 4)); }
...
TEST_F(DEVPROF_API_UTEST, AdprofGetBatchReportMaxSize_c_api) { EXPECT_EQ(0U, AdprofGetBatchReportMaxSize(0)); }

TEST_F(DEVPROF_API_UTEST, AdprofReportData_c_api) { EXPECT_EQ(PROFILING_FAILED, AdprofReportData((void*)"data", 4)); }

TEST_F(DEVPROF_API_UTEST, AdprofAicpuStop_c_api) { EXPECT_EQ(PROFILING_FAILED, AdprofAicpuStop()); }
...
TEST_F(DEVPROF_API_UTEST, AdprofStop_c_api) { EXPECT_EQ(PROFILING_FAILED, AdprofStop()); }

TEST_F(DEVPROF_API_UTEST, GetIsExit_c_api) { EXPECT_EQ(true, GetIsExit()); }
