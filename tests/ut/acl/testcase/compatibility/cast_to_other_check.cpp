...
TEST_F(UTEST_ACL_compatibility_cast_check, aclrtStreamAttr)
{
    ...
    EXPECT_EQ((uint64_t)ACL_STREAM_ATTR_PRIORITY, (uint64_t)RT_STREAM_ATTR_PRIORITY);
    EXPECT_EQ((uint64_t)ACL_STREAM_LAUNCH_BLOCKING_MODE, (uint64_t)RT_STREAM_ATTR_LAUNCH_BLOCKING_MODE);
