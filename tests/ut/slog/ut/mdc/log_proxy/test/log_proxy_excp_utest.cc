...
class MDC_LOG_PROXY_EXCP_UTEST : public testing::Test
{
    protected:
        virtual void SetUp()
        {
...
void MDC_LOG_PROXY_EXCP_UTEST::LogProxyCreateLogFile()
{
    system("> " LOG_FILE);
...
void MDC_LOG_PROXY_EXCP_UTEST::LogProxyReset()
{
    g_iamFd = INVALID;
...
/**
 * @brief       : log_proxy ioctl himem failed
 * @return      : NA
 */
TEST_F(MDC_LOG_PROXY_EXCP_UTEST, LogProxyIoctlHimemFail)
{
