...
// stub for bbox_proc
void BboxStartMainThread(void) { return; }

void BboxStopMainThread(void) { return; }

// stub for stackcore
int StackMonitor(void) { return 0; }

void StackRegisterPrint(void (*printFunc)(const char* format, ...)) { return; }
...
int32_t AdxSendMsgByHandle(const CommHandle* handle, CmdClassT type, IdeString data, uint32_t len) { return 0; }
...
int32_t AdxServiceCleanup(int32_t serverType) { return 0; }
...
int LogGetCpuAlarmNum(void) { return g_cpuAlarmNum; }

int LogGetCpuStatNum(void) { return g_cpuStatNum; }

int LogGetMemAlarmNum(void) { return g_memAlarmNum; }

int LogGetMemStatNum(void) { return g_memStatNum; }

int LogGetFdAlarmNum(void) { return g_fdAlarmNum; }

int LogGetFdTopNum(void) { return g_fdTopNum; }

int LogGetFdStatNum(void) { return g_fdStatNum; }

int LogGetZpAlarmNum(void) { return g_zpAlarmNum; }

int LogGetZpStatNum(void) { return g_zpStatNum; }

int LogGetFrameStart(void) { return g_frameStart; }
...
void AdxDestroyCommHandle(AdxCommHandle handle) { return; }

int AdxRegisterService(
    int serverType, ComponentType componentType, AdxComponentInit init, AdxComponentProcess process,
    AdxComponentUnInit uninit)
{
    return 0;
}

int AdxUnRegisterService(int32_t serverType, ComponentType componentType) { return 0; }
