    ...
    OptionalInfo &opti_compilation_info)
{
    ...
    platform_info.ai_core_spec.l0_a_size = 100;
    platform_info.ai_core_spec.l0_b_size = 200;
    platform_info.ai_core_spec.l0_c_size = 300;
    platform_info.ai_core_spec.l1_size = 400;
