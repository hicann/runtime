...
class DupRegisterManagerUtest : public testing::Test {
protected:
    virtual void SetUp() {}
...
TEST_F(DupRegisterManagerUtest, Test_CreateRegisterFail)
{
...
TEST_F(DupRegisterManagerUtest, Test_CreateRegisterNotSupport)
{
    uint32_t v4type = 15;
...
TEST_F(DupRegisterManagerUtest, Test_CreateRegister)
{
    uint32_t v2type = 5;
