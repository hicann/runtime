...
#include <sys/epoll.h>
using namespace Adx;
class ADX_SOCK_EPOLL_UTEST : public testing::Test {
protected:
    virtual void SetUp() {}
...
TEST_F(ADX_SOCK_EPOLL_UTEST, EpollCreate)
{
    std::shared_ptr<Adx::AdxEpoll> epoll = nullptr;
    epoll = std::make_shared<Adx::AdxSockEpoll>();

    const int invalidSize = -1;
    EXPECT_EQ(-1, epoll->EpollCreate(invalidSize));

    MOCKER(epoll_create).stubs().will(returnValue(-1)).then(returnValue(0));

    const int validSize = 1;
    EXPECT_EQ(-1, epoll->EpollCreate(validSize));
    EXPECT_EQ(0, epoll->EpollCreate(validSize));
}

TEST_F(ADX_SOCK_EPOLL_UTEST, EpollDestroy)
{
    std::shared_ptr<Adx::AdxEpoll> epoll = nullptr;
    epoll = std::make_shared<Adx::AdxSockEpoll>();
...
TEST_F(ADX_SOCK_EPOLL_UTEST, EpollCtl)
{
    std::shared_ptr<Adx::AdxEpoll> epoll = nullptr;
    epoll = std::make_shared<Adx::AdxSockEpoll>();
    const int validSize = 1;
...
TEST_F(ADX_SOCK_EPOLL_UTEST, EpollAdd)
{
    std::shared_ptr<Adx::AdxEpoll> epoll = nullptr;
    epoll = std::make_shared<Adx::AdxSockEpoll>();
    const int validSize = 1;
...
TEST_F(ADX_SOCK_EPOLL_UTEST, EpollDel)
{
    std::shared_ptr<Adx::AdxEpoll> epoll = nullptr;
    epoll = std::make_shared<Adx::AdxSockEpoll>();
    const int validSize = 1;
...
TEST_F(ADX_SOCK_EPOLL_UTEST, EpollWait)
{
    std::shared_ptr<Adx::AdxEpoll> epoll = nullptr;
    epoll = std::make_shared<Adx::AdxSockEpoll>();
...
TEST_F(ADX_SOCK_EPOLL_UTEST, EpollErrorHandle)
{
    std::shared_ptr<Adx::AdxEpoll> epoll = nullptr;
    epoll = std::make_shared<Adx::AdxSockEpoll>();
...
TEST_F(ADX_SOCK_EPOLL_UTEST, EpollGetSize)
{
    std::shared_ptr<Adx::AdxEpoll> epoll = nullptr;
    epoll = std::make_shared<Adx::AdxSockEpoll>();
