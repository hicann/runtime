...
TEST_F(FILE_UTILS_TEST, WriteFile)
{
...
TEST_F(FILE_UTILS_TEST, AddMappingFileItem)
{
...
TEST_F(FILE_UTILS_TEST, CreateDir)
{
...
TEST_F(FILE_UTILS_TEST, IsFileExist)
{
    std::string path;
...
TEST_F(FILE_UTILS_TEST, IsDiskFull)
{
...
TEST_F(FILE_UTILS_TEST, GetFileDir)
{
...
TEST_F(FILE_UTILS_TEST, GetFileName)
{
...
TEST_F(FILE_UTILS_TEST,  CheckNonCrossPath)
{
...
TEST_F(FILE_UTILS_TEST,  IsValidDirChar)
{
...
TEST_F(FILE_UTILS_TEST, IpValid)
{
...
TEST_F(FILE_UTILS_TEST, FilePathIsReal)
{
    const std::string path = "/home/test/test123.log";
    std::string dir = Adx::FileUtils::GetFileDir(path);
    std::string path1;
...
TEST_F(FILE_UTILS_TEST, FileNameIsReal)
{
    const std::string path = "/home/test/test123.log";
    std::string dir = Adx::FileUtils::GetFileDir(path);
    std::string path1;
...
TEST_F(FILE_UTILS_TEST, ReplaceAll)
{
