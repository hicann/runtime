...
class TinyAdumpApiStest : public testing::Test {
protected:
    virtual void SetUp() {}
...
void TinyAdumpApiStest::EnableOperatorDump()
{
    DumpConfig dumpConf;
...
TEST_F(TinyAdumpApiStest, Test_EnableOperatorDump)
{
    DumpConfig dumpConf;
    dumpConf.dumpPath = "/path/to/dump/dir";
    dumpConf.dumpStatus = "on";
...
TEST_F(TinyAdumpApiStest, Test_EnableOperatorOverflowDump)
{
    DumpConfig dumpConf;
    dumpConf.dumpPath = "/path/to/dump/dir";
    dumpConf.dumpStatus = "on";
...
TEST_F(TinyAdumpApiStest, Test_DisableOperatorDump)
{
    DumpConfig dumpConf;
    dumpConf.dumpPath = "";
...
TEST_F(TinyAdumpApiStest, Test_DisableOperatorOverflowDump)
{
    DumpConfig dumpConf;
    dumpConf.dumpPath = "";
    dumpConf.dumpStatus = "off";
...
TEST_F(TinyAdumpApiStest, Test_AdumpDumpTensor)
{
    EnableOperatorDump();
...
TEST_F(TinyAdumpApiStest, Test_AdumpDumpTensor_With_TensorNotOnDevice)
{
    EnableOperatorDump();
...
TEST_F(TinyAdumpApiStest, Test_AdumpDumpTensor_with_DumpStatus_off)
{
    DumpConfig dumpConf;
    dumpConf.dumpStatus = "off";
    EXPECT_EQ(AdumpSetDumpConfig(DumpType::OPERATOR, dumpConf), ADUMP_SUCCESS);
...
TEST_F(TinyAdumpApiStest, Test_ExceptionDump_Async)
{
...
TEST_F(TinyAdumpApiStest, Test_ExceptionDump_Async_OverFlow)
{
...
TEST_F(TinyAdumpApiStest, Test_ExceptionDump_Async_SetDevice)
{
...
TEST_F(TinyAdumpApiStest, Test_ArgsException_AdumpGetDFXInfoAddr)
{
...
TEST_F(TinyAdumpApiStest, Test_ArgsException_GetSizeInfoAddr)
{
...
TEST_F(TinyAdumpApiStest, Test_ArgsException_GetSizeInfoAddr_With_Right_Addr)
{
    uint32_t index = 0;
    DumpConfig DumpConf;
    DumpConf.dumpPath = "";
...
TEST_F(TinyAdumpApiStest, Test_GetEnv_Exception)
{
...
TEST_F(TinyAdumpApiStest, Test_AdumpSetDump)
{
...
TEST_F(TinyAdumpApiStest, Test_AdumpUnSetDump)
{
...
TEST_F(TinyAdumpApiStest, Test_AdumpGetDumpSwitch)
{
    DumpConfig dumpConf;
    dumpConf.dumpPath = "/path/to/dump/dir";
    dumpConf.dumpStatus = "on";
...
TEST_F(TinyAdumpApiStest, Test_AdumpPrintWorkSpace)
{
