...
class TinyExceptionDumperStest : public testing::Test {
protected:
    virtual void SetUp() {}
...
TEST_F(TinyExceptionDumperStest, Test_ExceptionDump_DumpData)
{
...
TEST_F(TinyExceptionDumperStest, Test_ExceptionDump_DumpData_LongName)
{
...
TEST_F(TinyExceptionDumperStest, Test_ExceptionDump_DumpData_Exception)
{
...
TEST_F(TinyExceptionDumperStest, Test_ExceptionDump_DumpData_RealPath)
{
...
TEST_F(TinyExceptionDumperStest, Test_ExceptionDump_DumpData_AddMapping_Failed)
{
...
TEST_F(TinyExceptionDumperStest, Test_ExceptionDump_DumpData_Write_Mapping_Failed)
{
...
TEST_F(TinyExceptionDumperStest, Test_DumpException)
{
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_ResidentOp)
{
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_FFTS_PLUS)
{
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_With_CreateDumpDirector_Fail)
{
    Tools::CaseWorkspace ws("Test_DumpException_FFTS_PLUS");
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_ResidentOp_Coredump)
{
    Tools::CaseWorkspace ws("Test_DumpException_ResidentOp");
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_Coredump_SetConfig_Failed)
{
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_ExceptionDumperInit)
{
    DumpConfig dumpConf;
    dumpConf.dumpPath = "";
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_DumpException_ExceptionFail)
{
    rtExceptionInfo exception = BuildRtException(1, 2, 3);
    ExceptionDumper dumper;
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_DumpException_ArgsException)
{
    rtExceptionInfo exception = BuildRtException(1, 2, 3);
    ExceptionDumper dumper;
    dumper.destructionFlag_ = false;
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_DumpException_NotSupport)
{
    rtExceptionInfo exception = BuildRtException(1, 2, 3);
    ExceptionDumper dumper;
    dumper.destructionFlag_ = false;
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_ExceptionModeDowngrade)
{
    ExceptionDumper dumper;
    dumper.destructionFlag_ = false;
    dumper.coredumpStatus_ = false;
...
TEST_F(TinyExceptionDumperStest, Test_DumpException_Exit)
{
    ExceptionDumper dumper;
    dumper.destructionFlag_ = false;
    dumper.coredumpStatus_ = false;
