...
class TinyDumpManagerStest : public testing::Test {
protected:
    virtual void SetUp() {}
...
TEST_F(TinyDumpManagerStest, Test_SetDumpConfig)
{
...
TEST_F(TinyDumpManagerStest, Test_UnSetDumpConfig)
{
...
TEST_F(TinyDumpManagerStest, Test_GetKFCInitStatus)
{
    DumpManager::Instance().SetKFCInitStatus(false);
    EXPECT_EQ(DumpManager::Instance().GetKFCInitStatus(), false);
}

TEST_F(TinyDumpManagerStest, Test_ExceptionModeDowngrade)
{
