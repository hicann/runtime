...
class ADX_HDC_INTERFACE_STEST : public testing::Test {
protected:
    virtual void SetUp() {}
    virtual void TearDown() { GlobalMockObject::verify(); }
};

TEST_F(ADX_HDC_INTERFACE_STEST, AdxSendMsgAndGetResultByType)
{
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxSendMsgAndNoResultByType)
{
    const char* value = "a.txt;b.txt;123";
    struct tlv_req* req = NULL;
    req = (struct tlv_req*)IdeXmalloc(sizeof(struct tlv_req) + strlen(value) + 10);
...
TEST_F(ADX_HDC_INTERFACE_STEST, ReadSettingResultNotEnd)
{
    const char* value = "a.txt;b.txt;123";
    struct tlv_req* req = NULL;
    req = (struct tlv_req*)IdeXmalloc(sizeof(struct tlv_req) + strlen(value) + 10);
...
TEST_F(ADX_HDC_INTERFACE_STEST, ReadSettingResultEnd)
{
    const char* value = "a.txt;b.txt;123";
    struct tlv_req* req = NULL;
    req = (struct tlv_req*)IdeXmalloc(sizeof(struct tlv_req) + strlen(value) + 10);
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxSendMsgByHandle)
{
    HDC_SESSION session = (HDC_SESSION)0x12345678;
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxSendFileByHandle)
{
    HDC_SESSION session = (HDC_SESSION)0x12345678;
    CommHandle handle{COMM_HDC, (OptHandle)session};
    char* src = "/home/src";
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxCreateCommHandle)
{
    AdxCommHandle handle = AdxCreateCommHandle((enum drvHdcServiceType)3, 7, COMPONENT_GETD_FILE);
    EXPECT_EQ(0, AdxIsCommHandleValid(handle));
    EXPECT_EQ(COMM_HDC, handle->type);
    EXPECT_EQ(COMPONENT_GETD_FILE, handle->comp);
    EXPECT_NE(nullptr, handle->client);
    ...
    int val = -1;
    EXPECT_EQ(0, Adx::IdeGetDevIdBySession(handle, &val));
    EXPECT_EQ(0, Adx::IdeGetRunEnvBySession(handle, &val));
    EXPECT_EQ(0, Adx::IdeGetVfIdBySession(handle, &val));
    ...
    MOCKER(strncpy_s).stubs().will(invoke(StrncpyStub));

    EXPECT_EQ(0, AdxRecvMsg((AdxCommHandle)handle, &get, &len, -1));
    IdeXfree(get);
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxCreateRecvLenFail)
{
    AdxCommHandle handle = AdxCreateCommHandle((enum drvHdcServiceType)3, 7, COMPONENT_GETD_FILE);
    EXPECT_EQ(0, AdxIsCommHandleValid(handle));
    EXPECT_EQ(COMM_HDC, handle->type);
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxCreateReadLessFail)
{
    AdxCommHandle handle = AdxCreateCommHandle((enum drvHdcServiceType)3, 7, COMPONENT_GETD_FILE);
    EXPECT_EQ(0, AdxIsCommHandleValid(handle));
    EXPECT_EQ(COMM_HDC, handle->type);
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxCreateCommHandleGetCapacityFailed)
{
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxCreateCommHandleSessionConnectFailed)
{
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxCreateCommHandleClientCreateFailed)
{
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxCreateCommHandleSendMsgFailed)
{
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdcoreInterfaceInvalidInput)
{
    AdxCommConHandle handle = AdxCreateCommHandle((enum drvHdcServiceType)3, 7, COMPONENT_GETD_FILE);
...
TEST_F(ADX_HDC_INTERFACE_STEST, HdcReadTimeout)
{
...
TEST_F(ADX_HDC_INTERFACE_STEST, HdcReadPackageLenFailed)
{
    OptHandle session = (OptHandle)0x123456;
    char* result;
...
TEST_F(ADX_HDC_INTERFACE_STEST, HdcReadNoDeviceFailed)
{
    OptHandle session = (OptHandle)0x123456;
    char* result;
...
TEST_F(ADX_HDC_INTERFACE_STEST, HdcReuseMsgFailed)
{
    OptHandle session = (OptHandle)0x123456;
    char* result;
...
TEST_F(ADX_HDC_INTERFACE_STEST, HdcReadTimeoutFailed)
{
    OptHandle session = (OptHandle)0x123456;
    char* result;
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxDevCommShortLink)
{
...
TEST_F(ADX_HDC_INTERFACE_STEST, AdxDevCommShortLinkFail)
{
    AdxHdcServiceType type = HDC_SERVICE_TYPE_IDE_FILE_TRANS;
    std::string value = "value";
