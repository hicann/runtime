...
INT32 mmCreateTaskWithThreadAttr_stub2(mmThread *threadHandle, const mmUserBlock_t *funcBlock, const mmThreadAttr *threadAttr)
{
    g_count++;
    if(g_count < 4)
    {
...
INT32 mmCreateTaskWithThreadAttr_stub3(mmThread *threadHandle, const mmUserBlock_t *funcBlock, const mmThreadAttr *threadAttr)
{
    g_count++;
    if(g_count <=4)
    {
...
INT32 mmCreateTaskWithThreadAttr_stub4(mmThread *threadHandle, const mmUserBlock_t *funcBlock, const mmThreadAttr *threadAttr)
{
    g_count++;
