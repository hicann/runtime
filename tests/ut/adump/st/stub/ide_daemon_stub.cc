...
int ide_stub_get_tlv_len(struct tlv_req* req) { return sizeof(struct tlv_req) + req->len; }

hdcError_t ide_hdc_host_drvHdcRecv_stub(
...
hdcError_t ide_hdc_host_drvHdcRecv_stub1(
    HDC_SESSION session, struct drvHdcMsg* msg, int bufLen, unsigned long long flag, int* recvBufCount,
    unsigned int timeout)
{
    g_ide_recv_time++;
...
hdcError_t ide_hdc_host_drvHdcGetMsgBuffer_stub(struct drvHdcMsg* msg, int index, char** pBuf, int* pLen)
{
    int len = 0;
    struct tlv_req* tmp = NULL;
...
hdcError_t ide_hdc_host_drvHdcGetMsgBuffer_stub2(struct drvHdcMsg* msg, int index, char** pBuf, int* pLen)
{
    int len = 0;
    int string_len = 0;
    char* tmp = NULL;
...
hdcError_t ide_hdc_host_drvHdcGetMsgBuffer_stub1(struct drvHdcMsg* msg, int index, char** pBuf, int* pLen)
{
    int len = 0;
    int string_len = 0;
    char* tmp = NULL;
...
hdcError_t IdeHdcDeviceDrvHdcGetMsgBufferStub(struct drvHdcMsg* msg, int index, char** pBuf, int* pLen)
{
    int len = 0;
    struct tlv_req* tmp = NULL;
    struct IdeHdcPacket* packet = NULL;
...
int hdc_init_mock(void) { return IDE_DAEMON_OK; }

int debug_init_mock(void) { return IDE_DAEMON_OK; }

int bbox_init_mock() { return IDE_DAEMON_OK; }

int log_init_mock(void) { return IDE_DAEMON_OK; }

int profile_init_mock() { return IDE_DAEMON_OK; }

int hdc_destroy_mock(void) { return IDE_DAEMON_OK; }

int debug_destroy_mock(void) { return IDE_DAEMON_OK; }

int bbox_destroy_mock(void) { return IDE_DAEMON_OK; }

int log_destroy_mock(void) { return IDE_DAEMON_OK; }

int profile_destroy_mock(void) { return IDE_DAEMON_OK; }

int debug_dev_process_stub(HDC_SESSION session, const struct tlv_req* req) { return IDE_DAEMON_OK; }

int debug_host_process_stub(void* sock_desc, HDC_CLIENT client, const struct tlv_req* req) { return IDE_DAEMON_OK; }
...
void _exit_stub(int exit_code) { return; }

#ifdef __cplusplus
extern "C" {
#endif

int HdclogDeviceInit() { return IDE_DAEMON_OK; }

int HdclogDeviceDestroy() { return IDE_DAEMON_OK; }

int HdclogHostInit() { return IDE_DAEMON_OK; }

int HdclogHostDestroy() { return IDE_DAEMON_OK; }

int IdeDeviceLogProcess(HDC_SESSION session, const struct tlv_req* req) { return IDE_DAEMON_OK; }
int BboxSockCommandProcess(void* sock_desc, HDC_CLIENT client, const struct tlv_req* req) { return IDE_DAEMON_OK; }
int BboxRemoteInit(void) { return IDE_DAEMON_OK; }

int BboxRemoteDestroy(void) { return IDE_DAEMON_OK; }

int BboxDevStartupNotify(uint32_t num, uint32_t* dev) { return IDE_DAEMON_OK; }

int BboxHostInit(void) { return IDE_DAEMON_OK; }

int BboxHostDestroy(void) { return IDE_DAEMON_OK; }

int BboxDaemonInit(void) { return IDE_DAEMON_OK; }

int BboxDaemonDestroy(void) { return IDE_DAEMON_OK; }

int IdeHostProfileInit() { return IDE_DAEMON_OK; }
int IdeHostProfileCleanup() { return IDE_DAEMON_OK; }
int IdeDeviceProfileInit() { return IDE_DAEMON_OK; }

int IdeDeviceProfileCleanup() { return IDE_DAEMON_OK; }

int IdeHostProfileProcess(void* sock_desc, HDC_CLIENT client, const struct tlv_req* req) { return IDE_DAEMON_OK; }

int IdeDeviceProfileProcess(HDC_SESSION session, const struct tlv_req* req) { return IDE_DAEMON_OK; }

int IdeCmdProfileInit() { return IDE_DAEMON_OK; }

int IdeCmdProfileCmdRes(const char* str, int len) { return IDE_DAEMON_OK; }

int IdeHostLogProcess(void* sock_desc, HDC_CLIENT client, const struct tlv_req* req) { return IDE_DAEMON_OK; }

int IdeCmdLogProcess(int sockfd, unsigned int dev_id, const char* cmd) { return IDE_DAEMON_OK; }

void StackInit(void){};

void dlog_init(void){};

int DlogSetAttr(LogAttr logAttr) { return IDE_DAEMON_OK; }
...
int CheckLogLevel(int moduleId, int level) { return 0; }

int BboxHDCAddSesssion(HDC_SESSION session, const struct tlv_req* req) { return 0; }
...
int scanf_s_ret = 0;
int scanf_s(const char* format, ...) { return scanf_s_ret--; }

void PrintIdeSelfLog(IdeString logFile, IdeString format, ...) { return; }
int close_stub(int fd) { return 0; }

int free_stub(int fd) { return 0; }

errno_t strncpy_s(char* strDest, size_t destMax, const char* strSrc, size_t count) { return 0; }

void DlogFlush(void) { return; }
