...
drvError_t halBindCgroupStub(BIND_CGROUP_TYPE bindType) { return DRV_ERROR_NONE; }

drvError_t halBindCgroup(BIND_CGROUP_TYPE bindType) { return halBindCgroupStub(bindType); }
...
int log_read_by_type(int device_id, char* buf, unsigned int* size, int timeout, enum log_channel_type channel_type)
{
    ...
    snprintf_s(
        buf + sizeof(head), *size - sizeof(head), *size - 1 - sizeof(head),
...
int32_t log_read_by_type_stub_start(
...
int32_t log_read_by_type_stub_middle(
    int device_id, char* buf, unsigned int* size, int timeout, enum log_channel_type channel_type)
{
    (void)device_id;
    (void)channel_type;
...
int32_t log_read_by_type_stub_end(
    int device_id, char* buf, unsigned int* size, int timeout, enum log_channel_type channel_type)
{
    (void)device_id;
    (void)channel_type;
...
int32_t log_read_by_type_stub_size_over(
    int device_id, char* buf, unsigned int* size, int timeout, enum log_channel_type channel_type)
{
    static int i = 0;
...
int32_t log_read_by_type_stub_invalid(
    int device_id, char* buf, unsigned int* size, int timeout, enum log_channel_type channel_type)
{
    (void)device_id;
    (void)channel_type;
