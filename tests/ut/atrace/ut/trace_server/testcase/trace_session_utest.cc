...
// session mgr
static void TraceServerFuncStub(SessionNode* sessionNode, int8_t listFlag) { return; }
...
TEST_F(TraceSessionUtest, TraceGetSessionNodeInvalidInput) { EXPECT_EQ(NULL, TraceServerGetSessionNode(-1, -1)); }
