...
class QsArgsParserUtest : public ::testing::Test {
public:
    virtual void SetUp() {}
...
TEST_F(QsArgsParserUtest, ParseArgsSuccess1)
{
...
TEST_F(QsArgsParserUtest, ParseArgsSuccess2)
{
...
TEST_F(QsArgsParserUtest, ParseArgsFail1)
{
...
TEST_F(QsArgsParserUtest, ParseArgsFail2)
{
    // missed required para
    const uint32_t vfId = 5U;
    const std::string pidSign = "00000000";
...
TEST_F(QsArgsParserUtest, ParseArgsFail3)
{
    ArgsParser argsParser;
    int32_t argc = 0;
    const char *argv[] = {
...
TEST_F(QsArgsParserUtest, ParseSingleParaSuccess)
{
...
TEST_F(QsArgsParserUtest, ParseSingleParaFail1)
{
    // No "=" in input para
...
TEST_F(QsArgsParserUtest, ParseSingleParaFail2)
{
    // unknown key in para
...
TEST_F(QsArgsParserUtest, ParseSingleParaFail3)
{
...
TEST_F(QsArgsParserUtest, GetParaParsedStrSuccess)
{
...
TEST_F(QsArgsParserUtest, ParseDeviceIdSuccess)
{
    ArgsParser argsParser;
...
TEST_F(QsArgsParserUtest, ParseDeviceIdFail1)
{
    ArgsParser argsParser;
...
TEST_F(QsArgsParserUtest, ParseDeviceIdFail2)
{
    ArgsParser argsParser;
...
TEST_F(QsArgsParserUtest, ParseVfIdSuccess)
{
    ArgsParser argsParser;
    const std::string para = "1";
...
TEST_F(QsArgsParserUtest, ParseVfIdFail1)
{
    ArgsParser argsParser;
    const std::string para = "asd";
    const bool ret = argsParser.ParseVfId(para);
...
TEST_F(QsArgsParserUtest, ParseVfIdFail2)
{
    ArgsParser argsParser;
    const std::string para = "99999";
    const bool ret = argsParser.ParseVfId(para);
...
TEST_F(QsArgsParserUtest, ParseAicpuLogLevel001)
{
    ArgsParser argsParser;
    const std::string para = "1";
...
TEST_F(QsArgsParserUtest, ParseAicpuLogLevel002)
{
    ArgsParser argsParser;
    const std::string para = "asd";
    const bool ret = argsParser.ParseAicpuLogLevel(para);
...
TEST_F(QsArgsParserUtest, ParseHostPidSuccess)
{
    ArgsParser argsParser;
    const std::string para = "1";
...
TEST_F(QsArgsParserUtest, ParseHostPidFail1)
{
    ArgsParser argsParser;
    const std::string para = "asd";
    const bool ret = argsParser.ParseHostPid(para);
...
TEST_F(QsArgsParserUtest, ParseHostPidFail2)
{
    ArgsParser argsParser;
    const std::string para = "-99999";
    const bool ret = argsParser.ParseHostPid(para);
...
TEST_F(QsArgsParserUtest, ParseLogAndEventLevelSuccess)
{
    ArgsParser argsParser;
...
TEST_F(QsArgsParserUtest, ParseLogAndEventLevelSuccessHost)
{
    ArgsParser argsParser;
    const std::string para = "102";
    const bool ret = argsParser.ParseLogAndEventLevel(para);
...
TEST_F(QsArgsParserUtest, ParseLogAndEventLevelFail1)
{
    ArgsParser argsParser;
    const std::string para = "asd";
    const bool ret = argsParser.ParseLogAndEventLevel(para);
...
TEST_F(QsArgsParserUtest, ParseLogAndEventLevelFail2)
{
    ArgsParser argsParser;
    const std::string para = "-1";
    const bool ret = argsParser.ParseLogAndEventLevel(para);
...
TEST_F(QsArgsParserUtest, ParseSignSuccess)
{
    ArgsParser argsParser;
...
TEST_F(QsArgsParserUtest, ParseSchedPolicy)
{
    ArgsParser argsParser;
    const std::string para = "asd";
...
TEST_F(QsArgsParserUtest, ParseReschedInterval)
{
    ArgsParser argsParser;
    const std::string para = "asd";
...
TEST_F(QsArgsParserUtest, ParseProfFlag)
{
    ArgsParser argsParser;
    const std::string para = "asd";
...
TEST_F(QsArgsParserUtest, ParseAbnormalInterval_001)
{
    ArgsParser argsParser;
    const std::string para = "asd";
...
TEST_F(QsArgsParserUtest, ParseAbnormalInterval_002)
{
    ArgsParser argsParser;
    const std::string para = "-1";
    const bool ret = argsParser.ParseAbnormalInterval(para);
...
TEST_F(QsArgsParserUtest, ParseResourceList_001)
{
    ArgsParser argsParser;
...
TEST_F(QsArgsParserUtest, ParseResourceList_002)
{
    ArgsParser argsParser;
...
TEST_F(QsArgsParserUtest, ParseResourceList_003)
{
    ArgsParser argsParser;
    const std::string para = "0,-1";
    const bool ret = argsParser.ParseResourceList(para);
