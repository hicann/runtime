...
class DgwClientUtest : public testing::Test {
protected:
    virtual void SetUp()
    {
    ...
    {
        std::cout << "DgwClientUtest SetUpTestCase" << std::endl;
        MOCKER_CPP(&QSFeatureCtrl::IsSupportSetVisibleDevices).stubs().will(returnValue(false));
    }

    static void TearDownTestCase()
    {
        std::cout << "DgwClientUtest TearDownTestCase" << std::endl;
        GlobalMockObject::verify();
...
TEST_F(DgwClientUtest, TestConstructDgwClient)
{
    std::shared_ptr<DgwClient> dgwClient = std::make_shared<DgwClient>(11U);
    EXPECT_EQ(-1, dgwClient->qsPid_);
}

TEST_F(DgwClientUtest, TestGetInstance)
{
...
TEST_F(DgwClientUtest, TestStubSo)
{
...
TEST_F(DgwClientUtest, CreateHcomHandle)
{
...
TEST_F(DgwClientUtest, CreateHcomHandleFailForUninited)
{
...
TEST_F(DgwClientUtest, CreateHcomHandleFailForEmptyRankTable)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
...
TEST_F(DgwClientUtest, DestroyHcomHandle)
{
    Mbuf *pmbuf = (Mbuf *)&buffer_;
    MOCKER(halMbufAlloc)
        .stubs().with(mockcpp::any(), outBoundP((Mbuf **)&pmbuf))
...
TEST_F(DgwClientUtest, DestroyHcomHandleForUninited)
{
    std::shared_ptr<DgwClient> uninitedDgwClient = DgwClient::GetInstance(1U);
    uint64_t handle = 0;
...
TEST_F(DgwClientUtest, DestroyHcomHandle01)
{
...
TEST_F(DgwClientUtest, FinalizeTest)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    EXPECT_EQ(dgwClient->Finalize(), static_cast<int32_t>(BQS_STATUS_OK));
}

TEST_F(DgwClientUtest, Initialize_Failed001)
{
    MOCKER(halQueueInit)
        .stubs()
        .will(returnValue(200));
...
TEST_F(DgwClientUtest, Initialize_Failed002)
{
    MOCKER(halQueueInit)
        .stubs()
...
TEST_F(DgwClientUtest, Initialize_Failed003)
{
    MOCKER(halQueueInit)
        .stubs()
        .will(returnValue(DRV_ERROR_NONE));
...
TEST_F(DgwClientUtest, Initialize_Failed_For_AttachDeviceFail) {
...
TEST_F(DgwClientUtest, QueryConfigFailForUninited)
{
    ConfigQuery query;
    ConfigInfo cfgInfo;
    std::shared_ptr<DgwClient> uninitedDgwClient = DgwClient::GetInstance(1U);
...
TEST_F(DgwClientUtest, QueryConfigNumFailForUninited)
{
    ConfigQuery query;
    std::shared_ptr<DgwClient> uninitedDgwClient = DgwClient::GetInstance(1U);
...
TEST_F(DgwClientUtest, GetQryConfigNumRetWhenCmdRetError)
{
    ConfigQuery query;
...
TEST_F(DgwClientUtest, GetOperateHcomHandleRetWhenCmdRetError)
{
    QueueSubEventType eventType = CREATE_QUEUE;
    HcomHandleInfo info;
    uintptr_t mbufData = 0UL;
    int32_t cmdRet = static_cast<int32_t>(BQS_STATUS_DRIVER_ERROR);
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
...
TEST_F(DgwClientUtest, CalcConfigInfoLenErr)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    ConfigInfo cfgInfo;
...
TEST_F(DgwClientUtest, GetOperateConfigRetDefault)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    ConfigInfo cfgInfo;
    cfgInfo.cmd = ConfigCmd::DGW_CFG_CMD_RESERVED;
...
TEST_F(DgwClientUtest, CalcResultLenDefault)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    ConfigInfo cfgInfo;
    cfgInfo.cmd = ConfigCmd::DGW_CFG_CMD_RESERVED;
...
TEST_F(DgwClientUtest, CalcConfigInfoLenMemQueueErr001)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
...
TEST_F(DgwClientUtest, CalcConfigInfoLenMemQueueErr002)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    dgwClient->isServerOldVersion_ = true;
    ConfigInfo cfgInfo;
...
TEST_F(DgwClientUtest, CalcConfigInfoLenMemQueueSucc001)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    dgwClient->isServerOldVersion_ = true;
    ConfigInfo cfgInfo;
...
TEST_F(DgwClientUtest, CalcConfigInfoLenMemQueueSucc002)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    dgwClient->isServerOldVersion_ = true;
    ConfigInfo cfgInfo;
...
TEST_F(DgwClientUtest, CalcConfigInfoLenMemQueueSucc003)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    dgwClient->isServerOldVersion_ = true;
    size_t cfgLen = 0U;
...
TEST_F(DgwClientUtest, CalcConfigInfoLenMemQueueSucc004)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    dgwClient->isServerOldVersion_ = true;
    size_t cfgLen = 0U;
...
TEST_F(DgwClientUtest, CalcConfigInfoLenMemQueueSucc005)
{
    MOCKER(memcpy_s)
        .stubs()
...
TEST_F(DgwClientUtest, CalcConfigInfoLenMemQueueSucc)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
    dgwClient->isServerOldVersion_ = true;
    ConfigInfo cfgInfo;
...
TEST_F(DgwClientUtest, WaitConfigEffect001)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(0U);
...
TEST_F(DgwClientUtest, WaitConfigEffect002)
{
...
TEST_F(DgwClientUtest, WaitConfigEffect003)
{
...
TEST_F(DgwClientUtest, WaitConfigEffect004)
{
...
TEST_F(DgwClientUtest, WaitConfigEffect005)
{
...
TEST_F(DgwClientUtest, WaitConfigEffectRsv001)
{
...
TEST_F(DgwClientUtest, WaitConfigEffectRsv002)
{
...
TEST_F(DgwClientUtest, WaitConfigEffectRsv003)
{
...
TEST_F(DgwClientUtest, WaitConfigEffectRsv004)
{
...
TEST_F(DgwClientUtest, WaitConfigEffectRsv005)
{
...
TEST_F(DgwClientUtest, WaitConfigEffectRsv006)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(10U);
    EXPECT_EQ(static_cast<int32_t>(BQS_STATUS_PARAM_INVALID), dgwClient->WaitConfigEffect(1, 1U));
}

TEST_F(DgwClientUtest, WaitConfigEffectRsv007)
{
...
TEST_F(DgwClientUtest, WaitConfigEffectRsv008)
{
...
TEST_F(DgwClientUtest, CreateHcomHandleOnOtherSide)
{
    std::shared_ptr<DgwClient> dgwClient = DgwClient::GetInstance(4U);
    dgwClient->initFlag_ = true;
...
TEST_F(DgwClientUtest, UpdateConfig_01)
{
...
TEST_F(DgwClientUtest, OperateToServerOnSameSide_Fail)
{
    Mbuf *pmbuf = (Mbuf *)&buffer_;
    MOCKER(halMbufAlloc)
        .stubs().with(mockcpp::any(), outBoundP((Mbuf **)&pmbuf))
...
TEST_F(DgwClientUtest, OperateToServerOnOtherSide_Fail)
{
    MOCKER(memcpy_s)
            .stubs()
            .will(returnValue(-1))
...
TEST_F(DgwClientUtest, GetQryRouteRet_Fail)
{
    MOCKER(memcpy_s)
            .stubs()
            .will(returnValue(-1));
...
TEST_F(DgwClientUtest, TestChangeUserDeviceIdToLogicDeviceIdSuccess001)
{
    char_t env[] = "7,6,5,4";
...
TEST_F(DgwClientUtest, TestGetVisibleDevices01)
{
    char_t env[] = "";
    MOCKER(getenv).stubs().will(returnValue(&env[0U]));
    MOCKER(drvGetDevNum).stubs().will(invoke(fake_drvGetDevNum));
...
TEST_F(DgwClientUtest, TestGetVisibleDevices02)
{
    char_t *env = nullptr;
...
TEST_F(DgwClientUtest, TestGetVisibleDevices03)
{
    char_t env[] = "4,5a,&6,7!";
    MOCKER(getenv).stubs().will(returnValue(&env[0U]));
    MOCKER(drvGetDevNum).stubs().will(invoke(fake_drvGetDevNum));
...
TEST_F(DgwClientUtest, TestGetVisibleDevices04)
{
    char_t env[] = ",4,5a,&6,7!";
    MOCKER(getenv).stubs().will(returnValue(&env[0U]));
    MOCKER(drvGetDevNum).stubs().will(invoke(fake_drvGetDevNum));
...
TEST_F(DgwClientUtest, TestGetVisibleDevices05)
{
    char_t env[] = "4,5,";
    MOCKER(getenv).stubs().will(returnValue(&env[0U]));
    MOCKER(drvGetDevNum).stubs().will(invoke(fake_drvGetDevNum));
...
TEST_F(DgwClientUtest, TestGetVisibleDevices06)
{
    char_t env[] = "4,5,5,7";
    MOCKER(getenv).stubs().will(returnValue(&env[0U]));
    MOCKER(drvGetDevNum).stubs().will(invoke(fake_drvGetDevNum));
...
TEST_F(DgwClientUtest, TestGetVisibleDevices07)
{
...
TEST_F(DgwClientUtest, TestGetVisibleDevices08)
{
    char_t env[] = "4,5,6,7";
    MOCKER(getenv).stubs().will(returnValue(&env[0U]));
    MOCKER(drvGetDevNum).stubs().will(invoke(fake_drvGetDevNum));
...
TEST_F(DgwClientUtest, TestGetVisibleDevices09)
{
...
TEST_F(DgwClientUtest, TestGetVisibleDevices10)
{
    char_t env[] = "4,5,6,7";
    MOCKER(getenv).stubs().will(returnValue(&env[0U]));
...
TEST_F(DgwClientUtest, TestGetPlatformInfo1)
{
...
TEST_F(DgwClientUtest, TestGetPlatformInfo2)
{
...
TEST_F(DgwClientUtest, IsSupportSetVisibleDevices1)
{
    auto ret = QSFeatureCtrl::IsSupportSetVisibleDevices(0);
    EXPECT_EQ(ret, false);
}

TEST_F(DgwClientUtest, GetInstanceFailed)
{
    GlobalMockObject::verify();
    GlobalMockObject::reset();
...
TEST_F(DgwClientUtest, IsSupportSetVisibleDevices2)
{
    GlobalMockObject::verify();
    GlobalMockObject::reset();
...
TEST_F(DgwClientUtest, ProcessEndpointDeviceId01)
{
    GlobalMockObject::verify();
    GlobalMockObject::reset();
    MOCKER_CPP(&QSFeatureCtrl::IsSupportSetVisibleDevices).stubs().will(returnValue(true));
...
TEST_F(DgwClientUtest, CalcConfigInfoLenIsSupportSetVisibleDevices01)
{
    GlobalMockObject::verify();
    GlobalMockObject::reset();
    MOCKER_CPP(&QSFeatureCtrl::IsSupportSetVisibleDevices).stubs().will(returnValue(true));
...
TEST_F(DgwClientUtest, CalcConfigInfoLenIsSupportSetVisibleDevices02)
{
    GlobalMockObject::verify();
    GlobalMockObject::reset();
    MOCKER_CPP(&QSFeatureCtrl::IsSupportSetVisibleDevices).stubs().will(returnValue(true));
