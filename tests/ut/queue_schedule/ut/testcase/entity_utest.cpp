...
class EntityUTest : public testing::Test {
protected:
    ...
    virtual void SetUp()
    {
        cout << "Before entity_utest" << endl;
    }
 
    virtual void TearDown()
    {
        cout << "after entity_utest" << endl;
        GlobalMockObject::verify();
    }
};

TEST_F(EntityUTest, GroupCheckTimeout_success_01)
{
...
TEST_F(EntityUTest, GroupSelectEntityWithMinTransId)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_GROUP;
    material.localInstanceIndex = 1U;
    ...
    EXPECT_EQ(entity1, group.SelectEntityWithMinTransId(entitiesInGroup));
}

TEST_F(EntityUTest, DoClientEnqueue_Fail)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
...
TEST_F(EntityUTest, SdmaCopy_Fail)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    material.id = 1001U;
...
TEST_F(EntityUTest, ClientEntity_DoDeQueue)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    material.id = 1001U;
...
TEST_F(EntityUTest, ClientEntity_DoDequeueMbuf)
{
    ...
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    material.queueType = 1U;
    dgw::ClientEntity entity(material, 0U);
    MOCKER(halQueueGetStatus)
        .stubs()
        .will(returnValue(DRV_ERROR_NO_DEVICE))
        .then(returnValue(DRV_ERROR_NONE));
...
TEST_F(EntityUTest, ClientEntity_DoClientDequeue)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    material.queueType = 1U;
...
TEST_F(EntityUTest, ClientEntity_DoSendData)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    material.queueType = 1U;
...
TEST_F(EntityUTest, ChannelEntity_ProcessReceiveCompletion_success)
{
...
TEST_F(EntityUTest, ChannelEntity_ProcessReceiveCompletion_fail)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_ResetSrcState)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_AddCachedReqCount)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_AllocMbuf_fail)
{
    bqs::BqsMsprofManager::GetInstance().isRun_ = true;
...
TEST_F(EntityUTest, Entity_DEFAULT_FUNCITON)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_GROUP;
    material.localInstanceIndex = 1U;
...
TEST_F(EntityUTest, GroupEntity_ResumeSubscribe_success)
{
    uint32_t groupId = 0U;
...
TEST_F(EntityUTest, GroupEntity_SelectSrcEntity_success)
{
    MOCKER(halQueueDeQueue).stubs().will(returnValue(DRV_ERROR_QUEUE_EMPTY));
    uint32_t groupId = 0U;
    uint32_t resIndex = 0U;
...
TEST_F(EntityUTest, ChannelEntity_Init_Fail)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
...
TEST_F(EntityUTest, ChannelEntity_CreateAndSubscribeCompletedQueue_Fail)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_DoProbe_Fail)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_Probe_Fail_Cache)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_ReceiveDataForLink_Fail)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_ReceiveMbufData_Fail)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_DoSendData_Fail)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_TAG;
    ChannelEntity entity(material, 0U);
...
TEST_F(EntityUTest, ChannelEntity_SendDataWithHccl_Fail)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_SendMbufData_Fail)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_SendDataForLink_Fail)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
    dgw::CommChannel channel(hcclComm, 1U, 1U, 0U, 1U, 1U, 1U);
...
TEST_F(EntityUTest, ChannelEntity_ProcessCompReq_Fail)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_TAG;
    ChannelEntity entity(material, 0U);
...
TEST_F(EntityUTest, ChannelEntity_ProcessCompReq_Success)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_TAG;
    ChannelEntity entity(material, 0U);
...
TEST_F(EntityUTest, ChannelEntity_ProcessSendCompletion_Error)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_TAG;
    ChannelEntity entity(material, 0U);
    ...
    MOCKER(halBuffGetInfo)
        .stubs()
        .with(mockcpp::any(), mockcpp::any(), mockcpp::any(), outBoundP(ptr), mockcpp::any())
        .will(returnValue(static_cast<int32_t>(DRV_ERROR_NONE)));
    MOCKER(halMbufUnBuild).stubs().will(returnValue((int)DRV_ERROR_NO_DEVICE));
    EXPECT_EQ(entity.ProcessSendCompletion(nullptr), FsmStatus::FSM_SUCCESS);
}

TEST_F(EntityUTest, Entity_AllowDeque)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    material.id = 1001U;
...
TEST_F(EntityUTest, Entity_SendData)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_GROUP;
    material.localInstanceIndex = 1U;
...
TEST_F(EntityUTest, EntityManager_RepeatedCreateGroup)
{
...
TEST_F(EntityUTest, EntityManager_RepeatedCreateEntity)
{
    EntityManager entityManager(0U);
...
TEST_F(EntityUTest, EntityManager_CreateEntity_Fail_For_Init)
{
    uint64_t hcclHandle = 100UL;
    HcclComm hcclComm = &hcclHandle;
...
TEST_F(EntityUTest, EntityManager_CreateEntity_Fail_For_AllocEntity)
{
    EntityManager entityManager(0U);
    EntityMaterial material = {};
...
TEST_F(EntityUTest, SupplyEventForRecvRequest)
{
    EntityManager entityManager(0U);
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_TAG;
...
TEST_F(EntityUTest, GroupEntity_SelectSrcEntity_Fail)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_GROUP;
    GroupEntity group(material, 0U);
...
TEST_F(EntityUTest, GroupEntity_SelectDstEntities_Fail_For_UnknownStrategy)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_GROUP;
    GroupEntity group(material, 0U);
...
TEST_F(EntityUTest, SimpleEntity_RefreshWithData_Fail)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    material.id = 1001U;
...
TEST_F(EntityUTest, SimpleEntity_SendData_Full)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
...
TEST_F(EntityUTest, SimpleEntity_DoSendData_Fail)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    SimpleEntity dstEntity1(material, 0U);
...
TEST_F(EntityUTest, SimpleEntity_SdmaCopyData_Fail)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    SimpleEntity dstEntity1(material, 0U);
...
TEST_F(EntityUTest, SimpleEntity_PauseSubscribe_Fail)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    SimpleEntity entity(material, 0U);
...
TEST_F(EntityUTest, SimpleEntity_ClearQueue_Success)
{
    dgw::EntityMaterial material = {};
    material.eType = dgw::EntityType::ENTITY_QUEUE;
    SimpleEntity entity(material, 0U);
