...
TEST_F(PathMgrTest, BuildKernelSoRootPath_EmptyDestination_ReturnsDefaultRoot)
{
    uint32_t uniqueVfId = 2;
    string destPath = "";
...
TEST_F(PathMgrTest, BuildKernelSoPath_EmptyRoot_ReturnsRelativeKernelPath)
{
...
TEST_F(PathMgrTest, AddVersionInfoName_PathEndsWithSlash_AppendsFileName)
{
...
TEST_F(PathMgrTest, AddVersionInfoName_PathWithoutTrailingSlash_ConcatenatesFileName)
{
    string kernelSoPath = "/usr/lib64/aicpu_kernels/2/aicpu_kernels_device";
    string result = TsdPathMgr::AddVersionInfoName(kernelSoPath);
