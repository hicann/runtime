...
std::string binaryTxtFileName(
    "tests/ut/runtime/runtime/test/data/GatherV3_9e31943a1a48bf81ddff1fc6379e0be3_high_performance.txt");
std::string binaryFileName(
    "tests/ut/runtime/runtime/test/data/GatherV3_9e31943a1a48bf81ddff1fc6379e0be3_high_performance.o");
...
{
    std::string file =
        "../tests/ut/runtime/runtime/test/data/GatherV3_9e31943a1a48bf81ddff1fc6379e0be3_high_performance.json";
    BinaryLoader binaryLoader(file.c_str(), nullptr);
...
TEST_F(BinaryLoaderTest, TestParseKernelJsonFile_NotSupport)
{
    ...
    std::string content =
        ...
        "\"debugOptions\":\"test_printf_test\",\"sha256\":"
        "\"23673556afa3860402a84eda043f19ffbd350a39a08ac94635dbbfeb35a2024d\"}";
