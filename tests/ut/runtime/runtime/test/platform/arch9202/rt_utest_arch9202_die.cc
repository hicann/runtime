...
class Arch9202DieTest : public testing::Test {
protected:
    void SetUp() override
    {
    ...
    {
        DevProperties props = {};
        ASSERT_EQ(GET_DEV_PROPERTIES(CHIP_CLOUD_V6, props), RT_ERROR_NONE);
...
TEST_F(Arch9202DieTest, RegisteredCoreNumPerDie)
{
    DevProperties props = {};
    ASSERT_EQ(GET_DEV_PROPERTIES(CHIP_CLOUD_V6, props), RT_ERROR_NONE);
...
TEST_F(Arch9202DieTest, AllocStackPhyBaseForSingleDie) { CheckStackAllocSize(1U, 32ULL * 1024ULL * (18ULL + 36ULL)); }

TEST_F(Arch9202DieTest, AllocStackPhyBaseForDualDie)
{
