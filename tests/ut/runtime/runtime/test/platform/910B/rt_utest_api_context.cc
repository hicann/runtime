...
class CloudV2ApiContextTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout<<"CloudV2ApiContextTest test start start. "<<std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout<<"CloudV2ApiContextTest test start end. "<<std::endl;
...
TEST_F(CloudV2ApiContextTest, TestRtsCtxDestroy)
{
    rtError_t error;
...
TEST_F(CloudV2ApiContextTest, TestRtsCtxGetAndSetCurrent)
{
    rtError_t error;
    int32_t state = 0;
    int32_t devId = 0;
...
TEST_F(CloudV2ApiContextTest, TestRtsGetPrimaryCtxState)
{
    rtError_t error;
    int32_t state = 0;
    int32_t devId = 0;
...
TEST_F(CloudV2ApiContextTest, TestRtsCtxGetAndSetSysParamOpt)
{
    rtError_t error;
    int64_t val;
...
TEST_F(CloudV2ApiContextTest, TestRtsCtxGetCurrentDefaultStream)
{
    rtStream_t stream;
