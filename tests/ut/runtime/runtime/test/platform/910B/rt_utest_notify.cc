...
class NotifyTest910B : public testing::Test
{
protected:
...
TEST_F(NotifyTest910B, notify_record)
{
    rtError_t error;
    int32_t device_id = 0;
    uint32_t tsId = 0;
...
TEST_F(NotifyTest910B, revised_notify_record)
{
    rtError_t error;
    int32_t device_id = 0;
    uint32_t tsId = 0;
...
TEST_F(NotifyTest910B, notify_create_error)
{
    rtError_t error;
    int32_t device_id = 0;
    uint32_t tsId = 0;
...
TEST_F(NotifyTest910B, notify_create_error02)
{
    rtError_t error;
    int32_t device_id = 0;
    uint32_t tsId = 0;
...
TEST_F(NotifyTest910B, notify_getaddroffset)
{
    rtError_t error;
    int32_t device_id = 0;
    uint32_t tsId = 0;
...
TEST_F(NotifyTest910B, notify_getaddroffset_error)
{
    rtError_t error;
    int32_t device_id = 0;
    uint32_t tsId = 0;
...
TEST_F(NotifyTest910B, notify_getaddroffset_error2)
{
    rtError_t error;
    int32_t device_id = 0;
    uint32_t tsId = 0;
...
TEST_F(NotifyTest910B, notify_getaddroffset_error3)
{
    rtError_t error;
    int32_t device_id = 0;
    uint32_t tsId = 0;
...
TEST_F(NotifyTest910B, notify_record_taskinit_error)
{
...
TEST_F(NotifyTest910B, notify_record_tasksubmit_error)
{
...
TEST_F(NotifyTest910B, notify_ipc_create)
{
    rtError_t error;
    int32_t device_id = 0;
    int32_t tsId = 0;
...
TEST_F(NotifyTest910B, notify_ipc_multi_create)
{
    rtError_t error;
    int32_t device_id = 0;
    uint32_t tsId = 0;
...
TEST_F(NotifyTest910B, notify_ipc_open)
{
    MOCKER(halShrIdOpen)
             .stubs()
...
TEST_F(NotifyTest910B, notify_ipc_pod_open)
{
    MOCKER(halShrIdOpen)
             .stubs()
             .will(invoke(halShrIdOpen_stub));
...
TEST_F(NotifyTest910B, notify_ipc_multi_open)
{
    MOCKER(halShrIdOpen)
             .stubs()
             .will(invoke(halShrIdOpen_stub));
...
TEST_F(NotifyTest910B, notify_dtor_null)
{
    Notify *notify = new Notify(0, 0);
...
TEST_F(NotifyTest910B, notify_setname_fail)
{
...
TEST_F(NotifyTest910B, CheckIpcNotifyDevId)
{
    rtError_t error;
