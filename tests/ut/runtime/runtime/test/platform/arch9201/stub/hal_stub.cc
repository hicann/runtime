...
rtTaskReport_t g_report[MAX_DEVICE_NUM][2][MAX_REPORT_COUNT];
...
drvError_t halSqTaskSend(uint32_t devId, struct halTaskSendInfo* info) { return DRV_ERROR_NONE; }
...
void* create_collect_client(const char* address, const char* engine_name) { return nullptr; }
