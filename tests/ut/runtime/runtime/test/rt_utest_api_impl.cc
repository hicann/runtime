...
rtError_t PtrGetRealLocationStub(
    Driver* drv, const void* ptr, rtMemLocationType& location, rtMemLocationType& realLocation)
{
    (void)drv;
    (void)ptr;
...
void SetMemcpyExLocationStub(
    rtMemLocationType srcLocation, rtMemLocationType srcRealLocation, rtMemLocationType dstLocation,
    rtMemLocationType dstRealLocation)
{
...
rtError_t MemcpyAsyncCheckExLocationWithStub(
    ApiErrorDecorator& apiError, rtMemcpyKind_t kind, rtMemLocationType srcRealLocation,
    rtMemLocationType dstRealLocation)
{
