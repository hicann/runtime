...
TEST(EnumToStringUtilsTest, DriverEventIdTypeName)
{
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_RANDOM_KERNEL), "EVENT_RANDOM_KERNEL");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_DVPP_MSG), "EVENT_DVPP_MSG");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_FR_MSG), "EVENT_FR_MSG");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_TS_HWTS_KERNEL), "EVENT_TS_HWTS_KERNEL");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_AICPU_MSG), "EVENT_AICPU_MSG");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_TS_CTRL_MSG), "EVENT_TS_CTRL_MSG");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_QUEUE_ENQUEUE), "EVENT_QUEUE_ENQUEUE");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_QUEUE_FULL_TO_NOT_FULL), "EVENT_QUEUE_FULL_TO_NOT_FULL");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_QUEUE_EMPTY_TO_NOT_EMPTY), "EVENT_QUEUE_EMPTY_TO_NOT_EMPTY");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_TDT_ENQUEUE), "EVENT_TDT_ENQUEUE");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_TIMER), "EVENT_TIMER");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_HCFI_SCHED_MSG), "EVENT_HCFI_SCHED_MSG");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_HCFI_EXEC_MSG), "EVENT_HCFI_EXEC_MSG");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_ROS_MSG_LEVEL0), "EVENT_ROS_MSG_LEVEL0");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_ROS_MSG_LEVEL1), "EVENT_ROS_MSG_LEVEL1");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_ROS_MSG_LEVEL2), "EVENT_ROS_MSG_LEVEL2");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_ACPU_MSG_TYPE0), "EVENT_ACPU_MSG_TYPE0");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_ACPU_MSG_TYPE1), "EVENT_ACPU_MSG_TYPE1");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_ACPU_MSG_TYPE2), "EVENT_ACPU_MSG_TYPE2");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_CCPU_CTRL_MSG), "EVENT_CCPU_CTRL_MSG");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_SPLIT_KERNEL), "EVENT_SPLIT_KERNEL");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_DVPP_MPI_MSG), "EVENT_DVPP_MPI_MSG");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_CDQ_MSG), "EVENT_CDQ_MSG");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_TEST), "EVENT_TEST");
    EXPECT_STREQ(EventIdTypeName(RT_EVENT_MAX_NUM), "EVENT_MAX_NUM");
    EXPECT_STREQ(EventIdTypeName(static_cast<rtEventIdType_t>(100)), "UNKNOWN");
}
...
TEST(EnumToStringUtilsTest, RemediatedEnumToStringKnownValue)
{
    ...
    EXPECT_EQ(
        LaunchKernelAttrIdToString(RT_LAUNCH_KERNEL_ATTR_ENABLE_PROFILING), "LAUNCH_KERNEL_ATTR_ENABLE_PROFILING(9)");
    EXPECT_EQ(LaunchKernelAttrIdToString(RT_LAUNCH_KERNEL_ATTR_MAX), "LAUNCH_KERNEL_ATTR_MAX(10)");
...
TEST(EnumToStringUtilsTest, CommonExecutionEnumsAllKnownValues)
{
    ...
    EXPECT_STREQ(DevAttrToString(RT_DEV_ATTR_SUPER_POD_CHASSIS_ID), "DEV_ATTR_SUPER_POD_CHASSIS_ID(410)");
