...
bool fe::PlatFormInfos::GetPlatformRes(const string& label, const string& key, string& val) { return true; }

uint32_t fe::PlatformInfoManager::GetPlatformInstanceByDevice(const uint32_t& device_id, PlatFormInfos& platform_infos)
{
    return 0U;
}
...
uint32_t fe::PlatformInfoManager::InitRuntimePlatformInfos(const std::string& SoCVersion) { return 0U; }
...
uint32_t fe::PlatformInfoManager::Finalize() { return 0U; }

fe::PlatformInfoManager::PlatformInfoManager() {}
fe::PlatformInfoManager::~PlatformInfoManager() {}

uint32_t fe::PlatFormInfos::GetCoreNum() const { return 8U; }

void fe::PlatFormInfos::SetCoreNumByCoreType(const std::string& core_type) { return; }
...
const std::map<std::string, StubVersionInfo> kVersionInfoMap = {
    ...
    {"KirinDev0002", {"204", "5165"}},    {"KirinDev0003", {"205", "5163"}},
};
