...
TEST_F(AIKernelsLibAiCpuKFCSTest, CallKFCKernelApi_ST_SonameNotEmpty_GetApiFail_GlobalFail)
{
...
TEST_F(AIKernelsLibAiCpuKFCSTest, CallKFCKernelApi_ST_SoNameLenExceedMax_GlobalFail)
{
...
TEST_F(AIKernelsLibAiCpuKFCSTest, CallKFCKernelApi_ST_GlobalApiSuccess)
{
    std::string kernelSo = "";
    kernel_.kernelSo = (uintptr_t)kernelSo.data();
...
TEST_F(AIKernelsLibAiCpuKFCSTest, CallKFCKernelApi_ST_SonameGetApiSuccessButNull_GlobalFail)
{
    std::string kernelSo = "libTest.so";
    kernel_.kernelSo = (uintptr_t)kernelSo.data();
