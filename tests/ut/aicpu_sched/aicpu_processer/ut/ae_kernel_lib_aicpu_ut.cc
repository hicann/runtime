...
namespace aicpu {
    namespace ut {
        ...
        class AIKernelsLibAiCpuUTest : public testing::Test {
        protected:
            static void SetUpTestCase()
            {
                ...
                printf("AIKernelsLibAiCpuUTest SetUpTestCase\n");
            }
            ...
            static void TearDownTestCase()
            {
                ...
                printf("AIKernelsLibAiCpuUTest TearDownTestCase \n");
            }
        ...
        cce::AIKernelsLibBase *AIKernelsLibAiCpuUTest::aiKernelsLibAiCpu_ = nullptr;

        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_param_NULL)
        {
            int32_t ret = aiKernelsLibAiCpu_->CallKernelApi(aicpu::KERNEL_TYPE_AICPU, nullptr);
            EXPECT_EQ(AE_STATUS_BAD_PARAM, ret);
        }

        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_kernelName_NULL)
        {
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_kernelSo_NULL)
        {
            kernel_.kernelSo = 0;
            int32_t ret = aiKernelsLibAiCpu_->CallKernelApi(aicpu::KERNEL_TYPE_AICPU, &kernel_);
            EXPECT_EQ(AE_STATUS_BAD_PARAM, ret);
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_strncpy_kernelName_failed)
        {
            MOCKER(strncpy_s)
                    .stubs()
                    .will(returnValue(1));
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_strncpy_soName_failed)
        {
            MOCKER(strncpy_s)
                    .stubs()
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_GetApi_failed)
        {
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_CALL_kernel_failed)
        {
             MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_SUCCESS)
        {
             MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_AICPU_END_OF_SEQUENCE)
        {
             MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_AICPU_TASK_WAIT)
        {
            MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_AICPU_SILENT_FAULT)
        {
            MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_AICPU_DETECT_FAULT)
        {
            MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_AICPU_DETECT_FAULT_NORAS)
        {
            MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_AICPU_DETECT_LOW_BIT_FAULT)
        {
            MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_AICPU_DETECT_lOW_BIT_FAULT_NORAS)
        {
            MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_HOSTCPU_SUCCESS)
        {
             MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_HOSTCPU_Fail_001)
        {
             MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, CallKernelApi_HOSTCPU_Fail_002)
        {
             MOCKER_CPP(&cce::MultiSoManager::GetApi,
                       aeStatus_t(cce::MultiSoManager::*)(aicpu::KernelType kernelType, const char *, const char *,
                                                           void **))
        ...
        TEST_F(AIKernelsLibAiCpuUTest, ContextSet_SUCC_001)
        {
            string key = "test";
            string value = "test";
            SetUniqueVfId(0);
