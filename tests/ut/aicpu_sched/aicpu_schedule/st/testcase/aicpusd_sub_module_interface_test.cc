...
TEST_F(AicpusdSubModuleInterfaceTest, DeleteArgsFileSuccess01)
{
...
TEST_F(AicpusdSubModuleInterfaceTest, DeleteArgsFileFail01)
{
    const std::string filePath = "./aaaaa";
...
TEST_F(AicpusdSubModuleInterfaceTest, ReportErrMsgToTsdSuccess01)
{
...
TEST_F(AicpusdSubModuleInterfaceTest, ReportErrMsgToTsdFail)
{
...
TEST_F(AicpusdSubModuleInterfaceTest, SendPidQosMsgToTsdSuccess01)
{
...
{
    SubModuleInterface::GetInstance().SendSubModuleRsponse(TSD_EVENT_START_AICPU_SD_MODULE_RSP);
    EXPECT_EQ(SubModuleInterface::GetInstance().startFlag_.load(), false);
}
