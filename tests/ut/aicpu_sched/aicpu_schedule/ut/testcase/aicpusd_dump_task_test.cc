...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0x12345678));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(1001UL));
...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xABCDEF00));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(2001UL));
...
TEST_F(AicpuDumpTaskTest, GetSessionDifferentThreadTest)
{
    ...
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0x11111111)).then(returnValue((void*)0x22222222));

    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(3001UL)).then(returnValue(3002UL));
...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(4001UL));
...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0x33333333));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(5001UL));
...
{
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0x44444444)).then(returnValue((void*)0x55555555));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(6001UL));
...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(7001UL));
...
{
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0x66666666)).then(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(8001UL));
...
{
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR)).then(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0x77777777)).then(returnValue((void*)0x88888888));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(9001UL)).then(returnValue(9002UL));
...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0x99999999));
...
TEST_F(AicpuDumpTaskTest, DumpIdeDumpDataSuccessTest)
{
    ...
    MOCKER_CPP(&IdeDumpData).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
...
TEST_F(AicpuDumpTaskTest, DumpReacquireSuccessTest)
{
    ...
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xAAAA3333));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(1111UL));
...
TEST_F(AicpuDumpTaskTest, DumpReacquireFailTest)
{
    ...
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(2222UL));
...
TEST_F(AicpuDumpTaskTest, DoDumpTensorGetSessionFailTest)
{
    ...
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(3333UL));
...
TEST_F(AicpuDumpTaskTest, DoDumpStatsGetSessionFailTest)
{
    ...
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(4444UL));
...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xCCCC0001));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(30001UL));
...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(40001UL));
...
TEST_F(AicpuDumpTaskTest, ReacquireSessionNullptrInMapTest)
{
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(50001UL));
...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(60001UL));
...
TEST_F(AicpuDumpTaskTest, DumpSessionReferenceUpdateTest)
{
    ...
    MOCKER_CPP(&IdeDumpData)
        ...
        .then(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xDDDD0002));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(11111UL));
    DumpSessionManager::GetInstance().CloseAllSessions();
...
TEST_F(AicpuDumpTaskTest, DumpFirstFailReacquireNullTest)
{
    ...
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(22222UL));
    DumpSessionManager::GetInstance().CloseAllSessions();
...
TEST_F(AicpuDumpTaskTest, DoDumpStatsSuccessWithSessionManagerTest)
{
    ...
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xEEEE2222));
    MOCKER_CPP(&IdeDumpData).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(70002UL));
    DumpSessionManager::GetInstance().CloseAllSessions();
...
TEST_F(AicpuDumpTaskTest, DoDumpStatsRetrySuccessTest)
{
    ...
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xEEEE3333)).then(returnValue((void*)0xEEEE3334));
    MOCKER_CPP(&IdeDumpData)
        .stubs()
        .will(returnValue(IDE_DAEMON_HDC_CHANNEL_ERROR))
        .then(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(70003UL));
    DumpSessionManager::GetInstance().CloseAllSessions();
...
{
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_UNKNOW_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xFFFF0001));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(80001UL));
    DumpSessionManager& manager = DumpSessionManager::GetInstance();
    manager.CloseAllSessions();
...
{
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_UNKNOW_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xFFFF0002)).then(returnValue((void*)0xFFFF0003));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(90001UL));
    DumpSessionManager& manager = DumpSessionManager::GetInstance();
    manager.CloseAllSessions();
...
{
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)nullptr));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(80002UL)).then(returnValue(80003UL));
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    DumpSessionManager& manager = DumpSessionManager::GetInstance();
    manager.CloseAllSessions();
...
TEST_F(AicpuDumpTaskTest, DumpReacquireSuccessButSecondDumpFailTest)
{
    ...
    MOCKER_CPP(&IdeDumpEnd).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xDDDD0005));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(33333UL));
    DumpSessionManager::GetInstance().CloseAllSessions();
...
TEST_F(AicpuDumpTaskTest, DoDumpTensorSuccessWithSessionManagerTest)
{
    ...
    const std::string dumpFilePath = "/tmp/dump";
    MOCKER_CPP(&IdeDumpStart).stubs().will(returnValue((void*)0xEEEE1111));
    MOCKER_CPP(&IdeDumpData).stubs().will(returnValue(IDE_DAEMON_NONE_ERROR));
    MOCKER(AicpuSchedule::GetTid).stubs().will(returnValue(70001UL));
