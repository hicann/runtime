...
TEST_F(AiCPUContextUt, AiCPUContextUtFail)
{
    SetTaskAndStreamId(0, 0);
    uint64_t taskId = 0xFFFF;
    uint32_t streamId = 0xFFFF;
...
TEST_F(AiCPUContextUt, SetBlockIdxAndBlockNum)
{
...
TEST_F(AiCPUContextUt, SetAicpuBlockIdxAndBlockNum)
{
    auto ret = SetBlockIdxAndBlockNum(1, 2);
    EXPECT_EQ(ret, 0);
...
TEST_F(AiCPUContextUt, SetAicpuStreamIdAndTaskId)
{
    SetTaskAndStreamId(0, 0);
