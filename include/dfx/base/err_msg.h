...
RegisterFormatErrorMessage(const char* error_msg, size_t error_msg_len) WEAK_SYMBOL;
...
GE_FUNC_HOST_VISIBILITY GE_FUNC_DEV_VISIBILITY int32_t ReportInnerErrMsg(
    const char* file_name, const char* func, uint32_t line, const char* error_code, const char* format, ...)
    FORMAT_PRINTF(5, 6) WEAK_SYMBOL;
 ...
 */
GE_FUNC_HOST_VISIBILITY GE_FUNC_DEV_VISIBILITY int32_t
ReportUserDefinedErrMsg(const char* error_code, const char* format, ...) FORMAT_PRINTF(2, 3) WEAK_SYMBOL;
 ...
 * @return int32_t 0(success) -1(fail)
 */
GE_FUNC_HOST_VISIBILITY GE_FUNC_DEV_VISIBILITY int32_t ReportPredefinedErrMsg(
    const char* error_code, const std::vector<const char*>& key, const std::vector<const char*>& value) WEAK_SYMBOL;
 ...
 * @return int32_t 0(success) -1(fail)
 */
GE_FUNC_HOST_VISIBILITY GE_FUNC_DEV_VISIBILITY int32_t ReportPredefinedErrMsg(const char* error_code) WEAK_SYMBOL;
} // namespace error_message
