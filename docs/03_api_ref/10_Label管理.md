...
| stream | 输入 | 需设置标签的Stream。类型定义请参见[aclrtStream](25-05_Typedefs.md#aclrtStream)。<br>此处只支持通过[aclmdlRIBindStream](15_模型运行实例管理.md#aclmdlRIBindStream)接口绑定过模型运行实例的Stream。 |
