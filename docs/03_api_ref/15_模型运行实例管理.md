...
| mode | 输入 | 捕获模式，用于限制非安全函数（包括aclrtMemset、aclrtMemcpy、aclrtMemcpy2d以及使用非Host锁页内存进行异步内存复制操作的接口，如aclrtMemcpyAsync接口）的作用范围。<br>类型定义请参见[aclmdlRICaptureMode](24_数据类型及其操作接口.md#aclmdlRICaptureMode)。 |
...
| --- | :---: | --- |
| stream | 输入 | 指定Stream。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。 |
| status | 输出 | Stream上任务的捕获状态。类型定义请参见[aclmdlRICaptureStatus](24_数据类型及其操作接口.md#aclmdlRICaptureStatus)。 |
| modelRI | 输出 | 模型运行实例，该模型用于暂存所捕获的任务。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。<br>若本接口指定的Stream不在捕获状态，则此处返回的modelRI无效。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| mode | 输入&输出 | 捕获模式，用于限制非安全函数（包括aclrtMemset、aclrtMemcpy、aclrtMemcpy2d以及使用非Host锁页内存进行异步内存复制操作的接口，如aclrtMemcpyAsync接口）的作用范围。<br>类型定义请参见[aclmdlRICaptureMode](24_数据类型及其操作接口.md#aclmdlRICaptureMode)。 |
...
| --- | :---: | --- |
| stream | 输入 | 指定Stream。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。 |
| modelRI | 输出 | 模型运行实例，该模型用于暂存所捕获的任务。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| stream | 输入 | 指定Stream。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。<br>此处的Stream必须是在捕获状态的Stream。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| stream | 输入 | 指定Stream。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。<br>此处的Stream需与[aclmdlRICaptureTaskGrpBegin](#aclmdlRICaptureTaskGrpBegin)接口中指定的Stream保持一致。 |
| handle | 输出 | 标识任务组的句柄。类型定义请参见[aclrtTaskGrp](24_数据类型及其操作接口.md#aclrtTaskGrp)。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| stream | 输入 | 指定Stream。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。<br>此处的Stream必须是不在捕获状态的Stream。 |
| handle | 输入 | 标识任务组的句柄。类型定义请参见[aclrtTaskGrp](24_数据类型及其操作接口.md#aclrtTaskGrp)。<br>提前调用[aclmdlRICaptureTaskGrpBegin](#aclmdlRICaptureTaskGrpBegin)、[aclmdlRICaptureTaskGrpEnd](#aclmdlRICaptureTaskGrpEnd)接口标记任务组，并通过aclmdlRICaptureTaskGrpEnd接口获取任务组句柄，再作为入参传入此处。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| stream | 输入 | 指定Stream。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。<br>此处的Stream需与[aclmdlRICaptureTaskUpdateBegin](#aclmdlRICaptureTaskUpdateBegin)接口中指定的Stream保持一致。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| modelRI | 输入 | 模型运行实例，该模型用于暂存所捕获的任务。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。<br>需确保modelRI是有效的。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| modelRI | 输入 | 模型运行实例，该模型用于暂存所捕获的任务。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。<br>仅支持在[aclmdlRICaptureEnd](#aclmdlRICaptureEnd)接口之后打印模型信息，将[aclmdlRICaptureEnd](#aclmdlRICaptureEnd)接口输出的模型运行实例作为入参传入本接口，但需确保modelRI是有效的。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| modelRI | 输入 | 模型运行实例，该模型用于暂存所编译的任务。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| modelRI | 输入 | 模型运行实例。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。<br>此处的modelRI需与[aclmdlRIBuildBegin](#aclmdlRIBuildBegin)接口中的modelRI保持一致。 |
| stream | 输入 | 指定Stream。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。<br>此处的Stream需通过[aclrtCreateStreamWithConfig](06_Stream管理.md#aclrtCreateStreamWithConfig)接口创建ACL_STREAM_PERSISTENT类型的Stream。<br>不支持传NULL，不支持一个Stream绑定多个modelRI的场景。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| modelRI | 输入 | 模型运行实例。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。<br>modelRI支持通过以下方式获取：<br><br>  - 调用[aclmdlRICaptureBegin](#aclmdlRICaptureBegin)接口捕获Stream上下发的任务后，可通过[aclmdlRICaptureGetInfo](#aclmdlRICaptureGetInfo)接口获取模型运行实例，再传入本接口。<br>  - 调用[aclmdlRIBuildBegin](#aclmdlRIBuildBegin)、[aclmdlRIBuildEnd](#aclmdlRIBuildEnd)等接口构建模型运行实例，再传入本接口。 |
...
| --- | :---: | --- |
| modelRI | 输入 | 模型运行实例。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。<br>modelRI支持通过以下方式获取：<br><br>  - 调用[aclmdlRICaptureBegin](#aclmdlRICaptureBegin)接口捕获Stream上下发的任务后，可通过[aclmdlRICaptureGetInfo](#aclmdlRICaptureGetInfo)接口获取模型运行实例，再传入本接口。<br>  - 调用[aclmdlRIBuildBegin](#aclmdlRIBuildBegin)、[aclmdlRIBuildEnd](#aclmdlRIBuildEnd)等接口构建模型运行实例，再传入本接口。 |
| stream | 输入 | 指定Stream，用于执行模型推理任务。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| modelRI | 输入 | 模型运行实例。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。 |
...
| --- | :---: | --- |
| modelRI | 输入 | 模型运行实例。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。 |
| streams | 输入&输出 | 若streams传入空指针，表示获取模型运行实例关联的Stream数量，该数量通过numStreams参数返回。<br>若streams是一个数组，其大小为numStreams，则表示用于存放模型运行实例关联的所有Stream。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| streams | 输入 | 指定Stream。类型定义请参见[aclrtStream](24_数据类型及其操作接口.md#aclrtStream)。<br>需传入与模型运行实例有关联的Stream。 |
| tasks | 输入&输出 | 若tasks传入空指针，表示获取指定Stream中的所有任务数量，该数量通过numTasks参数返回。<br>若tasks是一个数组，其大小为numTasks，则表示用于存放指定Stream中的所有任务。类型定义请参见[aclmdlRITask](24_数据类型及其操作接口.md#aclmdlRITask)。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| tasks | 输入 | 指定任务。类型定义请参见[aclmdlRITask](24_数据类型及其操作接口.md#aclmdlRITask)。 |
| id | 输出 | 任务序列ID。 |
...
| --- | :---: | --- |
| tasks | 输入 | 指定任务。类型定义请参见[aclmdlRITask](24_数据类型及其操作接口.md#aclmdlRITask)。 |
| params | 输出 | 参数信息。类型定义请参见[aclmdlRITaskParams](24_数据类型及其操作接口.md#aclmdlRITaskParams)。 |
...
| --- | :---: | --- |
| tasks | 输入 | 指定任务。类型定义请参见[aclmdlRITask](24_数据类型及其操作接口.md#aclmdlRITask)。 |
| params | 输入 | 参数信息。类型定义请参见[aclmdlRITaskParams](24_数据类型及其操作接口.md#aclmdlRITaskParams)。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| modelRI | 输入 | 指定任务。类型定义请参见[aclmdlRI](24_数据类型及其操作接口.md#aclmdlRI)。 |
...
| --- | :---: | --- |
| tasks | 输入 | 指定任务。类型定义请参见[aclmdlRITask](24_数据类型及其操作接口.md#aclmdlRITask)。 |
| type | 输出 | 任务类型。类型定义请参见[aclmdlRITaskType](24_数据类型及其操作接口.md#aclmdlRITaskType)。 |
