...
| ACL_DEV_ATTR_HD_CONNECT_TYPE | Host和Device间的互联协议。<br>取值如下：<br><br>  - 0：通过PCIe互联传输。<br>  - 1：通过HCCS（Huawei Cache Coherence System，华为缓存一致性系统）互联传输。<br>  - 2：通过UB（Unified Buffer，统一缓冲区）互联传输。<br> |
