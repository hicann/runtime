...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| buf | 输入 | 待释放的共享Buffer。类型定义请参见[aclrtMbuf](25-05_Typedefs.md#aclrtMbuf)。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| buf | 输入 | 共享Buffer，类型定义请参见[aclrtMbuf](25-05_Typedefs.md#aclrtMbuf)。<br>须通过[acltdtAllocBuf](17-03_共享Buffer管理.md#acltdtAllocBuf)或[aclrtCopyBufRef](#aclrtCopyBufRef)接口申请获得。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| buf | 输入 | 共享Buffer。类型定义请参见[aclrtMbuf](25-05_Typedefs.md#aclrtMbuf)。<br>共享Buffer可通过[aclrtAllocBuf](#aclrtAllocBuf)或[aclrtCopyBufRef](#aclrtCopyBufRef)接口申请获得。 |
| newBuf | 输出 | 返回一个新的共享Buffer，指向相同的数据区。类型定义请参见[aclrtMbuf](25-05_Typedefs.md#aclrtMbuf)。 |
...
| 参数名 | 输入/输出 | 说明 |
| --- | :---: | --- |
| headBuf | 输入 | Mbuf链表中的第一个共享Buffer。类型定义请参见[aclrtMbuf](25-05_Typedefs.md#aclrtMbuf)。 |
| buf | 输入 | 待添加的共享Buffer。类型定义请参见[aclrtMbuf](25-05_Typedefs.md#aclrtMbuf)。 |
...
| buf | 输出 | 输出第index个共享Buffer。类型定义请参见[aclrtMbuf](25-05_Typedefs.md#aclrtMbuf)。 |
