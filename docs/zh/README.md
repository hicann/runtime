...
| **📋 API参考** | 接口字典，开发过程中随时查阅函数定义。函数签名 + 参数说明 + 返回值 | [头文件说明](api_ref/01_overview.md) · [API参考](api_ref/README.md) |
| **📋 日志参考** | 介绍定位问题时如何设置日志级别、从何处获取日志文件，同时介绍日志内容格式、日志配置。 | [日志参考](log_ref/README.md) |
| **📋 错误码参考** | 错误码字典，调试过程中查阅对应错误码的错误信息、可能原因、解决方法。 | [RTS-Errors](error_code_ref/RTS-Errors/RTS-Errors.md) · [ACL-Errors](error_code_ref/ACL-Errors/ACL-Errors.md) |
| **📋 环境变量参考** | 错误码字典，调试过程中查阅对应错误码的错误信息、可能原因、解决方法。 | [环境变量参考](env_vars/README.md) |
