...
trace日志落盘根目录默认为“$HOME/ascend/atrace/”，也可以通过环境变量ASCEND\_WORK\_PATH指定trace日志落盘路径，例如设置export ASCEND\_WORK\_PATH=/home/test，具体请参考《[环境变量参考](https://gitcode.com/cann/docs/blob/master/docs/zh/env-vars/README.md)》。
