...
在aclInit接口中启用默认Device功能后，初始化的示例代码如下，不可以直接拷贝编译运行，仅供参考。完整样例代码请参见[Link](https://gitcode.com/cann/runtime-dev/tree/master/example/1_basic_features/device/0_device_normal)。
