# aclrtGetErrorCodeFromExceptionInfo<a name="ZH-CN_TOPIC_0000001348896917"></a>
...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p5921112316549"><a name="p5921112316549"></a><a name="p5921112316549"></a>info</p>
</td>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p10578194515441"><a name="p10578194515441"></a><a name="p10578194515441"></a>异常信息的指针。</p>
<p id="p79219230547"><a name="p79219230547"></a><a name="p79219230547"></a>在执行任务之前调用<a href="aclrtSetExceptionInfoCallback.md">aclrtSetExceptionInfoCallback</a>接口，系统会将产生异常的任务ID、Stream ID、线程ID、Device ID、错误码存放在aclrtExceptionInfo结构体中。</p>
</td>
</tr>
</tbody>
</table>
