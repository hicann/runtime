# aclrtRegStreamStateCallback<a name="ZH-CN_TOPIC_0000002473863349"></a>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p867311205619"><a name="p867311205619"></a><a name="p867311205619"></a>注册唯一名称，不能为空，输入保证字符串以\0结尾。</p>
</td>
</tr>
...
<pre class="screen" id="screen179741357147"><a name="screen179741357147"></a><a name="screen179741357147"></a>typedef enum {
...
typedef void (*aclrtStreamStateCallback)(aclrtStream stm, aclrtStreamState state, void *args);</pre>
</td>
</tr>
