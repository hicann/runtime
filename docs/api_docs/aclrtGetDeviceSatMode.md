# aclrtGetDeviceSatMode<a name="ZH-CN_TOPIC_0000001378924326"></a>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p10758153532712"><a name="p10758153532712"></a><a name="p10758153532712"></a>获取浮点计算结果输出模式。</p>
</td>
</tr>
</tbody>
</table>
