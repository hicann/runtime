# aclrtSetTsDevice<a name="ZH-CN_TOPIC_0000001312641737"></a>
...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0122830089_p1088611422254"><a name="zh-cn_topic_0122830089_p1088611422254"></a><a name="zh-cn_topic_0122830089_p1088611422254"></a>tsId</p>
</td>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p2366361647"><a name="p2366361647"></a><a name="p2366361647"></a>指定本次计算需要使用的Task Schedule。如果<span id="ph1555712386204"><a name="ph1555712386204"></a><a name="ph1555712386204"></a>昇腾AI处理器</span>中只有AI CORE Task Schedule，没有VECTOR Core Task Schedule，则设置该参数无效，默认使用AI CORE Task Schedule。</p>
<pre class="screen" id="screen11930151364015"><a name="screen11930151364015"></a><a name="screen11930151364015"></a>typedef enum aclrtTsId {
