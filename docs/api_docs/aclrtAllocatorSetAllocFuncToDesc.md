# aclrtAllocatorSetAllocFuncToDesc<a name="ZH-CN_TOPIC_0000001571827064"></a>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p1178111411244"><a name="p1178111411244"></a><a name="p1178111411244"></a>申请内存block的回调函数。</p>
<p id="p128968121218"><a name="p128968121218"></a><a name="p128968121218"></a>回调函数定义如下：</p>
<pre class="screen" id="screen714239138"><a name="screen714239138"></a><a name="screen714239138"></a>typedef void *(*aclrtAllocatorAllocFunc)(aclrtAllocator allocator, size_t size);</pre>
</td>
</tr>
</tbody>
</table>
