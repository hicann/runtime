# aclrtIpcOpenEventHandle<a name="ZH-CN_TOPIC_0000006365327649"></a>

## AI处理器支持情况<a name="section8278181118225"></a>

<a name="table38301333189"></a>
...
## 函数原型<a name="section13231182415108"></a>
...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p1588612558270"><a name="p1588612558270"></a><a name="p1588612558270"></a>handle</p>
</td>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p7884145522717"><a name="p7884145522717"></a><a name="p7884145522717"></a>Event句柄。</p><p>必须先调用<a href="aclrtIpcGetEventHandle.md">aclrtIpcGetEventHandle</a>接口获取指定Event的句柄，再作为入参传入。</p>
</td>
</tr>
<tr id="row1141161375"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p10884755182711"><a name="p10884755182711"></a><a name="p10884755182711"></a>event</p>
</td>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p11883165517279"><a name="p11883165517279"></a><a name="p11883165517279"></a>Event指针。</p>
</td>
</tr>
</tbody>
</table>
