# acltdtBindQueueRoutes<a name="ZH-CN_TOPIC_0000001312481613"></a>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p1172563414511"><a name="p1172563414511"></a><a name="p1172563414511"></a>路由关系数组的指针，接口调用完成后返回路由绑定结果。</p>
<p id="p1521156142214"><a name="p1521156142214"></a><a name="p1521156142214"></a>需提前调用<a href="acltdtCreateQueueRouteList.md">acltdtCreateQueueRouteList</a>接口创建acltdtQueueRouteList类型的数据，再调用<a href="acltdtAddQueueRoute.md">acltdtAddQueueRoute</a>接口添加路由关系。</p>
</td>
</tr>
</tbody>
</table>
...
## 约束说明<a name="section6693141091913"></a>
