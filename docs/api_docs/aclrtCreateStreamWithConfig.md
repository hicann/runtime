...
<p id="p69301912154616"><a name="p69301912154616"></a><a name="p69301912154616"></a>当前支持将flag设置为如下宏（配置取值范围之外的值，本接口创建出来的Stream等同于<a href="aclrtCreateStream.md">aclrtCreateStream</a>接口）：</p>
