# aclprofDestroyStepInfo<a name="ZH-CN_TOPIC_0000001265081922"></a>
...
## 约束说明<a name="section19557164384117"></a>
...
<tbody><tr id="row10379818172019"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p3861133121311"><a name="p3861133121311"></a><a name="p3861133121311"></a>stepinfo</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.2 "><p id="p086043161318"><a name="p086043161318"></a><a name="p086043161318"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p1985910361318"><a name="p1985910361318"></a><a name="p1985910361318"></a>指定迭代信息。需提前调用<a href="aclprofCreateStepInfo.md">aclprofCreateStepInfo</a>接口创建<strong id="b1046745315418"><a name="b1046745315418"></a><a name="b1046745315418"></a><a href="aclprofStepInfo.md">aclprofStepInfo</a></strong>类型的数据。</p>
</td>
</tr>
</tbody>
</table>
