# aclGetCannAttributeList<a name="ZH-CN_TOPIC_0000001866180697"></a>
...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p11319248145911"><a name="p11319248145911"></a><a name="p11319248145911"></a>cannAttrList</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.2 "><p id="p1031974811592"><a name="p1031974811592"></a><a name="p1031974811592"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p17318184813592"><a name="p17318184813592"></a><a name="p17318184813592"></a>用于保存运行环境支持的特性枚举数组。</p>
<p id="p185678174546"><a name="p185678174546"></a><a name="p185678174546"></a>用户无需提前申请内存，应用进程退出时，内存自动释放。</p>
</td>
</tr>
<tr id="row7909131293411"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p0317104813595"><a name="p0317104813595"></a><a name="p0317104813595"></a>num</p>
</td>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p19316148125918"><a name="p19316148125918"></a><a name="p19316148125918"></a>用于保存支持的特性数量，与cannAttrList数组长度保持一致。</p>
</td>
</tr>
</tbody>
</table>
