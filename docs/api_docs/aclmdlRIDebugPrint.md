# aclmdlRIDebugPrint<a name="ZH-CN_TOPIC_0000002186835206"></a>
...
<tbody><tr id="row8170205510541"><td class="cellrowborder" valign="top" width="15%" headers="mcps1.1.4.1.1 "><p id="p151701955165416"><a name="p151701955165416"></a><a name="p151701955165416"></a>modelRI</p>
</td>
<td class="cellrowborder" valign="top" width="15%" headers="mcps1.1.4.1.2 "><p id="p717015551544"><a name="p717015551544"></a><a name="p717015551544"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="70%" headers="mcps1.1.4.1.3 "><p id="p6957639152917"><a name="p6957639152917"></a><a name="p6957639152917"></a>模型运行实例，该模型用于暂存所捕获的任务。</p>
<p id="p10850611344"><a name="p10850611344"></a><a name="p10850611344"></a>仅支持在<a href="aclmdlRICaptureEnd.md">aclmdlRICaptureEnd</a>接口之后打印模型信息，将<a href="aclmdlRICaptureEnd.md">aclmdlRICaptureEnd</a>接口输出的模型运行实例作为入参传入本接口，但需确保modelRI是有效的。</p>
</td>
</tr>
</tbody>
</table>
