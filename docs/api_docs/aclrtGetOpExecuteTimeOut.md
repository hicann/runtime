# aclrtGetOpExecuteTimeOut<a name="ZH-CN_TOPIC_0000002440463368"></a>
...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p76784121566"><a name="p76784121566"></a><a name="p76784121566"></a>timeoutMs</p>
</td>
<td class="cellrowborder" valign="top" width="13.98%" headers="mcps1.1.4.1.2 "><p id="p8676171217561"><a name="p8676171217561"></a><a name="p8676171217561"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="72.02%" headers="mcps1.1.4.1.3 "><p id="p794074192913"><a name="p794074192913"></a><a name="p794074192913"></a>超时时间，单位为毫秒。</p>
<p id="p1790419144716"><a name="p1790419144716"></a><a name="p1790419144716"></a>若已调用set接口（例如aclrtSetOpExecuteTimeOut）设置过超时时间，则返回硬件的实际超时时间，否则，返回AI Core的默认超时时间。</p>
</td>
</tr>
</tbody>
</table>
