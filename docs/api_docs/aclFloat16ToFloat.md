# aclFloat16ToFloat<a name="ZH-CN_TOPIC_0000001265241722"></a>
...
## 功能说明<a name="section15454121319116"></a>

将[aclFloat16](aclFloat16.md)类型的数据转换为float（指float32）类型的数据。

## 函数原型<a name="section13251116814"></a>

```
float aclFloat16ToFloat(aclFloat16 value)
```

## 参数说明<a name="section1445513201715"></a>
...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p199798581861"><a name="p199798581861"></a><a name="p199798581861"></a>value</p>
</td>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p97691430304"><a name="p97691430304"></a><a name="p97691430304"></a>待转换的数据。</p>
</td>
</tr>
</tbody>
</table>

## 返回值说明<a name="section1754812241317"></a>
