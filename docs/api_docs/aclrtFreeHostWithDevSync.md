# aclrtFreeHostWithDevSync<a name="ZH-CN_TOPIC_0000002573943181"></a>

## AI处理器支持情况<a name="section8278181118225"></a>

<a name="table38301313189"></a>
...
## 函数原型<a name="section16230182415108"></a>

```
aclError aclrtFreeHostWithDevSync(void *hostPtr)
```

## 参数说明<a name="section75395139104"></a>

<a name="zh-cn_topic_0122830089_table438764397513"></a>
...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p76784121566"><a name="p76784121566"></a><a name="p76784121566"></a>hostPtr</p>
</td>
...
## 返回值说明<a name="section25797320141317"></a>
