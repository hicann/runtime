# aclrtDeviceCanAccessPeer<a name="ZH-CN_TOPIC_0000001265241622"></a>
...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p154205415431"><a name="p154205415431"></a><a name="p154205415431"></a>canAccessPeer</p>
</td>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p51520531034"><a name="p51520531034"></a><a name="p51520531034"></a>是否支持数据交互，1表示支持，0表示不支持。</p>
</td>
</tr>
<tr id="row10633135785616"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p11549182052815"><a name="p11549182052815"></a><a name="p11549182052815"></a>deviceId</p>
</td>
...
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p99450379174"><a name="p99450379174"></a><a name="p99450379174"></a>指定Device的ID，不能与peerDeviceId参数值相同。</p>
...
<tr id="row17839154614576"><td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.1 "><p id="p118395469574"><a name="p118395469574"></a><a name="p118395469574"></a>peerDeviceId</p>
</td>
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.2 "><p id="p148391946115719"><a name="p148391946115719"></a><a name="p148391946115719"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="72%" headers="mcps1.1.4.1.3 "><p id="p31135071714"><a name="p31135071714"></a><a name="p31135071714"></a>指定Device的ID，不能与deviceId参数值相同。</p>
