...
<tbody><tr id="zh-cn_topic_0122830089_row2038874343514"><td class="cellrowborder" valign="top" width="19.17%" headers="mcps1.1.4.1.1 "><p id="p4579181641514"><a name="p4579181641514"></a><a name="p4579181641514"></a>userdata</p>
</td>
...
<td class="cellrowborder" valign="top" width="67.80000000000001%" headers="mcps1.1.4.1.3 "><p id="p1039820018572">自定义信息。</p>
</td>
</tr>
<tr id="row1660814462512"><td class="cellrowborder" valign="top" width="19.17%" headers="mcps1.1.4.1.1 "><p id="p19609124617516"><a name="p19609124617516"></a><a name="p19609124617516"></a>length</p>
</td>
...
<td class="cellrowborder" valign="top" width="67.80000000000001%" headers="mcps1.1.4.1.3 "><p id="p123961002578">userdata的长度，单位Byte。</p><p>
    length建议配置为18字节；如果未满18字节，将会自动在数据末尾补0到18字节；如果超过18字节，接口会校验报错返回。
    </p>
</td>
</tr>
<tr id="row1660814462513"><td class="cellrowborder" valign="top" width="19.17%" headers="mcps1.1.4.1.1 "><p id="p19609124617526">stream</p>
</td>
<td class="cellrowborder" valign="top" width="13.03%" headers="mcps1.1.4.1.2 "><p id="p161915469510">输入</p>
</td>
<td class="cellrowborder" valign="top" width="67.80000000000001%" headers="mcps1.1.4.1.3 "><p id="p123961012578">指定执行打点任务的Stream。</p>
</td>
</tr>    
</tbody>
</table>
