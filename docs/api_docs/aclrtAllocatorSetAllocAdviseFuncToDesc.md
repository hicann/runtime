# aclrtAllocatorSetAllocAdviseFuncToDesc<a name="ZH-CN_TOPIC_0000001621987201"></a>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p42510325256"><a name="p42510325256"></a><a name="p42510325256"></a>根据建议地址申请内存block的回调函数。</p>
