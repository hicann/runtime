# acltdtSendTensor<a name="ZH-CN_TOPIC_0000001312721881"></a>
...
<tbody><tr id="row10379818172019"><td class="cellrowborder" valign="top" width="18%" headers="mcps1.1.4.1.1 "><p id="p5380121811206"><a name="p5380121811206"></a><a name="p5380121811206"></a>handle</p>
</td>
...
<p id="p14415932295"><a name="p14415932295"></a><a name="p14415932295"></a>需提前调用<a href="acltdtCreateChannel.md">acltdtCreateChannel</a>接口或<a href="acltdtCreateChannelWithCapacity.md">acltdtCreateChannelWithCapacity</a>接口创建acltdtChannelHandle类型的数据。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.2 "><p id="p947017134517"><a name="p947017134517"></a><a name="p947017134517"></a>输入</p>
</td>
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p16470117144511"><a name="p16470117144511"></a><a name="p16470117144511"></a>向Device发送的数据的指针。</p>
</td>
</tr>
...
<div class="p" id="p19168192614220"><a name="p19168192614220"></a><a name="p19168192614220"></a>该参数取值范围如下：<a name="ul106543915231"></a><a name="ul106543915231"></a><ul id="ul106543915231"><li>-1：阻塞方式，一直等待直到数据发送完成。</li><li>0：非阻塞方式，当通道满时，直接返回通道满这个错误，这时由用户自行设定重试间隔。</li><li>&gt;0：配置具体的超时时间，单位为毫秒。通道满时，等待达到超时时间后返回报错。<p id="p19664120154818"><a name="p19664120154818"></a><a name="p19664120154818"></a>超时时间受操作系统影响，一般偏差在操作系统的一个时间片内，例如，操作系统的一个时间片为4ms，用户设置的超时时间为1ms，则实际的超时时间在1ms到5ms范围内。在CPU负载高场景下，超时时间仍可能存在波动。</p>
</li></ul>
</div>
</td>
</tr>
