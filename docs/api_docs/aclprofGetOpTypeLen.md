# aclprofGetOpTypeLen<a name="ZH-CN_TOPIC_0000001265241814"></a>
...
## 功能说明<a name="section2857102414306"></a>
...
## 参数说明<a name="section12749114513017"></a>
...
<td class="cellrowborder" valign="top" width="14.000000000000002%" headers="mcps1.1.4.1.2 "><p id="p6353121416418"><a name="p6353121416418"></a><a name="p6353121416418"></a>输出</p>
</td>
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p1835319142411"><a name="p1835319142411"></a><a name="p1835319142411"></a>opType的长度。</p>
</td>
</tr>
</tbody>
</table>

## 返回值说明<a name="section2175162318411"></a>
