# aclrtGetThreadIdFromExceptionInfo<a name="ZH-CN_TOPIC_0000001312721429"></a>
...
<td class="cellrowborder" valign="top" width="68%" headers="mcps1.1.4.1.3 "><p id="p18611143374411"><a name="p18611143374411"></a><a name="p18611143374411"></a>异常信息的指针。</p>
<p id="p79219230547"><a name="p79219230547"></a><a name="p79219230547"></a>在执行任务之前调用<a href="aclrtSetExceptionInfoCallback.md">aclrtSetExceptionInfoCallback</a>接口，系统会将产生异常的任务ID、Stream ID、线程ID、Device ID存放在aclrtExceptionInfo结构体中。</p>
</td>
</tr>
</tbody>
</table>
