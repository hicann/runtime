...
mmSocketSendTo(mmSockHandle sockFd, VOID* sendMsg, INT32 sendLen, UINT32 sendFlag, const mmSockAddr* addr, INT32 tolen);
MMPA_FUNC_VISIBILITY mmSsize_t mmSocketRecvFrom(
...
MMPA_FUNC_VISIBILITY INT32 mmPoll(
...
MMPA_FUNC_VISIBILITY CHAR* mmSysGetEnv(mmEnvId id) MMPA_WEAK_FUC;
MMPA_FUNC_VISIBILITY INT32 mmSysSetEnv(mmEnvId id, const CHAR* value, INT32 overwrite) MMPA_WEAK_FUC;
MMPA_FUNC_VISIBILITY INT32 mmSysUnsetEnv(mmEnvId id) MMPA_WEAK_FUC;
