...
const std::map<std::string, SocVersion> SOC_VERSION_STR {
    ...
    {"BS9SX2AA", SocVersion::BS9SX2AA},
    {"BS9SX2AB", SocVersion::BS9SX2AB},
    {"MC61AM21AB", SocVersion::MC61AM21AB},
    {"AS31XM1X", SocVersion::AS31XM1X},
    {"MC61AM21AA", SocVersion::MC61AM21AA},
    {"BS9SX1AB", SocVersion::BS9SX1AB},
    {"BS9SX1AC", SocVersion::BS9SX1AC},
    {"Ascend035A", SocVersion::ASCEND035A},
    {"Ascend035B", SocVersion::ASCEND035B},
    {"Ascend310P5", SocVersion::ASCEND310P5},
    {"Ascend310P7", SocVersion::ASCEND310P7},
    {"Ascend910_5591", SocVersion::ASCEND910_5591},
    {"Ascend910_9362", SocVersion::ASCEND910_9362},
    {"Ascend910_9382", SocVersion::ASCEND910_9382},
    {"Ascend910_9392", SocVersion::ASCEND910_9392},
    {"Ascend910_950z", SocVersion::ASCEND910_950z},
    {"Ascend910_957b", SocVersion::ASCEND910_957b},
    {"Ascend910_957d", SocVersion::ASCEND910_957d},
    {"Ascend910_9581", SocVersion::ASCEND910_9581},
    {"Ascend910_9589", SocVersion::ASCEND910_9589},
    {"Ascend910_958a", SocVersion::ASCEND910_958a},
    {"Ascend910_958b", SocVersion::ASCEND910_958b},
    {"Ascend910_9599", SocVersion::ASCEND910_9599},
    {"Ascend910_95A1", SocVersion::ASCEND910_95A1},
    {"Ascend910_95A2", SocVersion::ASCEND910_95A2},
    {"Ascend910_9571", SocVersion::ASCEND910_9571},
    {"Ascend910_9573", SocVersion::ASCEND910_9573},
    {"Ascend910_9583", SocVersion::ASCEND910_9583},
    {"Ascend910_9585", SocVersion::ASCEND910_9585},
    {"Ascend910_9586", SocVersion::ASCEND910_9586},
    {"Ascend910_9595", SocVersion::ASCEND910_9595},
    {"Ascend910_9596", SocVersion::ASCEND910_9596},
...
enum class IntrinsicAbility {
  add = 0, anti_quant_add = 1, anti_quant_sub = 2, b8u2 = 3, bb = 4,
  bf16 = 5, bf162f32 = 6, bf162s32a = 7, bf162s32c = 8, bf162s32f = 9,
  bf162s32r = 10, bf162s32z = 11, bs16 = 12, bs32 = 13, bs8 = 14,
  bu16 = 15, bu32 = 16, bu8 = 17, cast = 18, clip_relu = 19,
  deq = 20, deqs322f16 = 21, dequant = 22, f16 = 23, f162f16 = 24,
  f162f32 = 25, f162s16 = 26, f162s16a = 27, f162s16c = 28, f162s16f = 29,
  f162s16r = 30, f162s16z = 31, f162s32a = 32, f162s32c = 33, f162s32f = 34,
  f162s32r = 35, f162s32z = 36, f162s4 = 37, f162s8 = 38, f162s8a = 39,
  f162s8c = 40, f162s8f = 41, f162s8r = 42, f162s8z = 43, f162u8 = 44,
  f162u8a = 45, f162u8c = 46, f162u8f = 47, f162u8r = 48, f162u8z = 49,
  f16f16 = 50, f16f16f16 = 51, f16f16s4 = 52, f16f16s8 = 53, f16f16u16 = 54,
  f16f16u2 = 55, f16f32 = 56, f16s16 = 57, f16s32 = 58, f16s32s32 = 59,
  f16s8 = 60, f16u16 = 61, f16u16f16 = 62, f16u2 = 63, f16u8 = 64,
  f32 = 65, f322bf16 = 66, f322bf16a = 67, f322bf16c = 68, f322bf16f = 69,
  f322bf16r = 70, f322bf16z = 71, f322f16 = 72, f322f16a = 73, f322f16c = 74,
  f322f16f = 75, f322f16o = 76, f322f16r = 77, f322f16z = 78, f322f32 = 79,
  f322f32a = 80, f322f32c = 81, f322f32f = 82, f322f32r = 83, f322f32z = 84,
  f322s16a = 85, f322s16c = 86, f322s16f = 87, f322s16r = 88, f322s16z = 89,
  f322s32a = 90, f322s32c = 91, f322s32f = 92, f322s32r = 93, f322s32z = 94,
  f322s4 = 95, f322s64a = 96, f322s64c = 97, f322s64f = 98, f322s64r = 99,
  f322s64z = 100, f322s8 = 101, f322u8 = 102, f32f16 = 103, f32f16f16 = 104,
  f32f32 = 105, f32f32f32 = 106, f32s16 = 107, f32s32 = 108, f32u32 = 109,
  f32u32f32 = 110, float16 = 111, float32 = 112, h322f32 = 113, int16 = 114,
  int32 = 115, int64 = 116, int8 = 117, normal_relu = 118, nz2nd = 119,
  post_act = 120, post_eltwise = 121, post_quant = 122, post_transform = 123, pre_act = 124,
  pre_conv = 125, quant = 126, requant = 127, s16 = 128, s162f16 = 129,
  s162f16a = 130, s162f16c = 131, s162f16f = 132, s162f16r = 133, s162f16z = 134,
  s162f32 = 135, s162s16 = 136, s162s32 = 137, s162s8 = 138, s162u32 = 139,
  s162u8 = 140, s16f16 = 141, s16f32 = 142, s16s16 = 143, s16s16u16 = 144,
  s16s32 = 145, s16s48 = 146, s16s64 = 147, s16s8 = 148, s16u16 = 149,
  s16u16s16 = 150, s16u16s8 = 151, s16u32 = 152, s16u8 = 153, s24s16 = 154,
  s24s8 = 155, s24u16 = 156, s24u8 = 157, s32 = 158, s322f16 = 159,
  s322f32 = 160, s322f32a = 161, s322f32c = 162, s322f32f = 163, s322f32r = 164,
  s322f32z = 165, s322s16 = 166, s322s4 = 167, s322s64 = 168, s322s8 = 169,
  s322u16 = 170, s322u8 = 171, s32f32 = 172, s32s16 = 173, s32s32 = 174,
  s32s4s4 = 175, s32s8s8 = 176, s32u16 = 177, s32u32 = 178, s32u32s32 = 179,
  s32u8 = 180, s32u8s8 = 181, s32u8u2 = 182, s32u8u8 = 183, s4 = 184,
  s48s16 = 185, s48s32 = 186, s48u16 = 187, s642f32a = 188, s642f32c = 189,
  s642f32f = 190, s642f32r = 191, s642f32z = 192, s642s32 = 193, s64s32 = 194,
  s8 = 195, s82f16 = 196, s82s16 = 197, s82s32 = 198, s82s8 = 199,
  s8f16 = 200, s8f16f16 = 201, s8s16 = 202, s8s24 = 203, s8s32 = 204,
  s8s48 = 205, s8s8 = 206, s8s8u8 = 207, s8u16 = 208, scalar_relu = 209,
  sub = 210, u16 = 211, u162s32 = 212, u162u32 = 213, u162u8 = 214,
  u16s16 = 215, u16s48 = 216, u16s64 = 217, u16u16 = 218, u16u16u16 = 219,
  u16u16u8 = 220, u16u32 = 221, u16u8 = 222, u32 = 223, u322s16 = 224,
  u322u16 = 225, u322u8 = 226, u32s16 = 227, u32s32 = 228, u32u16 = 229,
  u32u32 = 230, u32u32u32 = 231, u32u8 = 232, u32u8u8 = 233, u8 = 234,
  u82f16 = 235, u82s16 = 236, u82s32 = 237, u82u16 = 238, u82u32 = 239,
  u8f16 = 240, u8f16f16 = 241, u8s16 = 242, u8s24 = 243, u8s48 = 244,
  u8s8 = 245, u8u16 = 246, u8u32 = 247, u8u8 = 248, u8u8u8 = 249,
  uint16 = 250, uint32 = 251, uint64 = 252, uint8 = 253, vdeqs162b8 = 254,
  vector_relu = 255, e4m3e4m3 = 256, e4m3e5m2 = 257, e5m2e4m3 = 258, e5m2e5m2 = 259,
  s32s8s4 = 260, s32s16s8 = 261
};
