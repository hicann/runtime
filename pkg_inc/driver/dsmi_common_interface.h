 ...
 * @note Support:Ascend310,Ascend310B,Ascend910,Ascend310P,Ascend910B,Ascend910_93,Ascend950,Ascend910_55
 */
DLLEXPORT int dsmi_get_component_list(
    int device_id, DSMI_COMPONENT_TYPE* component_table, unsigned int component_count);
 ...
 */
DLLEXPORT int dsmi_set_device_ip_address(
    int device_id, int port_type, int port_id, ip_addr_t ip_address, ip_addr_t mask_address);
 ...
 * @note Support:Ascend310,Ascend310B,Ascend910,Ascend910B,Ascend910_93,Ascend950,Ascend910_55
 */
DLLEXPORT int dsmi_get_device_ip_address(
    int device_id, int port_type, int port_id, ip_addr_t* ip_address, ip_addr_t* mask_address);
 ...
 * @note Support:
 */
DLLEXPORT int dsmi_get_safetyisland_status(
    int device_id, struct dsmi_safetyisland_status_stru* safetyisland_status_data);
 ...
 * @note Support:Ascend310,Ascend310B,Ascend310P,Ascend910,Ascend910B,Ascend910_93,Ascend950,Ascend910_55
 */
DLLEXPORT int dsmi_get_resource_info(
    unsigned int devid, struct dsmi_resource_para* para, struct dsmi_resource_info* info);
 ...
 * @note Support:Ascend310,Ascend310B,Ascend910,Ascend310P,Ascend910B,Ascend910_93,Ascend950,Ascend910_55
 */
DLLEXPORT int dsmi_read_fault_event(
    int device_id, int timeout, struct dsmi_event_filter filter, struct dsmi_event* event);
 ...
 * @note Support:
 */
DLLEXPORT int dsmi_ctrl_device_node(
    int device_id, struct dsmi_dtm_node_s dtm_node, DSMI_DTM_OPCODE opcode, IN_OUT_BUF buf);
 ...
 * @note Support:
 */
DLLEXPORT int dsmi_get_all_device_node(
    int device_id, DEV_DTM_CAP capability, struct dsmi_dtm_node_s node_info[], unsigned int* size);
 ...
 * @note Support:
 */
DLLEXPORT int dsmi_get_device_state(
    int device_id, DSMI_DEV_NODE_STATE* node_state, unsigned int max_num, unsigned int* num);
 ...
 * @return  0 for success, others for fail
 * @note
 * Support:Support:Ascend310,Ascend310B,Ascend910,Ascend610,as31xm1,Ascend310P,Ascend910B,Ascend910_93,bs9sx1a,Ascend610Lite,Ascend950,Ascend910_55
 */
