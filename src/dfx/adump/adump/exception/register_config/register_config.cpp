...
void CloudV4Register::GenAIVDbgAddr(){
    std::vector<RegisterTable> regAIVDbgTab =  {
        ...
        {0X23000000000000, 1, 4}, {0X24000000000000, 23, 4}, {0X32000000000000, 1, 4},   
        {0X32000000000010, 1, 4}, {0X32000000000020, 1, 4}, {0X32000000000030, 1, 4},    
        {0X32000000000040, 1, 4}, {0X32000000000050, 1, 4}, {0X32000000000060, 1, 4},   
        {0X32000000000070, 1, 4}, {0X32000000000080, 1, 4}, {0X32000000000090, 1, 4},    
        {0X320000000000a0, 1, 4}, {0X320000000000b0, 1, 4}, {0X320000000000c0, 1, 4},   
        {0X320000000000d0, 1, 4}, {0X320000000000e0, 1, 4}, {0X320000000000f0, 1, 4},   
        {0X32000000000100, 1, 4}, {0X32000000000110, 1, 4}, {0X32000000000120, 1, 4},   
        {0X32000000000130, 1, 4}, {0X32000000000140, 1, 4}, {0X32000000000150, 1, 4},    
        {0X32000000000160, 1, 4}, {0X32000000000170, 1, 4}, {0X32000000000180, 1, 4},   
        {0X32000000000190, 1, 4}, {0X320000000001a0, 1, 4}, {0X320000000001b0, 1, 4},    
        {0X320000000001c0, 1, 4}, {0X320000000001d0, 1, 4}, {0X320000000001e0, 1, 4},   
        {0X320000000001f0, 1, 4}, {0X32000000000200, 1, 4}, {0X32000000000202, 1, 4},  
        ...
        {0X32000000002c00, 1, 4}, {0X39000000000000, 5, 4}, {0X39000000004000, 1, 4},    
        {0X39000000008000, 1, 4}, {0X3900000000c000, 1, 4}, {0X39000000010000, 1, 4},   
        {0X39000000014000, 1, 4}, {0X39000000018000, 1, 4}, {0X3900000001c000, 1, 4},   
