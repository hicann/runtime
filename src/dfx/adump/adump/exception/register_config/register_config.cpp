...
const std::vector<ErrorRegisterTable>& RegisterInterface::GetErrorRegisterTable() const { return ErrorRegisterMap_; }
...
void CloudBaseRegister::GenAICDbgAddr()
{
    std::vector<RegisterTable> regAICDbgTab = {
        // SU(for AIC)
        {0X10000000000000, 32, 8},
        {0X10000000000040, 15, 8},
        {0X10000000000080, 12, 8},
        {0X15000000000000, 32, 8},
        {0X15800000000000, 32, 8},
        {0X16000000000000, 16, 8},
        {0X16800000000000, 32, 8},
        // MTE(for AIC)
        {0X21000000000000, 1, 8},
        {0X22000000000000, 2, 8},
        {0X22000000000003, 4, 8},
        {0X22000000000012, 1, 8},
        {0X24000000000014, 1, 8},
        // CUBE
        {0X40000000000000, 8, 8},
        {0X40000000000008, 8, 8},
        {0X40000000000010, 8, 8},
        {0X40000000000018, 8, 8},
        {0X40000000000020, 8, 8},
        {0X40000000000028, 8, 8},
        {0X40000000000030, 8, 8},
        {0X40000000000038, 8, 8},
        {0X40000000000040, 8, 8},
        {0X40000000000048, 8, 8},
        {0X40000000000050, 8, 8},
        {0X40000000000058, 8, 8},
        ...
        // others
        {0X80000000000000, 5, 8},
        {0X90000000000000, 9, 8},
        {0X90000000000040, 8, 8},
        {0X90000000000080, 13, 8},
        {0X900000000000c0, 8, 8},
        {0Xa0000000000000, 3, 8},
        {0Xa0000000000100, 3, 8},
        {0Xa0000000000200, 3, 8},
        {0Xa0000000001000, 1, 8},
        {0Xa0000000001100, 1, 8},
        {0Xa0000000001200, 1, 8},
        {0Xa0000000002100, 2, 8},
        {0Xa0000000002200, 2, 8},
        {0Xa0000000003000, 1, 8},
        {0Xa0000000008100, 3, 8},
        {0Xc0000000000000, 16, 8},
        {0Xd0000000000000, 1, 8},
        {0Xd0000000000008, 1, 8},
        {0Xd0000000000010, 1, 8},
        {0Xd0000000000018, 1, 8},
        {0Xd0000000000020, 1, 8},
        {0Xd0000000000028, 1, 8},
        {0Xd0000000000030, 1, 8},
        {0Xd0000000000038, 1, 8},
        {0Xe0000000000000, 5, 8},
        {0Xe0000000000100, 3, 8},
        {0Xe0000000000200, 6, 8},
        {0Xe0000000000300, 2, 8},
        {0Xe0000000000400, 1, 8},
        {0Xe0000000000500, 9, 8},
...
{
    return {
        {0X10000000000000, 32, 8}, {0X10000000000040, 15, 8}, {0X10000000000080, 12, 8}, {0X15000000000000, 32, 8},
        {0X15800000000000, 32, 8}, {0X16000000000000, 16, 8}, {0X16800000000000, 16, 8},
    };
}
...
std::vector<RegisterTable> CloudBaseRegister::GenAIVDbgMTEAddr()
{
    return {
        {0X21000000000000, 1, 8},
        {0X22000000000002, 1, 8},
        {0X22000000000007, 3, 8},
        {0X2200000000000d, 3, 8},
        {0X22000000000016, 9, 8}};
}

std::vector<RegisterTable> CloudBaseRegister::GenAIVDbgVECRBAddr()
{
    return {{0X32000000000000, 8, 32},    {0X32000000000010, 8, 32},    {0X32000000000020, 8, 32},
            ...
            {0X3200000000020e, 1, 32},    {0X32000000000400, 24, 32},   {0X32000000000440, 24, 32},
            {0X32000000000480, 24, 32},   {0X320000000004c0, 24, 32},   {0X32000000000600, 4, 32},
            ...
            {0X39000000000000, 5, 8},     {0X39000000004000, 64, 8},    {0X39000000008000, 0x80, 32},
            {0X3900000000c000, 0x80, 32}, {0X39000000010000, 0x80, 32}, {0X39000000014000, 0x80, 32},
            {0X39000000014080, 0x80, 32}, {0X39000000014100, 0x80, 32}, {0X39000000014180, 0x80, 32},
            {0X39000000014200, 0x80, 32}, {0X39000000014280, 0x80, 32}, {0X39000000014300, 0x80, 32},
            {0X39000000014380, 0x80, 32}, {0X39000000014400, 0x80, 32}, {0X39000000014480, 0x80, 32},
            {0X39000000014500, 0x80, 32}, {0X39000000014580, 0x80, 32}, {0X39000000014600, 0x80, 32},
            {0X39000000014680, 0x80, 32}, {0X39000000014700, 0x80, 32}, {0X39000000014780, 0x80, 32},
            {0X39000000014800, 0x80, 32}, {0X39000000014880, 0x80, 32}, {0X39000000014900, 0x80, 32},
            {0X39000000014980, 0x80, 32}, {0X39000000014a00, 0x80, 32}, {0X39000000014a80, 0x80, 32},
            {0X39000000014b00, 0x80, 32}, {0X39000000014b80, 0x80, 32}, {0X39000000014c00, 0x80, 32},
            {0X39000000014c80, 0x80, 32}, {0X39000000014d00, 0x80, 32}, {0X39000000014d80, 0x80, 32},
            {0X39000000014e00, 0x80, 32}, {0X39000000014e80, 0x80, 32}, {0X39000000014f00, 0x80, 32},
            {0X39000000014f80, 0x80, 32}, {0X39000000018000, 0x200, 8}, {0X3900000001c000, 64, 8}};
}

std::vector<RegisterTable> CloudBaseRegister::GenAIVDbgOthersAddr()
{
    return {{0X80000000000000, 5, 8}, {0X90000000000000, 9, 8}, {0X90000000000040, 8, 8}, {0X90000000000080, 13, 8},
            {0X900000000000c0, 8, 8}, {0Xa0000000000000, 3, 8}, {0Xa0000000000100, 3, 8}, {0Xa0000000000200, 3, 8},
            {0Xa0000000001000, 1, 8}, {0Xa0000000001100, 1, 8}, {0Xa0000000001200, 1, 8}, {0Xa0000000002100, 2, 8},
            {0Xa0000000002200, 2, 8}, {0Xa0000000003000, 1, 8}, {0Xa0000000008100, 3, 8}, {0Xb0000000000000, 1, 8},
            {0Xb0000000000008, 1, 8}, {0Xb0000000000010, 1, 8}, {0Xb0000000000018, 1, 8}, {0Xb0000000000020, 1, 8},
            {0Xb0000000000040, 1, 8}, {0Xb0000000000080, 1, 8}, {0Xb00000000000c0, 1, 8}, {0Xb0000000000100, 1, 8},
            {0Xb0000000000140, 1, 8}, {0Xb0000000000180, 1, 8}, {0Xb00000000001c0, 1, 8}, {0Xb00000000001c8, 1, 8},
            {0Xb0000000000200, 1, 8}, {0Xb0000000000240, 1, 8}, {0Xb0000000000280, 1, 8}, {0Xb0000000000288, 1, 8},
            {0Xb0000000000290, 1, 8}, {0Xb00000000002c0, 1, 8}, {0Xb00000000002c8, 1, 8}, {0Xb0000000000300, 1, 8},
            {0Xb0000000000340, 1, 8}, {0Xd0000000000000, 1, 8}, {0Xd0000000000008, 1, 8}, {0Xd0000000000010, 1, 8},
            {0Xd0000000000018, 1, 8}, {0Xd0000000000020, 1, 8}, {0Xd0000000000028, 1, 8}, {0Xd0000000000030, 1, 8},
            {0Xd0000000000038, 1, 8}};
}
...
void CloudBaseRegister::GenAIVOffsetAddr()
{
    std::vector<RegisterTable> regAIVOffsetTab = {
        {0X80, 30, 4},   {0X1000, 3, 4},  {0X11f0, 1, 4},  {0X1500, 4, 4}, {0X2000, 1, 4}, {0X2010, 1, 4},
        {0X1200, 2, 4},  {0X1210, 1, 4},  {0X1400, 5, 4},  {0X2020, 1, 4}, {0X2030, 2, 4}, {0X2400, 1, 4},
...
RegisterManager::RegisterManager() { CreateRegister(); }
...
const std::shared_ptr<RegisterInterface> RegisterManager::GetRegister() { return register_; }
} // namespace Adx
