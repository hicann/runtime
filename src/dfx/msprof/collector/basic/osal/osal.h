...
OSAL_FUNC_VISIBILITY int32_t
OsalScandir(const CHAR* path, OsalDirent*** entryList, OsalFilter filterFunc, OsalSort sort);
...
OSAL_FUNC_VISIBILITY int32_t
OsalCreateProcess(const CHAR* fileName, const OsalArgvEnv* env, const CHAR* stdoutRedirectFile, OsalProcess* id);
OSAL_FUNC_VISIBILITY int32_t OsalCreateTaskWithThreadAttr(
...
OSAL_FUNC_VISIBILITY int32_t
OsalGetOptLong(int32_t argc, CHAR* const* argv, const CHAR* opts, const OsalStructOption* longOpts, int32_t* longIndex);
