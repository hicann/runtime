...
LinuxScandir(const CHAR* path, OsalDirent*** entryList, OsalFilter filterFunc, OsalSort sort);
...
OSAL_FUNC_VISIBILITY int32_t
LinuxCreateProcess(const CHAR* fileName, const OsalArgvEnv* env, const CHAR* stdoutRedirectFile, OsalProcess* id);
OSAL_FUNC_VISIBILITY int32_t LinuxCreateTaskWithThreadAttr(
...
OSAL_FUNC_VISIBILITY int32_t LinuxGetOptLong(
