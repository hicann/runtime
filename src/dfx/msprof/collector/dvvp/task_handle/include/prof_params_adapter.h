...
public:
    ...
    int32_t Init() const;
    int32_t StartReqTrfToInnerParam(
    ...
    int32_t CheckApiConfigIsValid(
        SHARED_PTR_ALIA<analysis::dvvp::message::ProfileParams> params, aclprofConfigType type,
        const std::string& config);
    int32_t CheckApiConfigIsValidTwo(
        SHARED_PTR_ALIA<analysis::dvvp::message::ProfileParams> params, aclprofConfigType type,
        const std::string& config);
    int32_t CheckApiConfigIsValidThree(
        SHARED_PTR_ALIA<analysis::dvvp::message::ProfileParams> params, aclprofConfigType type,
        const std::string& config);
