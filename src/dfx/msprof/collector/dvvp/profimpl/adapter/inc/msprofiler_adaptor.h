...
ProfAclInit(Msprof::Engine::Intf::ProfType type, const char* profilerPath, uint32_t length);
extern "C" MSVP_PROF_API int32_t
ProfAclWarmup(Msprof::Engine::Intf::ProfType type, PROF_CONFIG_CONST_PTR profilerConfig);
extern "C" MSVP_PROF_API int32_t
ProfAclStart(Msprof::Engine::Intf::ProfType type, PROF_CONFIG_CONST_PTR profilerConfig);
extern "C" MSVP_PROF_API int32_t ProfAclStop(Msprof::Engine::Intf::ProfType type, PROF_CONFIG_CONST_PTR profilerConfig);
...
extern "C" MSVP_PROF_API int32_t ProfAclSubscribe(
    Msprof::Engine::Intf::ProfType type, uint32_t modelId, const aclprofSubscribeConfig* profSubscribeConfig);
...
extern "C" MSVP_PROF_API size_t
ProfAclGetId(Msprof::Engine::Intf::ProfType type, CONST_VOID_PTR opInfo, size_t opInfoLen, uint32_t index);
extern "C" MSVP_PROF_API int32_t
