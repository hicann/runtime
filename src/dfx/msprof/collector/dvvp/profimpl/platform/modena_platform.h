...
#ifndef DVVP_COLLECT_PLATFORM_MODENA_PLATFORM_H
#define DVVP_COLLECT_PLATFORM_MODENA_PLATFORM_H
#include "platform_interface.h"

namespace Dvvp {
namespace Collect {
namespace Platform {
class ModenaPlatform : public PlatformInterface {
public:
    ModenaPlatform();
    ~ModenaPlatform() override {}
