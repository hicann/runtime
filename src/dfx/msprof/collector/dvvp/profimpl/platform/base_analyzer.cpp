...
void BaseAnalyzer::InitFuncMapWithItself()
{
    pmuFuncMap_.insert({
        {"0x500",
         {"write_cache_hit", &pmuCalculator_->CalculateSelf, PmuCalculationType::WITH_ITSELF, {FLOAT_BIT, FLOAT_BIT}}},
        {"0x502",
        ...
        {"0x50a",
         {"r1_read_cache_miss_allocate",
          ...
          {FLOAT_BIT, FLOAT_BIT}}},
        {"Custom:",
         {"Custom:", &pmuCalculator_->CalculateSelf, PmuCalculationType::WITH_ITSELF, {FLOAT_BIT, FLOAT_BIT}}},
    });
}
