...
 */
#ifndef DVVP_COLLECT_PLATFORM_MDC_LITE_V2_PLATFORM_H
#define DVVP_COLLECT_PLATFORM_MDC_LITE_V2_PLATFORM_H
#include "platform_interface.h"

namespace Dvvp {
namespace Collect {
namespace Platform {
class MdcLiteV2Platform : public PlatformInterface {
public:
    MdcLiteV2Platform();
    ~MdcLiteV2Platform() override {}
