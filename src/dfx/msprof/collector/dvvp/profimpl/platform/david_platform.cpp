...
constexpr char DAVID_MEMORY[] = "0x422,0x423,0x56f,0x571,0x570,0x572,0x707,0x709";
...
DavidPlatform::DavidPlatform()
{
    supportedFeature_ = {
        ...
        PLATFORM_TASK_TRACE, PLATFORM_TASK_TRACE_L3, PLATFORM_TASK_STARS_ACSQ, PLATFORM_TASK_TS_KEYPOINT,
        ...
        PLATFORM_TASK_INSTR_PROFILING, PLATFORM_TASK_PC_SAMPLING,
        // Device
        ...
        PLATFORM_ACLAPI_SETDEVICE_ENABLE, PLATFORM_API_STATS, PLATFORM_AICPU_SAMPLE_PERIOD};
    InsertPmuFeature();
    InsertSysFeature();
}
