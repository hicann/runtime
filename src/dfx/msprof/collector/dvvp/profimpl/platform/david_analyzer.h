...
private:
    ...
    {
        // PipeUtilization
        BaseAnalyzer::pmuFuncMap_["0x501"] = {
            "vec_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x301"] = {
            "mac_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x1"] = {
            "scalar_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x701"] = {
            "mte1_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x202"] = {
            "mte2_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x203"] = {
            "mte3_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x34"] = {
            "icache_req_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x35"] = {
            "icache_miss_rate",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x714"] = {
            "fixpipe_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
    ...
    void AdaptDavidMemFuncMap()
    {
        ...
        BaseAnalyzer::pmuFuncMap_["0x401"] = {
            ...
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_THREE, SCALAR_EIGHT}};
        BaseAnalyzer::pmuFuncMap_["0x56f"] = {
            "ub_read_bw_ext(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_FOUR}};
        BaseAnalyzer::pmuFuncMap_["0x571"] = {
            "ub_read_bw_vec(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_FOUR}};
        BaseAnalyzer::pmuFuncMap_["0x570"] = {
            "ub_write_bw_ext(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_FOUR}};
        BaseAnalyzer::pmuFuncMap_["0x572"] = {
            "ub_write_bw_vec(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_FOUR}};
        BaseAnalyzer::pmuFuncMap_["0x707"] = {
            "l1_read_bw(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_SIXTEEN}};
        BaseAnalyzer::pmuFuncMap_["0x709"] = {
            "l1_write_bw(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
    ...
    {
        BaseAnalyzer::pmuFuncMap_["0x304"] = {
            "l0a_read_bw(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_SIXTEEN}};
        BaseAnalyzer::pmuFuncMap_["0x703"] = {
            "l0a_write_bw(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_SIXTEEN}};
        BaseAnalyzer::pmuFuncMap_["0x306"] = {
            "l0b_read_bw(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_EIGHT}};
        BaseAnalyzer::pmuFuncMap_["0x705"] = {
            "l0b_write_bw(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_EIGHT}};
        BaseAnalyzer::pmuFuncMap_["0x712"] = {
            "l0c_read_bw(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_EIGHT}};
        BaseAnalyzer::pmuFuncMap_["0x30a"] = {
            "l0c_read_bw_cube(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_EIGHT, SCALAR_EIGHT}};
        BaseAnalyzer::pmuFuncMap_["0x308"] = {
    ...
    {
        BaseAnalyzer::pmuFuncMap_["0x3"] = {
            "ub_read_bw_scalar(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_SEVEN, SCALAR_ONE}};
        BaseAnalyzer::pmuFuncMap_["0x5"] = {
            "ub_write_bw_scalar(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_SEVEN, SCALAR_ONE}};
        BaseAnalyzer::pmuFuncMap_["0x206"] = {
            "ub_write_bw_mte(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_SEVEN, SCALAR_ONE}};
        BaseAnalyzer::pmuFuncMap_["0x204"] = {
            "ub_read_bw_mte(GB/s)",
            &pmuCalculator_->CalculateWithFreq,
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_SEVEN, SCALAR_ONE}};
        ...
        BaseAnalyzer::pmuFuncMap_["0x572"] = {
            ...
            PmuCalculationType::WITH_FREQ,
            {PIPE_TWO_SEVEN, SCALAR_TWO}};
        BaseAnalyzer::pmuFuncMap_["0x70c"] = {
    ...
    {
        BaseAnalyzer::pmuFuncMap_["0x323"] = {
            "mac_fp16_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x324"] = {
            "mac_int8_ratio",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
    ...
    {
        BaseAnalyzer::pmuFuncMap_["0x556"] = {
            "stu_pmu_wctl_ub_cflt",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x540"] = {
            "ldu_pmu_ib_ub_cflt",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x502"] = {
            "pmu_idc_aic_vec_instr_vf_busy_o",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
        BaseAnalyzer::pmuFuncMap_["0x528"] = {
            "idu_pmu_ins_iss_cnt",
            &pmuCalculator_->CalculateWithoutFreq,
            PmuCalculationType::WITHOUT_FREQ,
            {FLOAT_BIT, FLOAT_BIT}};
