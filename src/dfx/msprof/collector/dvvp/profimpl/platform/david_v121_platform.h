...
#ifndef DVVP_COLLECT_PLATFORM_DAVID_V121_PLATFORM_H
#define DVVP_COLLECT_PLATFORM_DAVID_V121_PLATFORM_H
#include "platform_interface.h"

namespace Dvvp {
namespace Collect {
namespace Platform {
class DavidV121Platform : public PlatformInterface {
public:
    DavidV121Platform();
    ~DavidV121Platform() override {}
