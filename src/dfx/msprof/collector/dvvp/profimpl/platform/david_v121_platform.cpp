...
constexpr char DAVID_V121_MEMORY[] = "0x422,0x423,0x56f,0x571,0x570,0x572,0x707,0x709";
...
constexpr char DAVID_V121_L2CACHEEVENT[] = "0x00,0x81,0x82,0x83,0x74,0x75";
...
DavidV121Platform::DavidV121Platform()
{
    supportedFeature_ = {
        ...
        PLATFORM_TASK_TRAINING_TRACE, PLATFORM_TASK_AICPU, PLATFORM_TASK_DYNAMIC, PLATFORM_TASK_DELAY_DURATION,
        PLATFORM_TASK_BLOCK, PLATFORM_TASK_CCU_INSTRUTION, PLATFORM_TASK_CCU_STATISTIC, PLATFORM_TASK_INSTR_PROFILING,
        PLATFORM_TASK_PC_SAMPLING, PLATFORM_TASK_SCALE,
        // Feature
