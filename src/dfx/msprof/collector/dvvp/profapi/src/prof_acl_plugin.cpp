...
int32_t ProfAclPlugin::ProfAclGetOpVal(
...
{
    PthreadOnce(
        &profGetOpExecutionTimeFlag_, []() -> void { ProfAclPlugin::instance()->LoadProfGetOpExecutionTime(); });
...
const char* ProfAclPlugin::ProfGetOpAttriVal(
    uint32_t type, const void* opInfo, size_t opInfoLen, uint32_t index, uint32_t attri)
{
    PthreadOnce(&profAclGetOpAttriValFlag_, []() -> void { ProfAclPlugin::instance()->LoadProfGetOpAttriVal(); });
    if (profGetOpExecutionTime_ != nullptr) {
...
void ProfAclPlugin::LoadProfAclInit()
{
    if (msProfLibHandle_ != nullptr) {
        profAclInit_ = reinterpret_cast<ProfAclInitFunc>(dlsym(msProfLibHandle_, "ProfAclInit"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclWarmup_ = reinterpret_cast<ProfAclCtrlFunc>(dlsym(msProfLibHandle_, "ProfAclWarmup"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclStart_ = reinterpret_cast<ProfAclCtrlFunc>(dlsym(msProfLibHandle_, "ProfAclStart"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclStop_ = reinterpret_cast<ProfAclCtrlFunc>(dlsym(msProfLibHandle_, "ProfAclStop"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclFinalize_ = reinterpret_cast<ProfAclFinalizeFunc>(dlsym(msProfLibHandle_, "ProfAclFinalize"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclSetConfig_ = reinterpret_cast<ProfAclSetConfigFunc>(dlsym(msProfLibHandle_, "ProfAclSetConfig"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclSubscribe_ = reinterpret_cast<ProfAclSubscribeFunc>(dlsym(msProfLibHandle_, "ProfAclSubscribe"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclUnSubscribe_ = reinterpret_cast<ProfAclUnSubscribeFunc>(dlsym(msProfLibHandle_, "ProfAclUnSubscribe"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profOpSubscribe_ = reinterpret_cast<ProfOpSubscribeFunc>(dlsym(msProfLibHandle_, "ProfOpSubscribe"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profOpUnSubscribe_ = reinterpret_cast<ProfOpUnSubscribeFunc>(dlsym(msProfLibHandle_, "ProfOpUnSubscribe"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclDrvGetNum_ = reinterpret_cast<ProfAclDrvGetDevNumFunc>(dlsym(msProfLibHandle_, "ProfAclDrvGetDevNum"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclGetOpTime_ = reinterpret_cast<ProfAclGetOpTimeFunc>(dlsym(msProfLibHandle_, "ProfAclGetOpTime"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclGetId_ = reinterpret_cast<ProfAclGetIdFunc>(dlsym(msProfLibHandle_, "ProfAclGetId"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclGetOpVal_ = reinterpret_cast<ProfAclGetOpValFunc>(dlsym(msProfLibHandle_, "ProfAclGetOpVal"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profGetOpExecutionTime_ =
            reinterpret_cast<ProfGetOpExecutionTimeFunc>(dlsym(msProfLibHandle_, "ProfGetOpExecutionTime"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profGetOpAttriVal_ = reinterpret_cast<ProfGetOpAttriValFunc>(dlsym(msProfLibHandle_, "ProfAclGetOpAttriVal"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profCreateTransport_ =
            reinterpret_cast<ProfCreateTransportTypeFunc>(dlsym(msProfLibHandle_, "ProfCreateParsertransport"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profRegisterTransport_ =
            reinterpret_cast<ProfRegisterTransportFunc>(dlsym(msProfLibHandle_, "ProfRegisterTransport"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profAclGetCompatibleFeatures_ =
            reinterpret_cast<ProfAclGetCompatibleFeaturesFunc>(dlsym(msProfLibHandle_, "ProfAclGetCompatibleFeatures"));
    }
}
...
{
    if (msProfLibHandle_ != nullptr) {
        profGetResultPath_ = reinterpret_cast<ProfGetResultPathFunc>(dlsym(msProfLibHandle_, "ProfGetResultPath"));
    }
}
} // namespace ProfAPI