...
#ifndef DOMAIN_PLARFORM_PLARFORM_FEATURE_H
#define DOMAIN_PLARFORM_PLARFORM_FEATURE_H

#ifdef __cplusplus
extern "C" {
#endif

#define SWITCH_LENGTH 30
#define PMU_EVENT_LENGTH 128

typedef enum PlatformFeature {
    ...
    PLATFORM_TASK_FWK_SCHEDULE,
    PLATFORM_TASK_TRACE,
    PLATFORM_TASK_MSPROFTX,
    PLATFORM_TASK_TSFW,
    PLATFORM_TASK_FRAMEWORK,
    ...
    PLATFORM_SYS_HARDWARE_MEM_FREQ,
    PLATFORM_SYS_IO_SAMPLING_FREQ,
    PLATFORM_SYS_INTERCONNECTION_FREQ,
    PLATFORM_SYS_DEVICE_INSTR_PROFILING,
    PLATFORM_SYS_DEVICE_POWER,
    PLATFORM_HOST_SYS,
    PLATFORM_HOST_SYS_USAGE,
    // sys device inner switch
