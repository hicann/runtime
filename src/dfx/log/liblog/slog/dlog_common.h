...
typedef enum { LOG_WRITE, LOG_FLUSH, LOG_FORK, LOG_ATFORK } CallbackType;
...
static inline const char* DlogGetPidName(void) { return (__progname != NULL) ? __progname : "None"; }
#else
static inline const char* DlogGetPidName(void) { return "None"; }
#endif
