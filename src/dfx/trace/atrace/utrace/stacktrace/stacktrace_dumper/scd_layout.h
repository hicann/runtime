...
#define SCD_THDS_ADDR(pro, n) \
    ((ScdProcess*)(pro) + (ScdProcess*)(pro)->thds.thdArray.offset + (ScdProcess*)(pro)->thds.thdArray.entSize * (n))

#define SCD_MAPS_NUM(pro) ((ScdProcess*)(pro)->maps.mapArray.num)
#define SCD_MAPS_SIZE(pro) ((ScdProcess*)(pro)->maps.mapArray.entSize)
#define SCD_MAPS_ADDR(pro, n) \
    ((ScdProcess*)(pro) + (ScdProcess*)(pro)->maps.mapArray.offset + (ScdProcess*)(pro)->maps.mapArray.entSize * (n))
