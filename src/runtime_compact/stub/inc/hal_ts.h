...
enum prof_cmd_type { PROF_START = 0, PROF_STOP, PROF_READ, PROF_POLL, PROF_GET_CHANNEL_LIST, PROF_CMD_MAX };
...
typedef int32_t halHostAtomic;
typedef int64_t halHostAtomic64;
...
extern drvError_t halEschedWaitEvent(
...
/**
 * @ingroup driver
 * @brief Initialize host mutex.
 * @param [in] mutex Pointer to mutex struct.
 * @return 0 for success, others for fail
 */
extern drvError_t halHostMutexInit(halHostMutex* mutex);

/**
 * @ingroup driver
 * @brief Lock host mutex.
 * @param [in] mutex Pointer to mutex struct.
 * @return 0 for success, others for fail
 */
extern drvError_t halHostMutexLock(halHostMutex* mutex);

/**
 * @ingroup driver
 * @brief Unlock host mutex.
 * @param [in] mutex Pointer to mutex struct.
 * @return 0 for success, others for fail
 */
extern drvError_t halHostMutexUnlock(halHostMutex* mutex);

/**
 * @ingroup driver
 * @brief Destroy host mutex.
 * @param [in] mutex Pointer to mutex struct.
 * @return 0 for success, others for fail
 */
extern drvError_t halHostMutexDestroy(halHostMutex* mutex);

/**
 * @ingroup driver
 * @brief Set host atomic value.
 * @param [in] ptr Pointer to atomic.
 * @param [in] value New value set to atomic.
 * @return None
 */
extern void halHostAtomicSet(halHostAtomic* ptr, int32_t value);

/**
 * @ingroup driver
 * @brief Add value to host atomic.
 * @param [in] ptr Pointer to atomic.
 * @param [in] value Value add to atomic.
 * @return None
 */
extern int32_t halHostAtomicAdd(halHostAtomic* ptr, int32_t value);

/**
 * @ingroup driver
 * @brief Exchange value with host atomic.
 * @param [in] ptr Pointer to atomic.
 * @param [in] value New value to exchange.
 * @return original value from atomic.
 */
extern int32_t halHostAtomicXchg32(halHostAtomic* ptr, int32_t value);

/**
 * @ingroup driver
 * @brief Exchange value with host 64bit atomic.
 * @param [in] ptr Pointer to atomic.
 * @param [in] value New value to exchange.
 * @return original value from atomic.
 */
extern int64_t halHostAtomicXchg64(halHostAtomic64* ptr, int64_t value);

/**
 * @ingroup driver
 * @brief Compare and if atomic same with oldval, exchange new val to atomic.
 * @param [in] ptr Pointer to atomic.
 * @param [in] oldval  Old value to compare.
 * @param [in] newval  New value to exchange.
 * @return True for not same and no exchange happens, False for exchange happens.
 */
extern bool halHostAtomicCmpXchg32(halHostAtomic* ptr, int32_t oldval, int32_t newval);

/**
 * @ingroup driver
 * @brief Compare and if 64bit atomic same with oldval, exchange new val to atomic.
 * @param [in] ptr Pointer to atomic.
 * @param [in] oldval  Old value to compare.
 * @param [in] newval  New value to exchange.
 * @return True for not same and no exchange happens, False for exchange happens.
 */
extern bool halHostAtomicCmpXchg64(halHostAtomic64* ptr, int64_t oldval, int64_t newval);
 ...
 * @return  -1 for fail
 */
extern drvError_t prof_channel_read(
    unsigned int device_id, unsigned int channel_id, char* out_buf, unsigned int buf_size);
/**
 * @ingroup driver
