...
__attribute__((weak)) __attribute__((visibility("default"))) int32_t AicpuGetOpTaskInfo(
    const KfcDumpTask& taskKey, KfcDumpInfo** ptr);

__attribute__((weak)) __attribute__((visibility("default"))) int32_t AicpuDumpOpTaskData(
    const KfcDumpTask& taskKey, void* dumpPtr, uint32_t length);
