...
typedef enum tagModelTaskType {
    ...
    RT_MODEL_TASK_NOP,
    RT_MODEL_TASK_PREPROCESS_KERNEL,
    RT_MODEL_TASK_SUPER_KERNEL,
    RT_MODEL_TASK_MEM_EVENT_RECORD,
    RT_MODEL_TASK_MEM_EVENT_WAIT,
    RT_MODEL_TASK_FUSION_KERNEL
} rtModelTaskType_t;
...
/**
 * @ingroup rt_model
 * @brief print model debug info into a json file
 * @param [in] mdl
 * @param [in] path
 * @param [in] flags
 * @return RT_ERROR_NONE for ok
