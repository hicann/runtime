...
std::string ArgsParser::GetParaParsedStr()
{
    ...
    oss << "deviceId=" << deviceId_ << ", hostPid=" << hostPid_ << ", pidSign=" << pidSign_ << ", vfId=" << vfId_
        << ", logLevel=" << logLevel_ << ", eventLevel_=" << eventLevel_ << ", aicpulogLevel=" << aicpulogLevel_
        << ", deployMode_=" << static_cast<uint32_t>(deployMode_) << ", reschedInterval_=" << reschedInterval_
        << ", groupName_=" << groupName_ << ", schedPolicy_=" << schedPolicy_
        << ", starter_=" << static_cast<uint32_t>(starter_) << ", profCfgData_=" << profCfgData_
        << ", profFlag_=" << profFlag_ << ", abnormalInterval_=" << abnormalInterval_
        << ", withDeviceId_=" << withDeviceId_ << ", withHostPid_=" << withHostPid_ << ", withPidSign_=" << withPidSign_
        << ", withVfId_=" << withVfId_ << ", withLogLevel_=" << withLogLevel_ << ", withGroupName_=" << withGroupName_
        << ", withStarter_=" << withStarter_;
