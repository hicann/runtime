...
REGISTER_PLATFORM_LIB_INFO(CHIP_DEV_0003, "libruntime_v100.so");

static const std::unordered_set<RtOptionalFeatureType> KIRIN_DEV_0003_FEATURE{};
REGISTER_CHIP_FEATURE_SET(CHIP_DEV_0003, KIRIN_DEV_0003_FEATURE);

constexpr uint32_t RT_KIRIN_DEV_0003_AICORE_NUM = 5U;
constexpr uint32_t RT_KIRIN_DEV_0003_AIVECTOR_NUM = 5U;
...
static const DevProperties CHIP_KIRIN_DEV_0003_PROPERTIES = {
    .engineType = "STARS",
    .isStars = true,
    .isStarsV2 = false,
    .pthreadStackSize = 0U,
    ...
    .sqTailOffset = static_cast<uint16_t>(STARS_SIMPLE_SQ_TAIL_OFFSET),
    ...
    .aicNum = RT_KIRIN_DEV_0003_AICORE_NUM,
    .aivNum = RT_KIRIN_DEV_0003_AIVECTOR_NUM,
...
REGISTER_DEV_PROPERTIES(CHIP_DEV_0003, CHIP_KIRIN_DEV_0003_PROPERTIES);
} // namespace runtime
} // namespace cce
