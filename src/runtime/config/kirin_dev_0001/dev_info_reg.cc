...
REGISTER_PLATFORM_LIB_INFO(CHIP_DEV_0001, "libruntime_v100.so");

static const std::unordered_set<RtOptionalFeatureType> KIRIN_DEV_0001_FEATURE{};
REGISTER_CHIP_FEATURE_SET(CHIP_DEV_0001, KIRIN_DEV_0001_FEATURE);

constexpr uint32_t RT_KIRIN_DEV_0001_AICORE_NUM = 5U;
constexpr uint32_t RT_KIRIN_DEV_0001_AIVECTOR_NUM = 5U;
...
static const DevProperties CHIP_KIRIN_DEV_0001_PROPERTIES = {
    .engineType = "STARS",
    .isStars = true,
    .isStarsV2 = false,
    .pthreadStackSize = 0U,
    ...
    .aicNum = RT_KIRIN_DEV_0001_AICORE_NUM,
    .aivNum = RT_KIRIN_DEV_0001_AIVECTOR_NUM,
...
REGISTER_DEV_PROPERTIES(CHIP_DEV_0001, CHIP_KIRIN_DEV_0001_PROPERTIES);
} // namespace runtime
} // namespace cce
