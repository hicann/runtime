...
REGISTER_PLATFORM_LIB_INFO(CHIP_DEV_0002, "libruntime_v100.so");

static const std::unordered_set<RtOptionalFeatureType> KIRIN_DEV_0002_FEATURE{};
REGISTER_CHIP_FEATURE_SET(CHIP_DEV_0002, KIRIN_DEV_0002_FEATURE);

constexpr uint32_t RT_KIRIN_DEV_0002_AICORE_NUM = 1U;
constexpr uint32_t RT_KIRIN_DEV_0002_AIVECTOR_NUM = 1U;
...
static const DevProperties CHIP_KIRIN_DEV_0002_PROPERTIES = {
    .engineType = "STARS",
    .isStars = true,
    .isStarsV2 = false,
    .pthreadStackSize = 0U,
    ...
    .aicNum = RT_KIRIN_DEV_0002_AICORE_NUM,
    .aivNum = RT_KIRIN_DEV_0002_AIVECTOR_NUM,
...
REGISTER_DEV_PROPERTIES(CHIP_DEV_0002, CHIP_KIRIN_DEV_0002_PROPERTIES);
} // namespace runtime
} // namespace cce
