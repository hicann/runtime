...
REGISTER_PLATFORM_LIB_INFO(CHIP_CLOUD_V6, "libruntime_v200.so");

const std::unordered_set<RtOptionalFeatureType> CHIP_CLOUD_V6_FEATURE{
...
REGISTER_CHIP_FEATURE_SET(CHIP_CLOUD_V6, CHIP_CLOUD_V6_FEATURE);
...
static const DevProperties CHIP_CLOUD_V6_PROPERTIES = {
    ...
    .maxCustomerStackSize = 146U * 1024U, // 146 KB
    .ioDieNum = 0U,
    ...
    .memcpyDescriptorSize = 64U, // MEMCPY_DESC_SIZE_V2
...
REGISTER_DEV_PROPERTIES(CHIP_CLOUD_V6, CHIP_CLOUD_V6_PROPERTIES);
} // namespace runtime
} // namespace cce
