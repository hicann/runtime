...
void ErrorcodeManage::InitRtErrCodeMap()
{
    ...
    rtErrMap_[RT_ERROR_INVALID_DEVICE_FUNCTION] = {ACL_ERROR_RT_INVALID_DEVICE_FUNCTION, "invalid device function"};
    ...
    rtErrMap_[RT_ERROR_STREAM_UNJOINED] = {ACL_ERROR_RT_STREAM_UNJOINED,
        "capture model contains a stream that was not joined to the origin stream"};
