...
static void ConstructDavidAICpuSqeForDavinciTaskResFieldPart(RtDavidStarsAicpuKernelSqe *const sqe, const uint64_t addr,
...
static void FillTopicType(RtDavidStarsAicpuKernelSqe * const sqe, const uint32_t kernelFlag)
{
