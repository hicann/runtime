...
constexpr float32_t RT_MC_KERNEL_CREDIT_SCALE = 33554.432F;
...
enum RtCondsSubType {
    ...
    CONDS_SUB_TYPE_CAPTURE_MODEL_COND = 24,
    CONDS_SUB_TYPE_CAPTURE_MODEL_COND_JUMPBACK = 25,
    CONDS_SUB_TYPE_MAX = 26,
};
