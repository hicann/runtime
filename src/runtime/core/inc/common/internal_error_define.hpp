...
constexpr int32_t RT_ERROR_STREAM_NOT_SUPPORT_OPERA = 0x07030028;
constexpr int32_t RT_ERROR_STREAM_SUB_ACLGRAPH_IS_CAPTURING = 0x07030029;
...
constexpr int32_t RT_ERROR_INVALID_DEVICE_FUNCTION  = 0x0708000C;
