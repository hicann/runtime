...
constexpr int32_t RT_ERROR_DRV_LINK_TYPE_NOT_SUPPORTED = 0x07020028;
...
constexpr int32_t RT_ERROR_STREAM_SUB_ACLGRAPH_IS_CAPTURING = 0x07030028;
...
constexpr int32_t RT_ERROR_JETTY_LIMIT = 0x07110019;
