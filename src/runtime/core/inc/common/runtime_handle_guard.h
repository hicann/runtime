...
constexpr uint64_t RT_BIN_HANDLE_MAGIC = 0x42494E48ULL;   // BINH
constexpr uint64_t RT_FUNC_HANDLE_MAGIC = 0x46554E43ULL;  // FUNC
constexpr uint64_t RT_ARGS_HANDLE_MAGIC = 0x41524753ULL;  // ARGS
constexpr uint64_t RT_PARAM_HANDLE_MAGIC = 0x50415241ULL; // PARA
...
REGISTER_RT_MAGIC(Program, RT_BIN_HANDLE_MAGIC);
REGISTER_RT_MAGIC(Kernel, RT_FUNC_HANDLE_MAGIC);
REGISTER_RT_MAGIC(::RtArgsHandle, RT_ARGS_HANDLE_MAGIC);
REGISTER_RT_MAGIC(::ParaDetail, RT_PARAM_HANDLE_MAGIC);
