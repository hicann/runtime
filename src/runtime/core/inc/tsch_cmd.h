...
typedef enum { STARS_QUEUE_QUERY_TYPE_SRC = 0, STARS_QUEUE_QUERY_TYPE_DST } stars_queue_query_type_t;
...
typedef struct {
    ...
    uint64_t input_data_pool_base_addrs[STARS_DQS_MAX_INPUT_QUEUE_NUM]; // 输入mbuf data地址，注意，这里已经加了偏移
                                                                        // dataPoolOffset
    uint64_t input_head_pool_base_addrs[STARS_DQS_MAX_INPUT_QUEUE_NUM]; // 输入mbuf head地址，注意，这里已经加了偏移
                                                                        // headPoolOffset
    ...
    uint64_t output_data_pool_base_addrs[STARS_DQS_MAX_OUTPUT_QUEUE_NUM]; // 输出mbuf data地址，注意，这里已经加了偏移
                                                                          // dataPoolOffset
    uint64_t output_head_pool_base_addrs[STARS_DQS_MAX_OUTPUT_QUEUE_NUM]; // 输出mbuf head地址，注意，这里已经加了偏移
                                                                          // headPoolOffset
