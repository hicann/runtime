...
set(libruntime_cmodel_api_src_files_cmodel
    ...
    ${RUNTIME_DIR}/src/runtime/api/api_c_rt_config.cc
...
set(libruntime_cmodel_src_files
    ...
    ${RUNTIME_FEATURE_DIR}/jetty/stream_ub_db_stub.cc
...
SET(PRODUCT_TYPE_LIST ascend310 ascend610 bs9sx1a ascend310p ascend910 hi3796cv300es hi3796cv300cs ascend910B1 ascend310B ascend610Lite ascend950pr_9599 ascend350 mc62cm12a mc32dm11a ascend960DT_968B7)
...
foreach(product_type ${PRODUCT_TYPE_LIST})
    # ---------------------------------- runtime_cmodel ----------------------------------
    if("${product_type}" STREQUAL "ascend950pr_9599" OR "${product_type}" STREQUAL "ascend350" OR "${product_type}" STREQUAL "ascend960DT_968B7")
    ...
    # -------------------------------- runtime_camodel --------------------------------
    if("${product_type}" STREQUAL "ascend950pr_9599" OR "${product_type}" STREQUAL "ascend350" OR "${product_type}" STREQUAL "mc62cm12a" OR "${product_type}" STREQUAL "mc32dm11a" OR "${product_type}" STREQUAL "ascend960DT_968B7")
