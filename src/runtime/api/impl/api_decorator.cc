...
namespace cce {
namespace runtime {
rtError_t ApiDecorator::NameStream(Stream* const stm, const char_t* const name) { return impl_->NameStream(stm, name); }

rtError_t ApiDecorator::ProfilerStart(
...
ApiDecorator::ApiDecorator(Api* const inImpl) : Api(), impl_(inImpl) { return; }
...
rtError_t ApiDecorator::DevBinaryUnRegister(Program* const prog) { return impl_->DevBinaryUnRegister(prog); }
...
rtError_t ApiDecorator::RegisterFuncSymbol(
...
rtError_t ApiDecorator::FunctionRegister(
...
rtError_t ApiDecorator::RegisterVariable(
...
rtError_t ApiDecorator::SymbolLookup(const void* const hostVar, void** const devPtr, size_t* const size)
{
...
rtError_t ApiDecorator::GetAddrAndPrefCntWithHandle(
...
rtError_t ApiDecorator::KernelGetAddrAndPrefCnt(
...
rtError_t ApiDecorator::KernelGetAddrAndPrefCntV2(
...
rtError_t ApiDecorator::KernelLaunch(
...
rtError_t ApiDecorator::KernelLaunchWithHandle(
...
rtError_t ApiDecorator::KernelLaunchEx(
...
rtError_t ApiDecorator::CpuKernelLaunch(
...
rtError_t ApiDecorator::CalcLaunchArgsSize(
    size_t const argsSize, size_t const hostInfoTotalSize, size_t const hostInfoNum, size_t* const launchArgsSize)
{
    return impl_->CalcLaunchArgsSize(argsSize, hostInfoTotalSize, hostInfoNum, launchArgsSize);
}

rtError_t ApiDecorator::CreateLaunchArgs(
    size_t const argsSize, size_t const hostInfoTotalSize, size_t const hostInfoNum, void* const argsData,
    rtLaunchArgs_t** const argsHandle)
{
    return impl_->CreateLaunchArgs(argsSize, hostInfoTotalSize, hostInfoNum, argsData, argsHandle);
}

rtError_t ApiDecorator::DestroyLaunchArgs(rtLaunchArgs_t* argsHandle) { return impl_->DestroyLaunchArgs(argsHandle); }

rtError_t ApiDecorator::ResetLaunchArgs(rtLaunchArgs_t* argsHandle) { return impl_->ResetLaunchArgs(argsHandle); }
...
rtError_t ApiDecorator::AppendLaunchHostInfo(
...
rtError_t ApiDecorator::CpuKernelLaunchExWithArgs(
...
rtError_t ApiDecorator::MultipleTaskInfoLaunch(
...
rtError_t ApiDecorator::BinaryGetFunction(
...
rtError_t ApiDecorator::BinaryGetFunctionByName(
...
rtError_t ApiDecorator::BinaryGetFunctionByEntry(
...
rtError_t ApiDecorator::BinaryGetMetaInfo(
...
rtError_t ApiDecorator::FunctionGetMetaInfo(
...
rtError_t ApiDecorator::FunctionGetMetaInfoSize(
...
rtError_t ApiDecorator::RegisterCpuFunc(
...
rtError_t ApiDecorator::BinaryUnLoad(Program* const binHandle) { return impl_->BinaryUnLoad(binHandle); }

rtError_t ApiDecorator::BinaryLoadFromFile(
...
rtError_t ApiDecorator::BinaryLoadFromData(
...
rtError_t ApiDecorator::LaunchKernelV2(
...
rtError_t ApiDecorator::KernelTransArgSet(
...
rtError_t ApiDecorator::StreamDestroy(Stream* const stm, bool flag) { return impl_->StreamDestroy(stm, flag); }

rtError_t ApiDecorator::StreamWaitEvent(
...
rtError_t ApiDecorator::GetMaxStreamAndTask(
...
rtError_t ApiDecorator::GetFreeStreamNum(uint32_t* const streamCount) { return impl_->GetFreeStreamNum(streamCount); }

rtError_t ApiDecorator::GetAvailEventNum(uint32_t* const eventCount) { return impl_->GetAvailEventNum(eventCount); }
...
rtError_t ApiDecorator::GetSqId(Stream* const stm, uint32_t* const sqId) { return impl_->GetSqId(stm, sqId); }
...
rtError_t ApiDecorator::EventCreate(Event** const evt, const uint64_t flag) { return impl_->EventCreate(evt, flag); }
...
rtError_t ApiDecorator::EventDestroy(Event* evt) { return impl_->EventDestroy(evt); }

rtError_t ApiDecorator::EventDestroySync(Event* evt) { return impl_->EventDestroySync(evt); }
...
rtError_t ApiDecorator::DevFree(void* const devPtr) { return impl_->DevFree(devPtr); }

rtError_t ApiDecorator::DevDvppMalloc(
...
rtError_t ApiDecorator::ManagedMemFree(const void* const ptr) { return impl_->ManagedMemFree(ptr); }
...
rtError_t ApiDecorator::MemManagedAdvise(
...
rtError_t ApiDecorator::DevMallocCached(
    void** const devPtr, const uint64_t size, const rtMemType_t type, const uint16_t moduleId)
{
    return impl_->DevMallocCached(devPtr, size, type, moduleId);
}

rtError_t ApiDecorator::FlushCache(const uint64_t base, const size_t len) { return impl_->FlushCache(base, len); }
...
rtError_t ApiDecorator::MemCopySyncEx(
    void* const dst, const uint64_t destMax, const void* const src, const uint64_t cnt, const rtMemcpyKind_t kind)
{
    return impl_->MemCopySyncEx(dst, destMax, src, cnt, kind);
}

rtError_t ApiDecorator::MemcpyAsync(
    void* const dst, const uint64_t destMax, const void* const src, const uint64_t cnt, const rtMemcpyKind_t kind,
...
rtError_t ApiDecorator::LaunchSqeUpdateTask(
...
rtError_t ApiDecorator::MemcpyAsyncPtr(
...
rtError_t ApiDecorator::RtsMemcpyAsync(
...
rtError_t ApiDecorator::RtsMemcpy(
    void* const dst, const uint64_t destMax, const void* const src, const uint64_t cnt, const rtMemcpyKind kind,
...
rtError_t ApiDecorator::SetMemcpyDesc(
...
rtError_t ApiDecorator::MemcpyAsyncWithDesc(
...
rtError_t ApiDecorator::ReduceAsync(
...
rtError_t ApiDecorator::ReduceAsyncV2(
    void* const dst, const void* const src, const uint64_t cnt, const rtRecudeKind_t kind, const rtDataType_t type,
...
rtError_t ApiDecorator::MemSetSync(
...
rtError_t ApiDecorator::MemsetAsync(
...
rtError_t ApiDecorator::MemsetD32(void* const dst, const uint64_t destMax, const uint32_t value, const uint64_t count)
{
    return impl_->MemsetD32(dst, destMax, value, count);
}

rtError_t ApiDecorator::MemsetD32Async(
...
rtError_t ApiDecorator::MemGetInfoByDeviceId(
...
rtError_t ApiDecorator::CheckMemType(
...
rtError_t ApiDecorator::GetMemUsageInfo(
...
rtError_t ApiDecorator::MemGetInfoEx(const rtMemInfoType_t memInfoType, size_t* const freeSize, size_t* const totalSize)
{
...
rtError_t ApiDecorator::MemManagedGetAttr(
...
rtError_t ApiDecorator::MemManagedGetAttrs(
...
rtError_t ApiDecorator::DeviceSynchronize(const int32_t timeout) { return impl_->DeviceSynchronize(timeout); }
...
rtError_t ApiDecorator::SnapShotProcessLock() { return impl_->SnapShotProcessLock(); }

rtError_t ApiDecorator::SnapShotProcessUnlock() { return impl_->SnapShotProcessUnlock(); }
...
rtError_t ApiDecorator::SnapShotProcessBackup() { return impl_->SnapShotProcessBackup(); }

rtError_t ApiDecorator::SnapShotProcessRestore() { return impl_->SnapShotProcessRestore(); }
...
rtError_t ApiDecorator::GetDeviceInfo(
...
rtError_t ApiDecorator::GetDeviceInfoFromPlatformInfo(
...
rtError_t ApiDecorator::GetPhyDeviceInfo(
...
rtError_t ApiDecorator::DeviceSetTsId(const uint32_t tsId) { return impl_->DeviceSetTsId(tsId); }
...
rtError_t ApiDecorator::ContextDestroy(Context* const inCtx) { return impl_->ContextDestroy(inCtx); }

rtError_t ApiDecorator::ContextSetCurrent(Context* const inCtx) { return impl_->ContextSetCurrent(inCtx); }

rtError_t ApiDecorator::ContextGetCurrent(Context** const inCtx) { return impl_->ContextGetCurrent(inCtx); }

rtError_t ApiDecorator::ContextGetDevice(int32_t* const devId) { return impl_->ContextGetDevice(devId); }

rtError_t ApiDecorator::ModelCreate(Model** const mdl, const uint32_t flag) { return impl_->ModelCreate(mdl, flag); }
...
rtError_t ApiDecorator::ModelDestroy(Model* const mdl) { return impl_->ModelDestroy(mdl); }
...
rtError_t ApiDecorator::ModelLoadComplete(Model* const mdl) { return impl_->ModelLoadComplete(mdl); }
...
rtError_t ApiDecorator::DebugRegister(
...
rtError_t ApiDecorator::DebugUnRegister(Model* const mdl) { return impl_->DebugUnRegister(mdl); }

rtError_t ApiDecorator::DebugRegisterForStream(
...
rtError_t ApiDecorator::DebugUnRegisterForStream(Stream* const stm) { return impl_->DebugUnRegisterForStream(stm); }
...
rtError_t ApiDecorator::ModelTaskUpdate(
...
rtError_t ApiDecorator::ModelAbort(Model* const mdl) { return impl_->ModelAbort(mdl); }

rtError_t ApiDecorator::ModelExit(Model* const mdl, Stream* const stm) { return impl_->ModelExit(mdl, stm); }
...
rtError_t ApiDecorator::SetExceptCallback(const rtErrorCallback callback) { return impl_->SetExceptCallback(callback); }

rtError_t ApiDecorator::SetTaskAbortCallBack(
    const char_t* regName, void* callback, void* args, TaskAbortCallbackType type)
{
...
rtError_t ApiDecorator::RegDeviceStateCallback(
...
rtError_t ApiDecorator::RegTaskFailCallbackByModule(
...
rtError_t ApiDecorator::StreamSwitchN(
...
rtError_t ApiDecorator::LabelCreate(Label** const lbl, Model* const mdl) { return impl_->LabelCreate(lbl, mdl); }

rtError_t ApiDecorator::LabelDestroy(Label* const lbl) { return impl_->LabelDestroy(lbl); }

rtError_t ApiDecorator::LabelSet(Label* const lbl, Stream* const stm) { return impl_->LabelSet(lbl, stm); }

rtError_t ApiDecorator::LabelGoto(Label* const lbl, Stream* const stm) { return impl_->LabelGoto(lbl, stm); }

rtError_t ApiDecorator::ProfilerTrace(const uint64_t id, const bool notifyFlag, const uint32_t flags, Stream* const stm)
{
    return impl_->ProfilerTrace(id, notifyFlag, flags, stm);
}

rtError_t ApiDecorator::ProfilerTraceEx(
...
rtError_t ApiDecorator::CallbackLaunch(
...
rtError_t ApiDecorator::GetRunMode(rtRunMode* const runMode) { return impl_->GetRunMode(runMode); }
...
rtError_t ApiDecorator::GetAiCoreCount(uint32_t* const aiCoreCnt) { return impl_->GetAiCoreCount(aiCoreCnt); }

rtError_t ApiDecorator::GetAiCpuCount(uint32_t* const aiCpuCnt) { return impl_->GetAiCpuCount(aiCpuCnt); }
...
rtError_t ApiDecorator::StopOnlineProf(Stream* const stm) { return impl_->StopOnlineProf(stm); }

rtError_t ApiDecorator::GetOnlineProfData(
...
rtError_t ApiDecorator::LabelSwitchByIndex(
...
rtError_t ApiDecorator::LabelGotoEx(Label* const lbl, Stream* const stm) { return impl_->LabelGotoEx(lbl, stm); }

rtError_t ApiDecorator::LabelListCpy(
...
rtError_t ApiDecorator::GetDeviceCapability(
...
rtError_t ApiDecorator::GetFaultEvent(
...
rtError_t ApiDecorator::SetOpWaitTimeOut(const uint32_t timeout) { return impl_->SetOpWaitTimeOut(timeout); }
...
rtError_t ApiDecorator::GetOpExecuteTimeOut(uint32_t* const timeout) { return impl_->GetOpExecuteTimeOut(timeout); }

rtError_t ApiDecorator::GetOpExecuteTimeoutV2(uint32_t* const timeout) { return impl_->GetOpExecuteTimeoutV2(timeout); }

rtError_t ApiDecorator::CheckArchCompatibility(
...
rtError_t ApiDecorator::GetOpTimeOutInterval(uint64_t* interval) { return impl_->GetOpTimeOutInterval(interval); }
...
rtError_t ApiDecorator::SetGroup(const int32_t groupId) { return impl_->SetGroup(groupId); }

rtError_t ApiDecorator::GetGroupCount(uint32_t* const cnt) { return impl_->GetGroupCount(cnt); }
...
rtError_t ApiDecorator::StarsTaskLaunch(
...
rtError_t ApiDecorator::FftsPlusTaskLaunch(
...
rtError_t ApiDecorator::NpuGetFloatStatus(
...
rtError_t ApiDecorator::NpuGetFloatDebugStatus(
    void* const outputAddrPtr, const uint64_t outputSize, const uint32_t checkMode, Stream* const stm)
{
...
rtError_t ApiDecorator::ContextSetINFMode(const bool infMode) { return impl_->ContextSetINFMode(infMode); }
...
rtError_t ApiDecorator::MemQueueCreate(const int32_t devId, const rtMemQueueAttr_t* const queAttr, uint32_t* const qid)
{
    return impl_->MemQueueCreate(devId, queAttr, qid);
}

rtError_t ApiDecorator::MemQueueExport(
...
rtError_t ApiDecorator::MemQueueUnExport(
    const int32_t devId, const uint32_t qid, const int32_t peerDevId, const char* const shareName)
{
    return impl_->MemQueueUnExport(devId, qid, peerDevId, shareName);
}

rtError_t ApiDecorator::MemQueueImport(
...
rtError_t ApiDecorator::MemQueueUnImport(
    const int32_t devId, const uint32_t qid, const int32_t peerDevId, const char* const shareName)
{
    return impl_->MemQueueUnImport(devId, qid, peerDevId, shareName);
}

rtError_t ApiDecorator::MemQueueSet(
...
rtError_t ApiDecorator::MemQueueInit(const int32_t devId) { return impl_->MemQueueInit(devId); }
...
rtError_t ApiDecorator::MemQueuePeek(
...
rtError_t ApiDecorator::MemQueueEnQueueBuff(
...
rtError_t ApiDecorator::MemQueueDeQueueBuff(
...
rtError_t ApiDecorator::MemQueueQueryInfo(
...
rtError_t ApiDecorator::MemQueueQuery(
...
rtError_t ApiDecorator::MemQueueGrant(
...
rtError_t ApiDecorator::BuffAlloc(const uint64_t size, void** buff) { return impl_->BuffAlloc(size, buff); }

rtError_t ApiDecorator::BuffConfirm(void* const buff, const uint64_t size) { return impl_->BuffConfirm(buff, size); }

rtError_t ApiDecorator::BuffFree(void* const buff) { return impl_->BuffFree(buff); }
...
rtError_t ApiDecorator::BuffGetInfo(
...
rtError_t ApiDecorator::MemGrpCacheAlloc(
...
rtError_t ApiDecorator::MemGrpAddProc(
...
rtError_t ApiDecorator::QueueSubscribe(
...
rtError_t ApiDecorator::BufEventTrigger(const char_t* const name) { return impl_->BufEventTrigger(name); }

rtError_t ApiDecorator::MemCopy2DSync(
...
rtError_t ApiDecorator::MemCopy2DAsync(
    void* const dst, const uint64_t dstPitch, const void* const src, const uint64_t srcPitch, const uint64_t width,
...
rtError_t ApiDecorator::CmoAddrTaskLaunch(
...
rtError_t ApiDecorator::BarrierTaskLaunch(
...
rtError_t ApiDecorator::MemcpyHostTask(
    void* const dst, const uint64_t destMax, const void* const src, const uint64_t cnt, const rtMemcpyKind_t kind,
    Stream* const stm)
{
...
rtError_t ApiDecorator::DvppGroupDestory(DvppGrp* grp) { return impl_->DvppGroupDestory(grp); }

rtError_t ApiDecorator::DvppWaitGroupReport(
...
rtError_t ApiDecorator::CleanDeviceSatStatus(Stream* const stm) { return impl_->CleanDeviceSatStatus(stm); }
...
rtError_t ApiDecorator::GetBinBuffer(
...
rtError_t ApiDecorator::GetStackBuffer(
...
rtError_t ApiDecorator::BindHostPid(rtBindHostpidInfo info) { return impl_->BindHostPid(info); }

rtError_t ApiDecorator::UnbindHostPid(rtBindHostpidInfo info) { return impl_->UnbindHostPid(info); }

rtError_t ApiDecorator::QueryProcessHostPid(
...
rtError_t ApiDecorator::StreamClear(Stream* const stm, rtClearStep_t step) { return impl_->StreamClear(stm, step); }

rtError_t ApiDecorator::StreamStop(Stream* const stm) { return impl_->StreamStop(stm); }
...
rtError_t ApiDecorator::DebugReadAICore(rtDebugMemoryParam_t* const param) { return impl_->DebugReadAICore(param); }

rtError_t ApiDecorator::GetExceptionRegInfo(
...
rtError_t ApiDecorator::ResourceClean(int32_t devId, rtIdType_t type) { return impl_->ResourceClean(devId, type); }
...
rtError_t ApiDecorator::SetDefaultDeviceId(const int32_t deviceId) { return impl_->SetDefaultDeviceId(deviceId); }
...
rtError_t ApiDecorator::RegStreamStateCallback(
...
rtError_t ApiDecorator::DeviceResetForce(const int32_t devId) { return impl_->DeviceResetForce(devId); }

rtError_t ApiDecorator::GetLastErr(rtLastErrLevel_t level) { return impl_->GetLastErr(level); }

rtError_t ApiDecorator::PeekLastErr(rtLastErrLevel_t level) { return impl_->PeekLastErr(level); }
...
rtError_t ApiDecorator::HdcServerDestroy(rtHdcServer_t const server) { return impl_->HdcServerDestroy(server); }

rtError_t ApiDecorator::HdcSessionConnect(
...
rtError_t ApiDecorator::ModelUpdate(Model* mdl) { return impl_->ModelUpdate(mdl); }
...
rtError_t ApiDecorator::CntNotifyRecord(
...
rtError_t ApiDecorator::CntNotifyWaitWithTimeout(
...
rtError_t ApiDecorator::GetCntNotifyAddress(
...
rtError_t ApiDecorator::UbDbSend(rtUbDbInfo_t* const dbInfo, Stream* const stm) { return impl_->UbDbSend(dbInfo, stm); }
...
rtError_t ApiDecorator::StreamTaskAbort(Stream* const stm) { return impl_->StreamTaskAbort(stm); }

rtError_t ApiDecorator::StreamRecover(Stream* const stm) { return impl_->StreamRecover(stm); }

rtError_t ApiDecorator::StreamTaskClean(Stream* const stm) { return impl_->StreamTaskClean(stm); }

rtError_t ApiDecorator::DeviceResourceClean(const int32_t devId) { return impl_->DeviceResourceClean(devId); }

rtError_t ApiDecorator::MemWriteValue(
...
rtError_t ApiDecorator::MemWaitValue(
    const void* const devAddr, const uint64_t value, const uint32_t flag, Stream* const stm)
{
    return impl_->MemWaitValue(devAddr, value, flag, stm);
}

rtError_t ApiDecorator::MemcpyBatch(
...
rtError_t ApiDecorator::MemcpyBatchAsync(
...
rtError_t ApiDecorator::MemManagedPrefetchAsync(
...
rtError_t ApiDecorator::MemManagedPrefetchBatchAsync(
...
{
    return impl_->MemManagedPrefetchBatchAsync(
        ptrs, sizes, count, prefetchLocs, prefetchLocIdxs, numPrefetchLocs, flags, stream);
}

rtError_t ApiDecorator::GetCmoDescSize(size_t* size) { return impl_->GetCmoDescSize(size); }
...
rtError_t ApiDecorator::EventWorkModeSet(uint8_t mode) { return impl_->EventWorkModeSet(mode); }

rtError_t ApiDecorator::EventWorkModeGet(uint8_t* mode) { return impl_->EventWorkModeGet(mode); }
...
rtError_t ApiDecorator::KernelTaskGetAttribute(
...
rtError_t ApiDecorator::ModelTaskDisable(rtTask_t task) { return impl_->ModelTaskDisable(task); }
} // namespace runtime
} // namespace cce
