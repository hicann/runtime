 ...
 */
#ifndef CCE_RUNTIME_API_IMPL_SNAPSHOT_HPP
#define CCE_RUNTIME_API_IMPL_SNAPSHOT_HPP
...
class ApiImplSnapshot : public ApiSnapshot {
public:
...
#endif // CCE_RUNTIME_API_IMPL_SNAPSHOT_HPP
