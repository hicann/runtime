...
struct rtStarsV2CommonSqe_t {
    rtStarsV2SqeHeader_t sqeHeader;  // word 0-1
...
struct rtStarsV2MemcpyAddrInfo{
    uint64_t res0[4];
    uint64_t src;
    uint64_t dst;
    uint32_t len;
