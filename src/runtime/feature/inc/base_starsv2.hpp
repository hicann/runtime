 ...
 */
#ifndef __CCE_RUNTIME_BASE_STARSV2_HPP__
#define __CCE_RUNTIME_BASE_STARSV2_HPP__

#include <cinttypes>

#define RT_STARSV2_SCALAR_BUFFER_SIZE_32K \
    (32U * 1024U * (RT_STARSV2_AICORE_NUM + RT_STARSV2_AIVECTOR_NUM))
...
constexpr uint32_t RT_STARSV2_AICORE_NUM = 36U;
constexpr uint32_t RT_STARSV2_AIVECTOR_NUM = 72U;
}
}

#endif // __CCE_RUNTIME_BASE_STARSV2_HPP__
