 ...
 */
#ifndef __CCE_RUNTIME_TASK_STARSV2_HPP__
#define __CCE_RUNTIME_TASK_STARSV2_HPP__

#include "task_info.hpp"

namespace cce {
namespace runtime {
    rtError_t SubmitTaskStarsV2(TaskInfo *submitTask, Stream * const stm, int32_t timeout = -1);
    ...
    rtError_t StarsV2SendTask(TaskInfo *taskInfo, Stream * const stm);
...
#endif  // __CCE_RUNTIME_TASK_STARSV2_HPP__
