...
AicpuSdPeriodStatistic::AicpuSdPeriodStatistic() : initFlag_(false), runningFlag_(false), deviceId_(0U), hostPid_(0U) {}
...
AicpuSdPeriodStatistic::~AicpuSdPeriodStatistic() { StopStatistic(); }
...
void AicpuSdPeriodStatistic::InitStatistic(
    const uint32_t deviceId, const uint32_t hostPid, const aicpu::AicpuRunMode runMode)
{
    if ((runMode == aicpu::AicpuRunMode::PROCESS_SOCKET_MODE) || (AicpuUtil::IsFpga())) {
