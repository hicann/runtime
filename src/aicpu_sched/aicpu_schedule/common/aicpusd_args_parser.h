...
public:
    ...
    inline uint32_t GetDeviceMode() const { return deviceMode_; }

    inline uint32_t GetGrpNameNum() const { return grpNameNum_; }

    inline uint32_t GetAicpuProcNum() const { return aicpuProcNum_; }

    inline std::vector<std::string> GetGrpNameList() const { return grpNameList_; }

    inline std::string GetHostProcName() const { return hostProcName_; }

    inline std::vector<std::string> GetQsGrpNameList() const { return qsGrpNameList_; }
