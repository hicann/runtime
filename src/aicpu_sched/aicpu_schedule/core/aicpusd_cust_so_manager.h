...
public:
    ...
    void SetSoRootPath(const std::string& soRootPath) { soRootPath_ = soRootPath; }
...
public:
     ...
     */
    int32_t InitAicpuCustSoManager(const aicpu::AicpuRunMode mode, const AicpuSchedMode schedMode);
    ...
    inline std::string GetSoRootPath() const { return custSoRootPath_; }
