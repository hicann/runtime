...
public:
     ...
     */
    __attribute__((visibility("default"))) void InitEventMgr(
        const bool noThreadFlag, const bool runningFlag, const uint32_t grpId);
     ...
     * @return AICPU_SCHEDULE_OK: success, other: error code
     */
    int32_t ProcessHWTSKernelEvent(const event_info& drvEventInfo, const uint32_t threadIndex) const;
     ...
     */
    int32_t DoOnce(const uint32_t threadIndex, const uint32_t deviceId, const int32_t timeout = AICPU_TIMEOUT_INTERVAL);
     ...
     */
    bool GetRunningFlag() { return runningFlag_; }
...
private:
     ...
     * @return AICPU_SCHEDULE_OK: success, other: error code
     */
    int32_t HWTSKernelEventMessageParse(
     ...
     * @return AICPU_SCHEDULE_OK: success, other: error code
     */
    int32_t ExecuteHWTSKFCEventTask(
     ...
     */
    void GetStreamIdAndTaskIdFromEvent(
