...
void DoSetThreadLocalCtx(const std::string& key, const std::string& value) { g_threadLocalCtx[key] = value; }
...
void AsyncEventManager::Register(const NotifyFunc& notify) { return; }

void AsyncEventManager::NotifyWait(void* notifyParam, const uint32_t paramLen) { return; }
...
void AsyncEventManager::ProcessEvent(const uint32_t eventId, const uint32_t subEventId, void* param) { return; }
