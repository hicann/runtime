...
auto g_custSoMgrInitRet __attribute__((unused)) =
    AicpuSchedule::AicpuCustSoManager::GetInstance().InitAicpuCustSoManager(
...
int32_t ComputeProcess::Start(
    ...
    const uint32_t profilingMode, const uint32_t vfId, const aicpu::AicpuRunMode runMode)
{
    return 0;
}

void ComputeProcess::Stop() { return; }
...
drvError_t drvHdcGetCapacity(struct drvHdcCapacity* capacity) { return DRV_ERROR_NONE; }
...
void ThreadPool::WaitForStop() { return; }
