...
AicpuMc2MaintenanceThread::~AicpuMc2MaintenanceThread() { UnitMc2MantenanceProcess(); }
...
int32_t AicpuMc2MaintenanceThread::SetMc2MantenanceThreadAffinity() { return AICPU_SCHEDULE_OK; }

void AicpuMc2MaintenanceThread::StartProcessEvent() { return; }
void AicpuMc2MaintenanceThread::ProcessEventFunc() const { return; }

void AicpuMc2MaintenanceThread::StopProcessEventFunc() const { return; }

void AicpuMc2MaintenanceThread::UnitMc2MantenanceProcess() { return; }
void AicpuMc2MaintenanceThread::SendMc2CreateThreadMsgToMain() const { return; }
