...
aclError QueueProcessorCcpu::acltdtDestroyQueue(const uint32_t qid) { return acltdtDestroyQueueOndevice(qid, true); }
...
aclError QueueProcessorCcpu::acltdtQueryQueueRoutes(
