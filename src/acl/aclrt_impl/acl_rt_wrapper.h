...
#define ACL_HOOK_DECL(ret, name, sig, args) \
    extern __attribute__((weak)) ACL_FUNC_VISIBILITY aclrtApiEntry g_hook_##name;
...
#define ACL_RT_FUNC_MAP(_)                                                                                             \
    ...
    _(aclError, aclrtGetArgsFromExceptionInfo,                                                                         \
      (const aclrtExceptionInfo* info, void** devArgsPtr, uint32_t* devArgsLen), (info, devArgsPtr, devArgsLen))       \
    _(aclError, aclrtGetFuncHandleFromExceptionInfo, (const aclrtExceptionInfo* info, aclrtFuncHandle* func),          \
      (info, func))                                                                                                    \
    _(aclError, aclrtBinarySetExceptionCallback,                                                                       \
      (aclrtBinHandle binHandle, aclrtOpExceptionCallback callback, void* userData), (binHandle, callback, userData))  \
    _(aclError, aclrtLaunchCallback,                                                                                   \
      (aclrtCallback fn, void* userData, aclrtCallbackBlockType blockType, aclrtStream stream),                        \
      (fn, userData, blockType, stream))                                                                               \
    ...
    _(aclError, aclrtGetDeviceUtilizationRate, (int32_t deviceId, aclrtUtilizationInfo * utilizationInfo),             \
      (deviceId, utilizationInfo))                                                                                     \
    ...
    _(aclError, aclrtRecordEventWithFlag, (aclrtEvent event, aclrtStream stream, uint32_t flag),                       \
      (event, stream, flag))                                                                                           \
    ...
    _(aclError, aclrtEventElapsedTime, (float* ms, aclrtEvent startEvent, aclrtEvent endEvent),                        \
      (ms, startEvent, endEvent))                                                                                      \
    ...
    _(aclError, aclrtMallocWithCfg, (void** devPtr, size_t size, aclrtMemMallocPolicy policy, aclrtMallocConfig* cfg), \
      (devPtr, size, policy, cfg))                                                                                     \
    _(aclError, aclrtMallocForTaskScheduler,                                                                           \
      (void** devPtr, size_t size, aclrtMemMallocPolicy policy, aclrtMallocConfig* cfg), (devPtr, size, policy, cfg))  \
    ...
    _(aclError, aclrtHostRegister, (void* ptr, uint64_t size, aclrtHostRegisterType type, void** devPtr),              \
      (ptr, size, type, devPtr))                                                                                       \
    ...
    _(aclError, aclrtMemcpy, (void* dst, size_t destMax, const void* src, size_t count, aclrtMemcpyKind kind),         \
      (dst, destMax, src, count, kind))                                                                                \
    _(aclError, aclrtMemset, (void* devPtr, size_t maxCount, int32_t value, size_t count),                             \
      (devPtr, maxCount, value, count))                                                                                \
    _(aclError, aclrtMemcpyAsync,                                                                                      \
    ...
    _(aclError, aclrtMemsetD32Async, (void* ptr, size_t memSize, uint32_t value, size_t N, aclrtStream stream),        \
      (ptr, memSize, value, N, stream))                                                                                \
    _(aclError, aclrtMemcpyAsyncWithCondition,                                                                         \
      (void* dst, size_t destMax, const void* src, size_t count, aclrtMemcpyKind kind, aclrtStream stream),            \
      (dst, destMax, src, count, kind, stream))                                                                        \
    _(aclError, aclrtMemcpy2d,                                                                                         \
      (void* dst, size_t dpitch, const void* src, size_t spitch, size_t width, size_t height, aclrtMemcpyKind kind),   \
      (dst, dpitch, src, spitch, width, height, kind))                                                                 \
    _(aclError, aclrtMemcpy2dAsync,                                                                                    \
      (void* dst, size_t dpitch, const void* src, size_t spitch, size_t width, size_t height, aclrtMemcpyKind kind,    \
       aclrtStream stream),                                                                                            \
      (dst, dpitch, src, spitch, width, height, kind, stream))                                                         \
    _(aclError, aclrtMemsetAsync, (void* devPtr, size_t maxCount, int32_t value, size_t count, aclrtStream stream),    \
      (devPtr, maxCount, value, count, stream))                                                                        \
    _(aclError, aclrtReserveMemAddress,                                                                                \
    ...
    _(aclError, aclrtMallocPhysical,                                                                                   \
    ...
    _(aclError, aclrtMapMem, (void* virPtr, size_t size, size_t offset, aclrtDrvMemHandle handle, uint64_t flags),     \
      (virPtr, size, offset, handle, flags))                                                                           \
    _(aclError, aclrtUnmapMem, (void* virPtr), (virPtr))                                                               \
    _(aclError, aclrtMemMapNoAccess,                                                                                   \
    ...
    _(aclError, aclrtCreateStreamWithConfig, (aclrtStream * stream, uint32_t priority, uint32_t flag),                 \
    ...
    _(aclError, aclrtStreamWaitEventWithFlag, (aclrtStream stream, aclrtEvent event, uint32_t timeout, uint32_t flag), \
      (stream, event, timeout, flag))                                                                                  \
    _(aclError, aclrtStreamWaitEventWithTimeout, (aclrtStream stream, aclrtEvent event, int32_t timeout),              \
    ...
    _(aclError, aclrtGetGroupInfoDetail,                                                                               \
      (const aclrtGroupInfo* groupInfo, int32_t groupIndex, aclrtGroupAttr attr, void* attrValue, size_t valueLen,     \
       size_t* paramRetSize),                                                                                          \
      (groupInfo, groupIndex, attr, attrValue, valueLen, paramRetSize))                                                \
    _(aclError, aclrtDeviceCanAccessPeer, (int32_t * canAccessPeer, int32_t deviceId, int32_t peerDeviceId),           \
    ...
    _(aclError, aclrtGetOverflowStatus, (void* outputAddr, size_t outputSize, aclrtStream stream),                     \
      (outputAddr, outputSize, stream))                                                                                \
    _(aclError, aclrtResetOverflowStatus, (aclrtStream stream), (stream))                                              \
    _(aclError, aclrtQueryDeviceStatus, (int32_t deviceId, aclrtDeviceStatus * deviceStatus),                          \
    ...
    _(aclError, aclrtMemGetAccess, (void* virPtr, aclrtMemLocation* location, uint64_t* flag),                         \
      (virPtr, location, flag))                                                                                        \
    _(aclError, aclrtMemExportToShareableHandle,                                                                       \
    ...
    _(aclError, aclrtMemExportToShareableHandleV2,                                                                     \
      (aclrtDrvMemHandle handle, uint64_t flags, aclrtMemSharedHandleType shareType, void* shareableHandle),           \
      (handle, flags, shareType, shareableHandle))                                                                     \
    _(aclError, aclrtMemImportFromShareableHandle,                                                                     \
      (uint64_t shareableHandle, int32_t deviceId, aclrtDrvMemHandle * handle), (shareableHandle, deviceId, handle))   \
    _(aclError, aclrtMemImportFromShareableHandleV2,                                                                   \
      (void* shareableHandle, aclrtMemSharedHandleType shareType, uint64_t flags, aclrtDrvMemHandle* handle),          \
      (shareableHandle, shareType, flags, handle))                                                                     \
    _(aclError, aclrtMemSetPidToShareableHandle, (uint64_t shareableHandle, int32_t * pid, size_t pidNum),             \
      (shareableHandle, pid, pidNum))                                                                                  \
    _(aclError, aclrtMemSetPidToShareableHandleV2,                                                                     \
      (void* shareableHandle, aclrtMemSharedHandleType shareType, int32_t* pid, size_t pidNum),                        \
      (shareableHandle, shareType, pid, pidNum))                                                                       \
    _(aclError, aclrtMemGetAllocationGranularity,                                                                      \
      (aclrtPhysicalMemProp * prop, aclrtMemGranularityOptions option, size_t * granularity),                          \
      (prop, option, granularity))                                                                                     \
    _(aclError, aclrtDeviceGetBareTgid, (int32_t * pid), (pid))                                                        \
    _(aclError, aclrtCmoAsync, (void* src, size_t size, aclrtCmoType cmoType, aclrtStream stream),                     \
      (src, size, cmoType, stream))                                                                                    \
    _(aclError, aclrtGetMemUceInfo,                                                                                    \
      (int32_t deviceId, aclrtMemUceInfo * memUceInfoArray, size_t arraySize, size_t * retSize),                       \
      (deviceId, memUceInfoArray, arraySize, retSize))                                                                 \
    _(aclError, aclrtDeviceTaskAbort, (int32_t deviceId, uint32_t timeout), (deviceId, timeout))                       \
    _(aclError, aclrtMemUceRepair, (int32_t deviceId, aclrtMemUceInfo * memUceInfoArray, size_t arraySize),            \
      (deviceId, memUceInfoArray, arraySize))                                                                          \
    _(aclError, aclrtStreamAbort, (aclrtStream stream), (stream))                                                      \
    _(aclError, aclrtBinaryLoadFromFile,                                                                               \
      (const char* binPath, aclrtBinaryLoadOptions* options, aclrtBinHandle* binHandle),                               \
      (binPath, options, binHandle))                                                                                   \
    _(aclError, aclrtBinaryGetDevAddress, (const aclrtBinHandle binHandle, void** binAddr, size_t* binSize),           \
      (binHandle, binAddr, binSize))                                                                                   \
    ...
    _(aclError, aclrtBinaryGetFunctionCount, (const aclrtBinHandle binHandle, uint32_t* count), (binHandle, count))    \
    ...
    _(aclError, aclrtSetMemcpyDesc,                                                                                    \
      ...
      (desc, kind, srcAddr, dstAddr, count, config))                                                                   \
    _(aclError, aclrtMemcpyAsyncWithDesc, (void* desc, aclrtMemcpyKind kind, aclrtStream stream),                      \
      (desc, kind, stream))                                                                                            \
    _(aclError, aclrtMemcpyAsyncWithOffset,                                                                            \
      (void** dst, size_t destMax, size_t dstDataOffset, const void** src, size_t count, size_t srcDataOffset,         \
       aclrtMemcpyKind kind, aclrtStream stream),                                                                      \
      (dst, destMax, dstDataOffset, src, count, srcDataOffset, kind, stream))                                          \
    _(aclError, aclrtKernelArgsGetHandleMemSize, (aclrtFuncHandle funcHandle, size_t * memSize),                       \
      (funcHandle, memSize))                                                                                           \
    _(aclError, aclrtKernelArgsGetMemSize, (aclrtFuncHandle funcHandle, size_t userArgsSize, size_t * actualArgsSize), \
      (funcHandle, userArgsSize, actualArgsSize))                                                                      \
    _(aclError, aclrtKernelArgsInit, (aclrtFuncHandle funcHandle, aclrtArgsHandle * argsHandle),                       \
      (funcHandle, argsHandle))                                                                                        \
    _(aclError, aclrtKernelArgsInitByUserMem,                                                                          \
    ...
    _(aclError, aclrtKernelArgsAppend,                                                                                 \
      (aclrtArgsHandle argsHandle, void* param, size_t paramSize, aclrtParamHandle* paramHandle),                      \
      (argsHandle, param, paramSize, paramHandle))                                                                     \
    _(aclError, aclrtKernelArgsAppendPlaceHolder, (aclrtArgsHandle argsHandle, aclrtParamHandle * paramHandle),        \
      (argsHandle, paramHandle))                                                                                       \
    _(aclError, aclrtKernelArgsGetPlaceHolderBuffer,                                                                   \
      (aclrtArgsHandle argsHandle, aclrtParamHandle paramHandle, size_t dataSize, void** bufferAddr),                  \
      (argsHandle, paramHandle, dataSize, bufferAddr))                                                                 \
    _(aclError, aclrtKernelArgsParaUpdate,                                                                             \
      (aclrtArgsHandle argsHandle, aclrtParamHandle paramHandle, void* param, size_t paramSize),                       \
      (argsHandle, paramHandle, param, paramSize))                                                                     \
    _(aclError, aclrtLaunchKernelWithConfig,                                                                           \
      ...
      (funcHandle, numBlocks, stream, cfg, argsHandle, reserve))                                                       \
    ...
    _(aclError, aclrtValueWrite, (void* devAddr, uint64_t value, uint32_t flag, aclrtStream stream),                   \
      (devAddr, value, flag, stream))                                                                                  \
    _(aclError, aclrtValueWait, (void* devAddr, uint64_t value, uint32_t flag, aclrtStream stream),                    \
      (devAddr, value, flag, stream))                                                                                  \
    _(aclError, aclrtGetStreamAvailableNum, (uint32_t * streamCount), (streamCount))                                   \
    _(aclError, aclrtSetStreamAttribute,                                                                               \
      (aclrtStream stream, aclrtStreamAttr stmAttrType, aclrtStreamAttrValue * value), (stream, stmAttrType, value))   \
    _(aclError, aclrtGetStreamAttribute,                                                                               \
      (aclrtStream stream, aclrtStreamAttr stmAttrType, aclrtStreamAttrValue * value), (stream, stmAttrType, value))   \
    ...
    _(aclError, aclrtWaitAndResetNotify, (aclrtNotify notify, aclrtStream stream, uint32_t timeout),                   \
      (notify, stream, timeout))                                                                                       \
    ...
    _(aclError, aclrtDeviceGetStreamPriorityRange, (int32_t * leastPriority, int32_t * greatestPriority),              \
    ...
    _(aclError, aclrtGetPrimaryCtxState, (int32_t deviceId, uint32_t * flags, int32_t * active),                       \
      (deviceId, flags, active))                                                                                       \
    _(aclError, aclrtReduceAsync,                                                                                      \
      (void* dst, const void* src, uint64_t count, aclrtReduceKind kind, aclDataType type, aclrtStream stream,         \
       void* reserve),                                                                                                 \
      (dst, src, count, kind, type, stream, reserve))                                                                  \
    ...
    _(aclError, aclrtGetDeviceResLimit, (int32_t deviceId, aclrtDevResLimitType type, uint32_t * value),               \
      (deviceId, type, value))                                                                                         \
    _(aclError, aclrtSetDeviceResLimit, (int32_t deviceId, aclrtDevResLimitType type, uint32_t value),                 \
      (deviceId, type, value))                                                                                         \
    _(aclError, aclrtResetDeviceResLimit, (int32_t deviceId), (deviceId))                                              \
    _(aclError, aclrtGetStreamResLimit, (aclrtStream stream, aclrtDevResLimitType type, uint32_t * value),             \
      (stream, type, value))                                                                                           \
    _(aclError, aclrtSetStreamResLimit, (aclrtStream stream, aclrtDevResLimitType type, uint32_t value),               \
      (stream, type, value))                                                                                           \
    ...
    _(aclError, aclrtCreateLabelList, (aclrtLabel * labels, size_t num, aclrtLabelList * labelList),                   \
      (labels, num, labelList))                                                                                        \
    _(aclError, aclrtDestroyLabelList, (aclrtLabelList labelList), (labelList))                                        \
    _(aclError, aclrtSwitchLabelByIndex, (void* ptr, uint32_t maxValue, aclrtLabelList labelList, aclrtStream stream), \
      (ptr, maxValue, labelList, stream))                                                                              \
    _(aclError, aclrtActiveStream, (aclrtStream activeStream, aclrtStream stream), (activeStream, stream))             \
    _(aclError, aclrtSwitchStream,                                                                                     \
    ...
    _(aclError, aclrtGetBufUserData, (const aclrtMbuf buf, void* dataPtr, size_t size, size_t offset),                 \
      (buf, dataPtr, size, offset))                                                                                    \
    _(aclError, aclrtSetBufUserData, (aclrtMbuf buf, const void* dataPtr, size_t size, size_t offset),                 \
      (buf, dataPtr, size, offset))                                                                                    \
    ...
    _(aclError, aclrtBinaryLoadFromData,                                                                               \
      (const void* data, size_t length, const aclrtBinaryLoadOptions* options, aclrtBinHandle* binHandle),             \
      (data, length, options, binHandle))                                                                              \
    _(aclError, aclrtRegisterCpuFunc,                                                                                  \
      (const aclrtBinHandle handle, const char* funcName, const char* kernelName, aclrtFuncHandle* funcHandle),        \
      (handle, funcName, kernelName, funcHandle))                                                                      \
    _(aclError, aclrtCmoAsyncWithBarrier,                                                                              \
      (void* src, size_t size, aclrtCmoType cmoType, uint32_t barrierId, aclrtStream stream),                          \
      (src, size, cmoType, barrierId, stream))                                                                         \
    _(aclError, aclrtCmoWaitBarrier, (aclrtBarrierTaskInfo * taskInfo, aclrtStream stream, uint32_t flag),             \
      (taskInfo, stream, flag))                                                                                        \
    _(aclError, aclrtGetDevicesTopo, (uint32_t deviceId, uint32_t otherDeviceId, uint64_t * value),                    \
      (deviceId, otherDeviceId, value))                                                                                \
    _(aclError, aclrtMemcpyBatch,                                                                                      \
      ...
      (dsts, destMaxs, srcs, sizes, numBatches, attrs, attrsIndexes, numAttrs, failIndex))                             \
    _(aclError, aclrtMemcpyBatchV2,                                                                                    \
      (void** dsts, size_t* destMaxs, void** srcs, size_t* sizes, size_t numBatches, aclrtMemcpyBatchAttr* attrs,      \
       size_t* attrsIndexes, size_t numAttrs),                                                                         \
      (dsts, destMaxs, srcs, sizes, numBatches, attrs, attrsIndexes, numAttrs))                                        \
    _(aclError, aclrtIpcMemGetExportKey, (void* devPtr, size_t size, char* key, size_t len, uint64_t flags),           \
      (devPtr, size, key, len, flags))                                                                                 \
    _(aclError, aclrtMemcpyBatchAsync,                                                                                 \
      (void** dsts, size_t* destMaxs, void** srcs, size_t* sizes, size_t numBatches, aclrtMemcpyBatchAttr* attrs,      \
       size_t* attrsIndexes, size_t numAttrs, size_t* failIndex, aclrtStream stream),                                  \
      (dsts, destMaxs, srcs, sizes, numBatches, attrs, attrsIndexes, numAttrs, failIndex, stream))                     \
    _(aclError, aclrtMemcpyBatchAsyncV2,                                                                               \
      (void** dsts, size_t* destMaxs, void** srcs, size_t* sizes, size_t numBatches, aclrtMemcpyBatchAttr* attrs,      \
       size_t* attrsIndexes, size_t numAttrs, aclrtStream stream),                                                     \
      (dsts, destMaxs, srcs, sizes, numBatches, attrs, attrsIndexes, numAttrs, stream))                                \
    ...
    _(aclError, aclrtIpcMemImportPidInterServer, (const char* key, aclrtServerPid* serverPids, size_t num),            \
      (key, serverPids, num))                                                                                          \
    _(aclError, aclrtNotifyBatchReset, (aclrtNotify * notifies, size_t num), (notifies, num))                          \
    _(aclError, aclrtNotifyGetExportKey, (aclrtNotify notify, char* key, size_t len, uint64_t flags),                  \
      (notify, key, len, flags))                                                                                       \
    ...
    _(aclError, aclrtNotifySetImportPidInterServer, (aclrtNotify notify, aclrtServerPid * serverPids, size_t num),     \
      (notify, serverPids, num))                                                                                       \
    _(aclError, aclrtCheckMemType,                                                                                     \
      (void** addrList, uint32_t size, uint32_t memType, uint32_t* checkResult, uint32_t reserve),                     \
      (addrList, size, memType, checkResult, reserve))                                                                 \
    _(aclError, aclrtGetLogicDevIdByUserDevId, (const int32_t userDevid, int32_t* const logicDevId),                   \
      (userDevid, logicDevId))                                                                                         \
    _(aclError, aclrtGetUserDevIdByLogicDevId, (const int32_t logicDevId, int32_t* const userDevid),                   \
      (logicDevId, userDevid))                                                                                         \
    _(aclError, aclrtGetLogicDevIdByPhyDevId, (const int32_t phyDevId, int32_t* const logicDevId),                     \
      (phyDevId, logicDevId))                                                                                          \
    _(aclError, aclrtGetPhyDevIdByLogicDevId, (const int32_t logicDevId, int32_t* const phyDevId),                     \
      (logicDevId, phyDevId))                                                                                          \
    _(aclError, aclrtGetUserDevIdByPhyDevId, (const int32_t phyDevId, int32_t* const userDevId),                       \
      (phyDevId, userDevId))                                                                                           \
    _(aclError, aclrtGetPhyDevIdByUserDevId, (const int32_t userDevId, int32_t* const phyDevId),                       \
      (userDevId, phyDevId))                                                                                           \
    _(aclError, aclrtProfTrace, (void* userdata, int32_t length, aclrtStream stream), (userdata, length, stream))      \
    _(aclError, aclrtLaunchKernelV2,                                                                                   \
      (aclrtFuncHandle funcHandle, uint32_t numBlocks, const void* argsData, size_t argsSize,                          \
       aclrtLaunchKernelCfg* cfg, aclrtStream stream),                                                                 \
      (funcHandle, numBlocks, argsData, argsSize, cfg, stream))                                                        \
    ...
    _(aclError, aclrtLaunchKernelWithArgsArray,                                                                        \
    ...
    _(aclError, aclrtNpuGetFloatOverFlowStatus,                                                                        \
      (void* outputAddr, uint64_t outputSize, uint32_t checkMode, aclrtStream stream),                                 \
      (outputAddr, outputSize, checkMode, stream))                                                                     \
    ...
    _(aclError, aclrtRandomNumAsync,                                                                                   \
      (const aclrtRandomNumTaskInfo* taskInfo, const aclrtStream stream, void* reserve), (taskInfo, stream, reserve))  \
    _(aclError, aclrtRegStreamStateCallback, (const char* regName, aclrtStreamStateCallback callback, void* args),     \
      (regName, callback, args))                                                                                       \
    _(aclError, aclrtRegDeviceStateCallback, (const char* regName, aclrtDeviceStateCallback callback, void* args),     \
      (regName, callback, args))                                                                                       \
    _(aclError, aclrtSetDeviceTaskAbortCallback,                                                                       \
      (const char* regName, aclrtDeviceTaskAbortCallback callback, void* args), (regName, callback, args))             \
    _(aclError, aclrtGetOpExecuteTimeout, (uint32_t* const timeoutMs), (timeoutMs))                                    \
    _(aclError, aclrtDevicePeerAccessStatus, (int32_t deviceId, int32_t peerDeviceId, int32_t * status),               \
      (deviceId, peerDeviceId, status))                                                                                \
    _(aclError, aclrtStreamStop, (aclrtStream stream), (stream))                                                       \
    _(aclError, aclrtTaskUpdateAsync,                                                                                  \
      (aclrtStream taskStream, uint32_t taskId, aclrtTaskUpdateInfo * info, aclrtStream execStream),                   \
      (taskStream, taskId, info, execStream))                                                                          \
    ...
    _(aclError, aclrtCmoAsyncWithDesc, (void* cmoDesc, aclrtCmoType cmoType, aclrtStream stream, const void* reserve), \
      (cmoDesc, cmoType, stream, reserve))                                                                             \
    _(aclError, aclrtCheckArchCompatibility, (const char* socVersion, int32_t* canCompatible),                         \
      (socVersion, canCompatible))                                                                                     \
    _(aclError, aclrtCntNotifyRecord, (aclrtCntNotify cntNotify, aclrtStream stream, aclrtCntNotifyRecordInfo * info), \
      (cntNotify, stream, info))                                                                                       \
    _(aclError, aclrtCntNotifyWaitWithTimeout,                                                                         \
      (aclrtCntNotify cntNotify, aclrtStream stream, aclrtCntNotifyWaitInfo * info), (cntNotify, stream, info))        \
    ...
    _(aclError, aclrtMemSetAccess, (void* virPtr, size_t size, aclrtMemAccessDesc* desc, size_t count),                \
      (virPtr, size, desc, count))                                                                                     \
    ...
    _(aclError, aclrtSnapShotCallbackRegister, (aclrtSnapShotStage stage, aclrtSnapShotCallBack callback, void* args), \
      (stage, callback, args))                                                                                         \
    _(aclError, aclrtSnapShotCallbackUnregister, (aclrtSnapShotStage stage, aclrtSnapShotCallBack callback),           \
      (stage, callback))                                                                                               \
    ...
    _(aclError, aclrtMemGetAllocationPropertiesFromHandle, (aclrtDrvMemHandle handle, aclrtPhysicalMemProp * prop),    \
      (handle, prop))                                                                                                  \
    _(aclError, aclrtReserveMemAddressNoUCMemory,                                                                      \
      (void** virPtr, size_t size, size_t alignment, void* expectPtr, uint64_t flags),                                 \
      (virPtr, size, alignment, expectPtr, flags))                                                                     \
    _(aclError, aclrtMemGetAddressRange, (void* ptr, void** pbase, size_t* psize), (ptr, pbase, psize))                \
    _(const char*, aclrtGetSocName, (), ())                                                                            \
    _(aclError, aclrtGetVersion, (int32_t * majorVersion, int32_t * minorVersion, int32_t * patchVersion),             \
      (majorVersion, minorVersion, patchVersion))                                                                      \
    _(aclError, aclrtMemP2PMap, (void* devPtr, size_t size, int32_t dstDevId, uint64_t flags),                         \
      (devPtr, size, dstDevId, flags))                                                                                 \
    _(aclError, aclrtMemPoolCreate, (aclrtMemPool * memPool, const aclrtMemPoolProps* poolProps),                      \
      (memPool, poolProps))                                                                                            \
    _(aclError, aclrtMemPoolDestroy, (const aclrtMemPool memPool), (memPool))                                          \
    _(aclError, aclrtMemPoolSetAttr, (aclrtMemPool memPool, aclrtMemPoolAttr attr, void* value),                       \
      (memPool, attr, value))                                                                                          \
    _(aclError, aclrtMemPoolGetAttr, (aclrtMemPool memPool, aclrtMemPoolAttr attr, void* value),                       \
      (memPool, attr, value))                                                                                          \
    _(aclError, aclrtMemPoolMallocAsync, (void** devPtr, size_t size, aclrtMemPool memPool, aclrtStream stream),       \
      (devPtr, size, memPool, stream))                                                                                 \
    _(aclError, aclrtMemPoolFreeAsync, (void* ptr, aclrtStream stream), (ptr, stream))                                 \
    _(aclError, aclrtMemManagedGetAttr,                                                                                \
      (aclrtMemManagedRangeAttribute attribute, const void* ptr, size_t size, void* data, size_t dataSize),            \
      (attribute, ptr, size, data, dataSize))                                                                          \
    _(aclError, aclrtMemManagedGetAttrs,                                                                               \
    ...
    _(aclError, aclrtMemcpyFromSymbol,                                                                                 \
      (void* dst, size_t dstMax, const void* symbol, size_t count, size_t offset, aclrtMemcpyKind kind),               \
      (dst, dstMax, symbol, count, offset, kind))                                                                      \
    _(aclError, aclrtMemcpyFromSymbolAsync,                                                                            \
      (void* dst, size_t dstMax, const void* symbol, size_t count, size_t offset, aclrtMemcpyKind kind,                \
       aclrtStream stream),                                                                                            \
      (dst, dstMax, symbol, count, offset, kind, stream))                                                              \
    _(aclError, aclrtMemcpyToSymbol,                                                                                   \
      (const void* symbol, const void* src, size_t count, size_t offset, aclrtMemcpyKind kind),                        \
      (symbol, src, count, offset, kind))                                                                              \
    _(aclError, aclrtMemcpyToSymbolAsync,                                                                              \
...
#define ACL_RT_ALLOCATOR_FUNC_MAP(_)                                                                                \
    ...
    _(aclError, aclrtAllocatorSetObjToDesc, (aclrtAllocatorDesc allocatorDesc, aclrtAllocator allocator),           \
      (allocatorDesc, allocator))                                                                                   \
    _(aclError, aclrtAllocatorSetAllocFuncToDesc, (aclrtAllocatorDesc allocatorDesc, aclrtAllocatorAllocFunc func), \
      (allocatorDesc, func))                                                                                        \
    _(aclError, aclrtAllocatorSetFreeFuncToDesc, (aclrtAllocatorDesc allocatorDesc, aclrtAllocatorFreeFunc func),   \
      (allocatorDesc, func))                                                                                        \
    _(aclError, aclrtAllocatorSetAllocAdviseFuncToDesc,                                                             \
      (aclrtAllocatorDesc allocatorDesc, aclrtAllocatorAllocAdviseFunc func), (allocatorDesc, func))                \
    _(aclError, aclrtAllocatorSetGetAddrFromBlockFuncToDesc,                                                        \
      (aclrtAllocatorDesc allocatorDesc, aclrtAllocatorGetAddrFromBlockFunc func), (allocatorDesc, func))           \
    _(aclError, aclrtAllocatorRegister, (aclrtStream stream, aclrtAllocatorDesc allocatorDesc),                     \
      (stream, allocatorDesc))                                                                                      \
    _(aclError, aclrtAllocatorGetByStream,                                                                          \
      ...
      (stream, allocatorDesc, allocator, allocFunc, freeFunc, allocAdviseFunc, getAddrFromBlockFunc))               \
...
#define ACL_MDLRI_FUNC_MAP(_)                                                                                         \
    ...
    _(aclError, aclmdlRICaptureGetInfo, (aclrtStream stream, aclmdlRICaptureStatus * status, aclmdlRI * modelRI),     \
      (stream, status, modelRI))                                                                                      \
    ...
    _(aclError, aclmdlRIGetStreams, (aclmdlRI modelRI, aclrtStream * streams, uint32_t * numStreams),                 \
    ...
    _(aclError, aclmdlRIDestroyRegisterCallback, (aclmdlRI modelRI, aclrtCallback func, void* userData),              \
      (modelRI, func, userData))                                                                                      \
    _(aclError, aclmdlRIDestroyUnregisterCallback, (aclmdlRI modelRI, aclrtCallback func), (modelRI, func))           \
    _(aclError, aclmdlRICondHandleCreate,                                                                             \
      (aclmdlRI modelRI, uint32_t defaultLaunchValue, aclmdlRICondHandleFlag flag, aclmdlRICondHandle * handle),      \
      (modelRI, defaultLaunchValue, flag, handle))                                                                    \
    _(aclError, aclmdlRICondHandleGetCondPtr, (aclmdlRICondHandle handle, uint64_t * *ptr), (handle, ptr))            \
    _(aclError, aclmdlRIAddCondTask, (aclmdlRICondTaskParams params, aclrtStream stream, uint32_t flags),             \
      (params, stream, flags))                                                                                        \
    _(aclError, aclmdlRICaptureToModelRIBegin, (aclrtStream stream, aclmdlRI modelRI, aclmdlRICaptureMode mode),      \
      (stream, modelRI, mode))
...
#define ACL_FUNC_MAP(_)                                                                                                \
    _(aclError, aclInitCallbackRegister, (aclRegisterCallbackType type, aclInitCallbackFunc cbFunc, void* userData),   \
      (type, cbFunc, userData))                                                                                        \
    _(aclError, aclInitCallbackUnRegister, (aclRegisterCallbackType type, aclInitCallbackFunc cbFunc), (type, cbFunc)) \
    _(aclError, aclFinalizeCallbackRegister,                                                                           \
      (aclRegisterCallbackType type, aclFinalizeCallbackFunc cbFunc, void* userData), (type, cbFunc, userData))        \
    _(aclError, aclFinalizeCallbackUnRegister, (aclRegisterCallbackType type, aclFinalizeCallbackFunc cbFunc),         \
      (type, cbFunc))                                                                                                  \
    ...
    _(aclError, aclGetDeviceCapability, (uint32_t deviceId, aclDeviceInfo deviceInfo, int64_t * value),                \
