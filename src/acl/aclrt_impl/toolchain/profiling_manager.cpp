...
const std::map<AclProfType, std::string> PROF_TYPE_TO_NAMES = {
    ...
    {AclProfType::AclrtRecordEventWithFlag, "aclrtRecordEventWithFlag"},
    ...
    {AclProfType::AclrtStreamWaitEventWithFlag, "aclrtStreamWaitEventWithFlag"},
    ...
    {AclProfType::AclrtLaunchKernelWithArgsArray, "aclrtLaunchKernelWithArgsArray"},
    {AclProfType::AclrtLaunchSIMTKernelWithArgsArray, "aclrtLaunchSIMTKernelWithArgsArray"},
    {AclProfType::AclrtCtxGetFloatOverflowAddr, "aclrtCtxGetFloatOverflowAddr"},
    {AclProfType::AclrtLaunchSIMTKernelWithHostArgs, "aclrtLaunchSIMTKernelWithHostArgs"},
    ...
    {AclProfType::AclrtFunctionGetParamCount, "aclrtFunctionGetParamCount"},
    {AclProfType::AclrtFunctionGetParamInfo, "aclrtFunctionGetParamInfo"},
...
bool AclProfilingManager::IsDeviceListEmpty() const { return deviceList_.empty(); }
